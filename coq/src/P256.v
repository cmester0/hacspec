...
Definition ltr_mul
  ...
  result_bind (foldibnd (usize 0) to (bits_v) for q_65>> (fun i_66 q_65 =>
    let q_65 :=
      point_double (q_65) in 
    ifbnd nat_mod_equal (nat_mod_get_bit (k_63) (((bits_v) - (usize 1)) - (
          i_66))) (nat_mod_one ) : bool
    thenbnd (result_bind (point_add_jacob (q_65) (p_64)) (fun q_65  => Ok ((q_65
          ))))
    else ((q_65)) >> (fun '(q_65) =>
...
Definition p256_point_mul
  ...
  (p_68 : affine_t)
  : affine_result_t :=
  result_bind (ltr_mul (k_67) (affine_to_jacobian (p_68))) (fun jac_69 =>
...
Definition point_add_distinct
  ...
  (q_73 : affine_t)
  : affine_result_t :=
  result_bind (point_add_jacob (affine_to_jacobian (p_72)) (affine_to_jacobian (
