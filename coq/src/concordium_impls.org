...
** Config
#+BEGIN_SRC toml :tangle ../../examples/concordium-impls/Cargo.toml :eval never
  [package]
  name = "hacspec-concordium-impls"
  version = "0.1.0"
  authors = [""]
  edition = "2018"

  [lib]
  path = "src/concordium-impls.rs"
...
** Imports
#+BEGIN_SRC rust :tangle ../../examples/concordium-impls/src/concordium-impls.rs :eval never
...
#+begin_src sh :eval never :results output silent
  cargo hacspec -o Concordium_Impls.v concordium-impls --init
#+end_src

#+begin_src sh :results output silent
  cargo hacspec -o Concordium_Impls.v concordium-impls --update
#+end_src
