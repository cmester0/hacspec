...
Definition sign
  ...
  : signature_result_t :=
  result_bind (check_scalar_zero (nonce_11)) (fun _ => result_bind (
      ecdsa_point_mul_base (nonce_11)) (fun '(k_x_12, k_y_13) =>
      let r_14 : p256_scalar_t :=
        nat_mod_from_byte_seq_be (nat_mod_to_byte_seq_be (
            k_x_12)) : p256_scalar_t in 
      result_bind (check_scalar_zero (r_14)) (fun _ =>
...
Definition verify
  ...
  result_bind (ecdsa_point_mul_base (u1_32)) (fun u1_33 =>
    let u2_34 : p256_scalar_t :=
      (r_27) *% (s_inv_31) in 
    result_bind (ecdsa_point_mul (u2_34) (pk_25)) (fun u2_35 => result_bind (
        ecdsa_point_add (u1_33) (u2_35)) (fun '(x_36, y_37) =>
        let x_38 : p256_scalar_t :=
          nat_mod_from_byte_seq_be (nat_mod_to_byte_seq_be (
