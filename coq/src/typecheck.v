...
Definition eqs  : unit :=
  let _ :=
    (false) =.? (true) in 
  let _ :=
    (@repr WORDSIZE8 0) =.? (@repr WORDSIZE8 4) in 
  let _ :=
    (@repr WORDSIZE16 0) =.? (@repr WORDSIZE16 0) in 
  let _ :=
    (@repr WORDSIZE32 4) =.? (@repr WORDSIZE32 7) in 
  let _ :=
    (@repr WORDSIZE64 4) =.? (@repr WORDSIZE64 4) in 
  let _ :=
    (@repr WORDSIZE128 4) =.? (@repr WORDSIZE128 4) in 
  let _ :=
    (usize 4) =.? (usize 4) in 
  let _ :=
    (@repr WORDSIZE8 0) =.? (@repr WORDSIZE8 4) in 
  ...
  let _ :=
    (isize 4) =.? (isize 4) in 
  let _ :=
    ((true, @repr WORDSIZE8 12, @repr WORDSIZE64 93)) =.? ((true, @repr WORDSIZE8 12, @repr WORDSIZE64 92)) in 
  let _ :=
    (
