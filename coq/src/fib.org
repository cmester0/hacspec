...
** Config
#+begin_src toml :tangle ../../examples/fib/Cargo.toml :mkdirp yes :eval never
[package]
name = "hacspec-fib"
version = "0.1.0"
authors = [""]
...
** Rust code
:PROPERTIES:
:header-args: rust :tangle ../../examples/fib/src/fib.rs :mkdirp yes :eval never
:END:
...
***  - Coq code
:PROPERTIES:
:header-args: coq :tangle Fib.v :mkdirp yes :comments link
