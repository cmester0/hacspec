...
#+begin_src python :wrap "src coq :results none" :result code :var loc=(file-name-directory buffer-file-name)
...
#+NAME: linum0
#+CALL: next(ARG="0 11", linum="0 0") :result output silent :exports none
...
#+NAME: linum1
#+CALL: next(ARG="0 2", linum=linum0) :result output silent :exports none
...
#+NAME: linum2
#+CALL: next(ARG="0 7", linum=linum1) :result output silent :exports none
...
#+NAME: linum3
#+CALL: next(ARG="0 6", linum=linum2) :result output silent :exports none
...
#+NAME: linum4
#+CALL: next(ARG="0 13", linum=linum3) :result output silent :exports none
...
#+NAME: linum5
#+CALL: next(ARG="0 6", linum=linum4) :result output silent :exports none
...
#+NAME: linum6
#+CALL: next(ARG="0 13", linum=linum5) :result output silent :exports none
...
#+NAME: linum7
#+CALL: next(ARG="0 5", linum=linum6)  :result output silent :exports none
...
#+NAME: linum8
#+CALL: next(ARG="0 2", linum=linum7)  :result output silent :exports none
...
#+NAME: linum9
#+CALL: next(ARG="0 13", linum=linum8)  :result output silent :exports none
...
#+NAME: linum10
#+CALL: next(ARG="0 2", linum=linum9)  :result output silent :exports none
...
#+NAME: linum11
#+CALL: next(ARG="0 13", linum=linum10)  :result output silent :exports none
...
#+NAME: linum12
#+CALL: next(ARG="0 13", linum=linum11)  :result output silent :exports none
...
#+NAME: linum13
#+CALL: next(ARG="0 5", linum=linum12)  :result output silent :exports none
...
#+NAME: linum14
#+CALL: next(ARG="0 2", linum=linum13)  :result output silent :exports none
...
#+NAME: linum15
#+CALL: next(ARG="0 2", linum=linum14)  :result output silent :exports none
...
#+NAME: linum16
#+CALL: next(ARG="0 5", linum=linum15)  :result output silent :exports none
...
#+NAME: linum17
#+CALL: next(ARG="0 13", linum=linum16)  :result output silent :exports none
...
#+NAME: linum18
#+CALL: next(ARG="0 13", linum=linum17)  :result output silent :exports none
...
#+NAME: linum19
#+CALL: next(ARG="0 13", linum=linum18)  :result output silent :exports none
...
#+NAME: linum20
#+CALL: next(ARG="0 2", linum=linum19)  :result output silent :exports none
...
#+NAME: linum21
#+CALL: next(ARG="0 2", linum=linum20)  :result output silent :exports none
...
#+NAME: linum22
#+CALL: next(ARG="0 2", linum=linum21)  :result output silent :exports none
...
#+NAME: linum23
#+CALL: next(ARG="0 3", linum=linum22)  :result output silent :exports none
...
#+NAME: linum24
#+CALL: next(ARG="0 2", linum=linum23)  :result output silent :exports none
...
#+NAME: linum25
#+CALL: next(ARG="0 2", linum=linum24)  :result output silent :exports none
...
#+NAME: linum26
#+CALL: next(ARG="0 2", linum=linum25)  :result output silent :exports none
...
#+NAME: linum27
#+CALL: next(ARG="0 2", linum=linum26)  :result output silent :exports none
...
#+NAME: linum28
#+CALL: next(ARG="0 2", linum=linum27)  :result output silent :exports none
...
#+NAME: linum29
#+CALL: next(ARG="0 3", linum=linum28)  :result output silent :exports none
...
#+NAME: linum30
#+CALL: next(ARG="0 1", linum=linum29) :result output silent :exports none
