...
Instance show_unit : Show (unit) := Build_Show (unit) (fun _ => "tt"%string).
Definition g_unit : G (unit) := returnGen tt.
Instance gen_unit : Gen (unit) := Build_Gen unit g_unit.
...
Instance show_public_byte_seq : Show (public_byte_seq) := Build_Show (public_byte_seq) show.
Definition g_public_byte_seq : G (public_byte_seq) := listOf arbitrary.
Instance gen_public_byte_seq : Gen (public_byte_seq) := Build_Gen public_byte_seq g_public_byte_seq.
