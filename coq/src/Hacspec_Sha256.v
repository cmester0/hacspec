...
Definition k_table_v : round_constants_table_t :=
  array_from_list uint32 (let l :=
      [
        secret (repr (i := U32) 1116352408) : int32;
        secret (repr (i := U32) 1899447441) : int32;
        secret (repr (i := U32) 3049323471) : int32;
        secret (repr (i := U32) 3921009573) : int32;
        secret (repr (i := U32) 961987163) : int32;
        secret (repr (i := U32) 1508970993) : int32;
        secret (repr (i := U32) 2453635748) : int32;
        secret (repr (i := U32) 2870763221) : int32;
        secret (repr (i := U32) 3624381080) : int32;
        secret (repr (i := U32) 310598401) : int32;
        secret (repr (i := U32) 607225278) : int32;
        secret (repr (i := U32) 1426881987) : int32;
        secret (repr (i := U32) 1925078388) : int32;
        secret (repr (i := U32) 2162078206) : int32;
        secret (repr (i := U32) 2614888103) : int32;
        secret (repr (i := U32) 3248222580) : int32;
        secret (repr (i := U32) 3835390401) : int32;
        secret (repr (i := U32) 4022224774) : int32;
        secret (repr (i := U32) 264347078) : int32;
        secret (repr (i := U32) 604807628) : int32;
        secret (repr (i := U32) 770255983) : int32;
        secret (repr (i := U32) 1249150122) : int32;
        secret (repr (i := U32) 1555081692) : int32;
        secret (repr (i := U32) 1996064986) : int32;
        secret (repr (i := U32) 2554220882) : int32;
        secret (repr (i := U32) 2821834349) : int32;
        secret (repr (i := U32) 2952996808) : int32;
        secret (repr (i := U32) 3210313671) : int32;
        secret (repr (i := U32) 3336571891) : int32;
        secret (repr (i := U32) 3584528711) : int32;
        secret (repr (i := U32) 113926993) : int32;
        secret (repr (i := U32) 338241895) : int32;
        secret (repr (i := U32) 666307205) : int32;
        secret (repr (i := U32) 773529912) : int32;
        secret (repr (i := U32) 1294757372) : int32;
        secret (repr (i := U32) 1396182291) : int32;
        secret (repr (i := U32) 1695183700) : int32;
        secret (repr (i := U32) 1986661051) : int32;
        secret (repr (i := U32) 2177026350) : int32;
        secret (repr (i := U32) 2456956037) : int32;
        secret (repr (i := U32) 2730485921) : int32;
        secret (repr (i := U32) 2820302411) : int32;
        secret (repr (i := U32) 3259730800) : int32;
        secret (repr (i := U32) 3345764771) : int32;
        secret (repr (i := U32) 3516065817) : int32;
        secret (repr (i := U32) 3600352804) : int32;
        secret (repr (i := U32) 4094571909) : int32;
        secret (repr (i := U32) 275423344) : int32;
        secret (repr (i := U32) 430227734) : int32;
        secret (repr (i := U32) 506948616) : int32;
        secret (repr (i := U32) 659060556) : int32;
        secret (repr (i := U32) 883997877) : int32;
        secret (repr (i := U32) 958139571) : int32;
        secret (repr (i := U32) 1322822218) : int32;
        secret (repr (i := U32) 1537002063) : int32;
        secret (repr (i := U32) 1747873779) : int32;
        secret (repr (i := U32) 1955562222) : int32;
        secret (repr (i := U32) 2024104815) : int32;
        secret (repr (i := U32) 2227730452) : int32;
        secret (repr (i := U32) 2361852424) : int32;
        secret (repr (i := U32) 2428436474) : int32;
        secret (repr (i := U32) 2756734187) : int32;
        secret (repr (i := U32) 3204031479) : int32;
        secret (repr (i := U32) 3329325298) : int32
      ] in  l).

Definition hash_init_v : hash_t :=
  array_from_list uint32 (let l :=
      [
        secret (repr (i := U32) 1779033703) : int32;
        secret (repr (i := U32) 3144134277) : int32;
        secret (repr (i := U32) 1013904242) : int32;
        secret (repr (i := U32) 2773480762) : int32;
        secret (repr (i := U32) 1359893119) : int32;
        secret (repr (i := U32) 2600822924) : int32;
        secret (repr (i := U32) 528734635) : int32;
        secret (repr (i := U32) 1541459225) : int32
      ] in  l).
    ...
    foldi (usize 0) (seq_num_chunks (msg_39) (block_size_v)) (fun i_43 '(
      ...
      let '(h_40, last_block_41, last_block_len_42) :=
        if (block_len_44) <.? (block_size_v):bool then (let last_block_41 :=
            array_update_start (array_new (block_size_v)) (block_45) in 
