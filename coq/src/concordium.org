...
#+name: split-file
#+begin_src python :wrap "src coq :eval never" :exports none :results code :var ARG="0 -1" :var FILENAME="Concordium.v" :eval never
import functools
...
#+begin_src sh
  cargo hacspec -o coq/src/Concordium.v hacspec-concordium --init
#+end_src

#+begin_src sh
  cargo hacspec -o Concordium.v hacspec-concordium --update
#+end_src
...
:PROPERTIES:
:header-args: :tangle Concordium.v
:header-args: coq :eval never :results output silent
:END:

*** The includes
#+NAME: linum0
#+CALL: next(ARG="0 7", linum="0 0") :exports none
#+NAME: seg0
