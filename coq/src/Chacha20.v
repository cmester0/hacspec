...
Definition chacha20_constants_init  : constants :=
  let constants_29 : constants :=
    array_new_ (secret (@repr WORDSIZE32 0)) (4) in 
  let constants_29 :=
    array_upd constants_29 (usize 0) (secret (@repr WORDSIZE32 1634760805)) in 
  let constants_29 :=
    array_upd constants_29 (usize 1) (secret (@repr WORDSIZE32 857760878)) in 
  let constants_29 :=
    array_upd constants_29 (usize 2) (secret (@repr WORDSIZE32 2036477234)) in 
  let constants_29 :=
    array_upd constants_29 (usize 3) (secret (@repr WORDSIZE32 1797285236)) in 
  constants_29.
...
Definition chacha20_init
  ...
  : state :=
  let st_33 : state :=
    array_new_ (secret (@repr WORDSIZE32 0)) (16) in 
  let st_33 :=
...
Definition chacha20_key_block (state_34 : state) : block :=
  let state_35 : state :=
    chacha20_core (secret (@repr WORDSIZE32 0)) (state_34) in 
...
Definition chacha20_key_block0
  ...
  : block :=
  let state_38 : state :=
    chacha20_init (key_36) (iv_37) (secret (@repr WORDSIZE32 0)) in 
...
Definition chacha20_encrypt_last
  ...
  : byte_seq :=
  let b_48 : block :=
    array_new_ (secret (@repr WORDSIZE8 0)) (64) in 
  let b_48 :=
...
Definition chacha20_update (st0_49 : state) (m_50 : byte_seq) : byte_seq :=
  let blocks_out_51 : seq uint8 :=
    seq_new_ (secret (@repr WORDSIZE8 0)) (seq_len (m_50)) in 
