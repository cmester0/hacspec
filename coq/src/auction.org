...
#+name: split-file
#+begin_src python :wrap "src coq :eval never" :exports none :results code :var ARG="0 -1" :var FILENAME="Auction.v" :eval never
import functools
...
:PROPERTIES:
:header-args: :tangle Auction.v  :comments link
:header-args: coq :eval never :results output silent
:END:

*** The includes
#+NAME: linum0
#+CALL: next(ARG="0 9", linum="0 1")  :exports none
#+NAME: seg0
#+CALL: split-file(ARG=linum0) :eval
#+RESULTS: seg0
#+begin_src coq :eval never
...
*** Types
#+NAME: linum1
#+CALL: next(ARG="0 0", linum=linum0) :exports none
#+NAME: seg1
...
#+NAME: linum5
#+CALL: next(ARG="0 4", linum=linum4) :exports none
#+NAME: seg5
...
#+NAME: seg24
#+CALL: split-file(ARG=linum24) :eval
#+RESULTS: seg24
#+begin_src coq :eval never
QuickChick (
...
#+NAME: seg25
#+CALL: split-file(ARG=linum25) :eval
#+RESULTS: seg25
#+begin_src coq :eval never
...
#+NAME: seg26
#+CALL: split-file(ARG=linum26) :eval
#+RESULTS: seg26
#+begin_src coq :eval never
...
#+NAME: seg27
#+CALL: split-file(ARG=linum27) :eval
#+RESULTS: seg27
#+begin_src coq :eval never
...
#+NAME: seg28
#+CALL: split-file(ARG=linum28) :eval
#+RESULTS: seg28
#+begin_src coq :eval never
...
#+NAME: seg29
#+CALL: split-file(ARG=linum29) :eval
#+RESULTS: seg29
#+begin_src coq :eval never
...
#+NAME: seg30
#+CALL: split-file(ARG=linum30) :eval
#+RESULTS: seg30
#+begin_src coq :eval never
QuickChick (
