...
Theorem test_fp2_prop_add_neg_correct : forall a_320 : fp2 ,test_fp2_prop_add_neg a_320 = true.
Proof. Admitted.
...
Definition test_fp2_prop_mul_inv (a_322 : fp2) : bool :=
  let b_323 :=
    fp2inv (a_322) in 
  ((fp2fromfp (nat_mod_zero )) =.? (a_322)) || (
    (fp2fromfp (nat_mod_one )) =.? (fp2mul (a_322) (b_323))).
QuickChick (forAll g_fp2 (fun a_322 : fp2 =>test_fp2_prop_mul_inv a_322)).


Theorem test_fp2_prop_mul_inv_correct : forall a_322 : fp2 ,test_fp2_prop_mul_inv a_322 = true.
Proof. Admitted.
...
Definition test_fp6_prop_mul_inv (a_325 : fp6) : bool :=
  let b_326 :=
    fp6inv (a_325) in 
  ((fp6fromfp2 (fp2fromfp (nat_mod_zero ))) =.? (a_325)) || (
    (fp6fromfp2 (fp2fromfp (nat_mod_one ))) =.? (fp6mul (a_325) (b_326))).
QuickChick (forAll g_fp6 (fun a_325 : fp6 =>test_fp6_prop_mul_inv a_325)).


Theorem test_fp6_prop_mul_inv_correct : forall a_325 : fp6 ,test_fp6_prop_mul_inv a_325 = true.
Proof. Admitted.
...
Theorem test_fp6_prop_add_neg_correct : forall a_327 : fp6 ,test_fp6_prop_add_neg a_327 = true.
Proof. Admitted.
...
Theorem test_fp12_prop_add_neg_correct : forall a_329 : fp12 ,test_fp12_prop_add_neg a_329 = true.
Proof. Admitted.
...
Definition test_fp12_prop_mul_inv (a_331 : fp12) : bool :=
  let b_332 :=
    fp12inv (a_331) in 
  ((fp12fromfp6 (fp6fromfp2 (fp2fromfp (nat_mod_zero )))) =.? (a_331)) || (
    (fp12fromfp6 (fp6fromfp2 (fp2fromfp (nat_mod_one )))) =.? (
      fp12mul (a_331) (b_332))).
QuickChick (forAll g_fp12 (fun a_331 : fp12 =>test_fp12_prop_mul_inv a_331)).


Theorem test_fp12_prop_mul_inv_correct : forall a_331 : fp12 ,test_fp12_prop_mul_inv a_331 = true.
Proof. Admitted.


Definition test_unsafe (a_333 : fp12) : bool :=
  let b_334 :=
    fp12inv (a_333) in 
  ((fp12fromfp6 (fp6fromfp2 (fp2fromfp (nat_mod_zero )))) =.? (a_333)) || (
    (fp12fromfp6 (fp6fromfp2 (fp2fromfp (nat_mod_one )))) =.? (
      fp12mul (a_333) (b_334))).
QuickChick (forAll g_fp12 (fun a_333 : fp12 =>test_unsafe a_333)).


Theorem test_unsafe_correct : forall a_333 : fp12 ,test_unsafe a_333 = true.
Proof. Admitted.
