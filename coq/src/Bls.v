...
Definition g1add_a (p_131 : g1) (q_132 : g1) : g1 :=
  ...
  let x3_140 :=
    ((nat_mod_exp (xovery_139) (@repr WORDSIZE32 2)) -% (x1_133)) -% (
      x2_135) in 
  let y3_141 :=
...
Definition g1double_a (p_142 : g1) : g1 :=
  let '(x1_143, y1_144, _) :=
    p_142 in 
  let x12_145 :=
    nat_mod_exp (x1_143) (@repr WORDSIZE32 2) in 
  let xovery_146 :=
    (
      (
        nat_mod_from_literal (
          0x1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9feffffffffaaab) (
          @repr WORDSIZE128 3)) *% (x12_145)) *% (
      nat_mod_inv ((nat_mod_two ) *% (y1_144))) in 
  let x3_147 :=
    (nat_mod_exp (xovery_146) (@repr WORDSIZE32 2)) -% (
      (nat_mod_two ) *% (x1_143)) in 
  let y3_148 :=
  ...
  let a_230 :=
    fp2mul (
      fp2fromfp (
        nat_mod_from_literal (
          0x1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9feffffffffaaab) (
          @repr WORDSIZE128 3))) (fp2mul (r0_228) (r0_228)) in 
  let a_231 :=
