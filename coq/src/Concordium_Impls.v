(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:1]] *)
...
(* hacspec_concordium_impls - Coq code:1 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:2]] *)
Require Import Hacspec.Lib.
(* hacspec_concordium_impls - Coq code:2 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:3]] *)
Require Import Hacspec.Concordium_Prims.
(* hacspec_concordium_impls - Coq code:3 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:4]] *)
Require Import Hacspec.Concordium_Types.
(* hacspec_concordium_impls - Coq code:4 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:5]] *)
Require Import Hacspec.Concordium_Traits.
(* hacspec_concordium_impls - Coq code:5 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:6]] *)
Notation "'reject_hacspec_t'" := (int32) : hacspec_scope.
(* hacspec_concordium_impls - Coq code:6 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:7]] *)
Definition reject_impl_deafult  : reject_hacspec_t :=
  min_v.
(* hacspec_concordium_impls - Coq code:7 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:8]] *)
Definition new_reject_impl (x_25 : int32) : (option int32) :=
  (if ((x_25) <.? (@repr WORDSIZE32 0)):bool then (@Some int32 (x_25)) else (
      @None int32)).
(* hacspec_concordium_impls - Coq code:8 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:9]] *)
...
Theorem ensures_reject_impl_convert_from_unit : forall result_26 ,
 ...
 Proof. Admitted.
(* hacspec_concordium_impls - Coq code:9 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:10]] *)
...
Theorem ensures_reject_impl_convert_from_parse_error : forall result_26 ,
 ...
 ~ (result_26 = @repr WORDSIZE32 0).
 Proof. Admitted.
(* hacspec_concordium_impls - Coq code:10 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:11]] *)
...
Theorem ensures_reject_impl_from_log_error : forall result_26 (
 ...
 ~ (result_26 = @repr WORDSIZE32 0).
 Proof. Admitted.
(* hacspec_concordium_impls - Coq code:11 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:12]] *)
...
(* hacspec_concordium_impls - Coq code:12 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:13]] *)
...
Theorem ensures_reject_impl_from_new_contract_name_error : forall result_26 (
 ...
 ~ (result_26 = @repr WORDSIZE32 0).
 Proof. Admitted.
(* hacspec_concordium_impls - Coq code:13 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:14]] *)
...
(* hacspec_concordium_impls - Coq code:14 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:15]] *)
...
Theorem ensures_reject_impl_from_new_receive_name_error : forall result_26 (
 ...
 ~ (result_26 = @repr WORDSIZE32 0).
 Proof. Admitted.
(* hacspec_concordium_impls - Coq code:15 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:16]] *)
...
Theorem ensures_reject_impl_from_not_payable_error : forall result_26 ,
 ...
 ~ (result_26 = @repr WORDSIZE32 0).
 Proof. Admitted.
(* hacspec_concordium_impls - Coq code:16 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:17]] *)
Notation "'contract_state_hacspec_t'" := (int32) : hacspec_scope.
(* hacspec_concordium_impls - Coq code:17 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:18]] *)
...
(* hacspec_concordium_impls - Coq code:18 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:19]] *)
Notation "'uint32_option_t'" := ((option int32)) : hacspec_scope.
(* hacspec_concordium_impls - Coq code:19 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:20]] *)
Notation "'iint64_option_t'" := ((option int64)) : hacspec_scope.
(* hacspec_concordium_impls - Coq code:20 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:21]] *)
...
(* hacspec_concordium_impls - Coq code:21 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:22]] *)
...
(* hacspec_concordium_impls - Coq code:22 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:23]] *)
...
(* hacspec_concordium_impls - Coq code:23 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:24]] *)
...
(* hacspec_concordium_impls - Coq code:24 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:25]] *)
...
(* hacspec_concordium_impls - Coq code:25 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:26]] *)
...
(* hacspec_concordium_impls - Coq code:26 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:27]] *)
Definition has_contract_state_impl_for_contract_state_open
  
  : contract_state_hacspec_t :=
  @repr WORDSIZE32 0.
(* hacspec_concordium_impls - Coq code:27 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:28]] *)
...
(* hacspec_concordium_impls - Coq code:28 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:29]] *)
Definition has_contract_state_impl_for_contract_state_truncate
  ...
  (if ((new_size_65) <.? (current_position_63)):bool then (new_size_65) else (
      current_position_63)).
(* hacspec_concordium_impls - Coq code:29 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:30]] *)
Notation "'parameter_hacspec_t'" := (int32) : hacspec_scope.
(* hacspec_concordium_impls - Coq code:30 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:31]] *)
...
(* hacspec_concordium_impls - Coq code:31 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:32]] *)
Notation "'attributes_cursor_hacspec_t'" := ((int32 × int16)) : hacspec_scope.
(* hacspec_concordium_impls - Coq code:32 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:33]] *)
...
(* hacspec_concordium_impls - Coq code:33 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:34]] *)
Notation "'policies_iterator_hacspec_t'" := ((int32 × int16)) : hacspec_scope.
(* hacspec_concordium_impls - Coq code:34 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:35]] *)
...
(* hacspec_concordium_impls - Coq code:35 ends here *)

(* [[file:concordium.org::* hacspec_concordium_impls - Coq code][hacspec_concordium_impls - Coq code:36]] *)
...
(* hacspec_concordium_impls - Coq code:36 ends here *)
