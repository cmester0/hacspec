...
Program Definition poly1305_encode_r
  ...
  ({code
     temp_4 ←
      (array_from_seq (16) (array_to_seq (b_2))) ;; 
...
Program Definition poly1305_encode_block
  ...
  ({code
     temp_13 ←
      (array_from_seq (16) (array_to_seq (b_11))) ;; 
...
Program Definition poly1305_init
  ...
  ({code
     temp_36 ←
      (array_from_slice (default) (16) (array_to_seq (k_34)) (usize 0) (
          usize 16)) ;; 
...
Program Definition poly1305_finish
  ...
  ({code
    let '(acc_81, _, k_82) :=
      (st_80) in 
     temp_84 ←
      (array_from_slice (default) (16) (array_to_seq (k_82)) (usize 16) (
          usize 16)) ;; 
    ...
    let temp_94 := type_from_choice_type_elem temp_95 in
     temp_97 ←
      (array_from_seq (16) (array_to_seq (temp_94))) ;; 
