...
Program Definition poly1305_finish
  ...
  ({code
    let '(acc_89, _, k_84) :=
      (st_83) in 
     temp_86 ←
      (array_from_slice (default) (16) (array_to_seq (k_84)) (usize 16) (
          usize 16)) ;; let temp_85 := type_from_choice_type_elem temp_86 in
     temp_88 ←
    ...
    let temp_97 := type_from_choice_type_elem temp_98 in
     temp_100 ←
      (array_from_seq (16) (array_to_seq (temp_97))) ;;
