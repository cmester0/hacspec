...
Definition poly1305_tag := nseq (uint8) (usize 16).
...
Definition poly1305_encode_r (b_0 : poly_block) : field_element :=
  ...
  let n_1 :=
    (n_1) .& (secret (
        @repr WORDSIZE128 21267647620597763993911028882763415551)) in 
...
Definition poly1305_encode_last
  ...
  : field_element :=
  let n_7 : uint128 :=
    uint128_from_le_bytes (array_from_slice (secret (@repr WORDSIZE8 0)) (16) (
        b_6) (usize 0) (seq_len (b_6))) in 
  let f_8 : field_element :=
...
Definition poly1305_init (k_9 : poly_key) : poly_state :=
  let r_10 : field_element :=
    poly1305_encode_r (array_from_slice (secret (@repr WORDSIZE8 0)) (16) (
        k_9) (usize 0) (usize 16)) in 
...
Definition poly1305_update_last
  ...
  (st_24 : poly_state)
  : poly_state :=
  let st_25 : (field_element × field_element × poly_key) :=
    st_24 in 
  let '(st_25) :=
...
Definition poly1305_update
  ...
  (st_30 : poly_state)
  : poly_state :=
  let st_31 : (field_element × field_element × poly_key) :=
...
Definition poly1305_finish (st_33 : poly_state) : poly1305_tag :=
  let '(acc_34, _, k_35) :=
    st_33 in 
  let n_36 : uint128 :=
    uint128_from_le_bytes (array_from_slice (secret (@repr WORDSIZE8 0)) (16) (
        k_35) (usize 16) (usize 16)) in 
  let aby_37 : seq uint8 :=
    nat_mod_to_byte_seq_le (acc_34) in 
  let a_38 : uint128 :=
    uint128_from_le_bytes (array_from_slice (secret (@repr WORDSIZE8 0)) (16) (
        aby_37) (usize 0) (usize 16)) in 
  array_from_seq (16) (uint128_to_le_bytes ((a_38) .+ (n_36))).

Definition poly1305 (m_39 : byte_seq) (key_40 : poly_key) : poly1305_tag :=
  let st_41 : (field_element × field_element × poly_key) :=
