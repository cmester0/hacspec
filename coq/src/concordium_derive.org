...
#+name: split-file
#+begin_src python :wrap "src coq :tangle Concordium_Impls.v :mkdirp yes :results output silent" :exports none :results code :var ARG="0 -1" :var FILENAME="Concordium_Impls.v" :eval never
  import functools
