...
Definition b_i_2899_loc : Location :=
  (seq uint8 ; 2901%nat).
Definition result_2897_loc : Location :=
  ((result (error_t) (byte_seq)) ; 2902%nat).
Definition l_i_b_str_2898_loc : Location :=
  (seq uint8 ; 2903%nat).
Definition uniform_bytes_2900_loc : Location :=
  (seq uint8 ; 2904%nat).
...
Definition output_2916_loc : Location :=
...
Notation "'ed_hash_to_field_out'" :=(
  seq_ed_result_t : choice_type) (at level 2).
  ...
  ((letb len_in_bytes_2919 : uint_size :=
      ...
      letb output_2916 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 count_2918) output_2916 (L := (fset (
...
Notation "'ed_is_square_out'" :=('bool : choice_type) (at level 2).
...
Notation "'sgn0_m_eq_1_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'sgn0_m_eq_1_out'" :=('bool : choice_type) (at level 2).
...
Notation "'ed_clear_cofactor_inp'" :=(ed_point_t : choice_type) (at level 2).
Notation "'ed_clear_cofactor_out'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'ed_clear_cofactor_out'" :=(ed_point_t : choice_type) (at level 2).
...
Notation "'cmov_inp'" :=(
  ed25519_field_element_t × ed25519_field_element_t × 'bool : choice_type) (in custom pack_type at level 2).
Notation "'cmov_inp'" :=(
  ed25519_field_element_t × ed25519_field_element_t × 'bool : choice_type) (at level 2).
Notation "'cmov_out'" :=(
  ed25519_field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'cmov_out'" :=(ed25519_field_element_t : choice_type) (at level 2).
Definition CMOV : nat :=
  2939.
Program Definition cmov (a_2938 : ed25519_field_element_t) (
    b_2937 : ed25519_field_element_t) (c_2936 : 'bool)
...
Notation "'xor_inp'" :=(
  'bool × 'bool : choice_type) (in custom pack_type at level 2).
Notation "'xor_inp'" :=('bool × 'bool : choice_type) (at level 2).
Notation "'xor_out'" :=('bool : choice_type) (in custom pack_type at level 2).
Notation "'xor_out'" :=('bool : choice_type) (at level 2).
Definition XOR : nat :=
  2942.
Program Definition xor (a_2940 : 'bool) (b_2941 : 'bool)
  : both (fset.fset0) [interface] ('bool) :=
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        if is_pure (I := [interface]) (lift_to_both0 a_2940)
        then if is_pure (I := [interface]) (lift_to_both0 b_2941)
        then lift_to_both0 ((false : 'bool))
        else lift_to_both0 ((true : 'bool))
        else if is_pure (I := [interface]) (lift_to_both0 b_2941)
        then lift_to_both0 ((true : 'bool))
        else lift_to_both0 ((false : 'bool)))
      ) : both (fset.fset0) [interface] ('bool)).
Fail Next Obligation.
...
Definition x_2963_loc : Location :=
  (ed25519_field_element_t ; 2965%nat).
Definition x1_2962_loc : Location :=
  (ed25519_field_element_t ; 2966%nat).
Definition y_2964_loc : Location :=
...
Program Definition map_to_curve_elligator2 (u_2972 : ed25519_field_element_t)
  : both (fset ([x1_2962_loc ; x_2963_loc ; y_2964_loc])) [interface] (
    ed_point_t) :=
  ((letb j_2968 : ed25519_field_element_t :=
      ...
      letb '(x1_2962) :=
        if (lift_to_both0 x1_2962) =.? (lift_to_both0 zero_2971) :'bool
        then lift_scope (L1 := fset ([x1_2962_loc])) (L2 := fset (
      ...
      letbm y_2964 : ed25519_field_element_t loc( y_2964_loc ) :=
        lift_to_both0 zero_2971 in
      letb '(x_2963, y_2964) :=
        if ed_is_square (lift_to_both0 gx1_2973) :'bool
        then lift_scope (L1 := fset ([x1_2962_loc ; x_2963_loc ; y_2964_loc])) (
          L2 := fset ([x1_2962_loc ; x_2963_loc ; y_2964_loc])) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          ...
          letb '(y_2964) :=
            if negb (sgn0_m_eq_1 (lift_to_both0 y_2964)) :'bool
            then lift_scope (L1 := fset (
                [x1_2962_loc ; x_2963_loc ; y_2964_loc])) (L2 := fset (
                [x1_2962_loc ; x_2963_loc ; y_2964_loc])) (I1 := [interface]) (
              I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
              letbm y_2964 loc( y_2964_loc ) :=
          ...
          letb '(y_2964) :=
            if sgn0_m_eq_1 (lift_to_both0 y_2964) :'bool
            then lift_scope (L1 := fset (
                [x1_2962_loc ; x_2963_loc ; y_2964_loc])) (L2 := fset (
                [x1_2962_loc ; x_2963_loc ; y_2964_loc])) (I1 := [interface]) (
              I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
...
Program Definition map_to_curve_elligator2_straight (
  ...
  ((letb j_2979 : ed25519_field_element_t :=
      ...
      letb e2_2997 : 'bool := ed_is_square (lift_to_both0 gx1_2994) in
      ...
      letb e3_3001 : 'bool := sgn0_m_eq_1 (lift_to_both0 y_3000) in
  ...
  ((letb j_3006 : ed25519_field_element_t :=
      ...
      letb y_3050 : ed25519_field_element_t :=
        cmov (lift_to_both0 y2_3045) (lift_to_both0 y1_3036) (
          lift_to_both0 e3_3048) in
      letb e4_3051 : 'bool := sgn0_m_eq_1 (lift_to_both0 y_3050) in
...
Notation "'ed_encode_to_curve_out'" :=(
  ed_point_result_t : choice_type) (at level 2).
