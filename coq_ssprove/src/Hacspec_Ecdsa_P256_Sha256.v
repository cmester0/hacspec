...
Notation "'check_scalar_zero_inp'" :=(p256_scalar_t : choice_type) (at level 2).
Notation "'check_scalar_zero_out'" :=(
  check_result_t : choice_type) (in custom pack_type at level 2).
Notation "'check_scalar_zero_out'" :=(
  check_result_t : choice_type) (at level 2).
...
Program Definition check_scalar_zero (r_673 : p256_scalar_t)
  ...
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        if is_pure (I := [interface]) (nat_mod_equal (lift_to_both0 r_673) (
            nat_mod_zero ))
        then @Err 'unit error_t (InvalidScalar)
...
Notation "'ecdsa_point_mul_base_out'" :=(
  arithmetic_result_t : choice_type) (at level 2).
...
Notation "'sign_inp'" :=(
  byte_seq × p256_secret_key_t × p256_scalar_t : choice_type) (at level 2).
Notation "'sign_out'" :=(
  p256_signature_result_t : choice_type) (in custom pack_type at level 2).
Notation "'sign_out'" :=(p256_signature_result_t : choice_type) (at level 2).
Definition SIGN : nat :=
  695.
Program Definition sign (payload_687 : byte_seq) (sk_690 : p256_secret_key_t) (
  ...
  ((letbnd(_) _ : 'unit := check_scalar_zero (lift_to_both0 nonce_683) in
      ...
      letbnd(_) _ : 'unit := check_scalar_zero (lift_to_both0 r_686) in
...
Notation "'ecdsa_p256_sha256_sign_out'" :=(
  p256_signature_result_t : choice_type) (in custom pack_type at level 2).
Notation "'ecdsa_p256_sha256_sign_out'" :=(
  p256_signature_result_t : choice_type) (at level 2).
...
Notation "'verify_inp'" :=(
  byte_seq × p256_public_key_t × p256_signature_t : choice_type) (at level 2).
Notation "'verify_out'" :=(
  p256_verify_result_t : choice_type) (in custom pack_type at level 2).
Notation "'verify_out'" :=(p256_verify_result_t : choice_type) (at level 2).
...
Notation "'ecdsa_p256_sha256_verify_out'" :=(
  p256_verify_result_t : choice_type) (in custom pack_type at level 2).
Notation "'ecdsa_p256_sha256_verify_out'" :=(
  p256_verify_result_t : choice_type) (at level 2).
