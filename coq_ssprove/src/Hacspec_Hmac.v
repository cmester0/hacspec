...
Notation "'k_block_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'k_block_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'k_block_out'" :=(block_t : choice_type) (at level 2).
...
Definition h_in_931_loc : Location :=
  (seq uint8 ; 932%nat).
Definition h_in_930_loc : Location :=
  (seq uint8 ; 933%nat).
Notation "'hmac_inp'" :=(
  byte_seq × byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'hmac_inp'" :=(byte_seq × byte_seq : choice_type) (at level 2).
Notation "'hmac_out'" :=(prk_t : choice_type) (in custom pack_type at level 2).
Notation "'hmac_out'" :=(prk_t : choice_type) (at level 2).
Definition HMAC : nat :=
  938.
Program Definition hmac (k_934 : byte_seq) (txt_936 : byte_seq)
  : both (fset ([h_in_930_loc ; h_in_931_loc])) [interface] (prk_t) :=
