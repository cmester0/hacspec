...
Definition n_554_loc : Location :=
  (uint128 ; 555%nat).
Notation "'poly1305_encode_r_inp'" :=(
  poly_block_t : choice_type) (in custom pack_type at level 2).
Notation "'poly1305_encode_r_inp'" :=(poly_block_t : choice_type) (at level 2).
...
Program Definition poly1305_encode_r (b_556 : poly_block_t)
  : both (fset ([n_554_loc])) [interface] (field_element_t) :=
...
Notation "'poly1305_encode_block_inp'" :=(
  poly_block_t : choice_type) (in custom pack_type at level 2).
Notation "'poly1305_encode_block_inp'" :=(
  poly_block_t : choice_type) (at level 2).
...
Notation "'poly1305_encode_last_inp'" :=(
  block_index_t × sub_block_t : choice_type) (at level 2).
...
Notation "'poly1305_init_inp'" :=(poly_key_t : choice_type) (at level 2).
Notation "'poly1305_init_out'" :=(
  poly_state_t : choice_type) (in custom pack_type at level 2).
Notation "'poly1305_init_out'" :=(poly_state_t : choice_type) (at level 2).
Definition POLY1305_INIT : nat :=
  569.
Program Definition poly1305_init (k_567 : poly_key_t)
  : both (fset ([n_554_loc])) [interface] (poly_state_t) :=
...
Notation "'poly1305_update_block_inp'" :=(
  poly_block_t × poly_state_t : choice_type) (at level 2).
Notation "'poly1305_update_block_out'" :=(
  poly_state_t : choice_type) (in custom pack_type at level 2).
Notation "'poly1305_update_block_out'" :=(
  poly_state_t : choice_type) (at level 2).
...
Definition st_576_loc : Location :=
...
Notation "'poly1305_update_blocks_inp'" :=(
  byte_seq × poly_state_t : choice_type) (at level 2).
...
Program Definition poly1305_update_blocks (m_579 : byte_seq) (
    st_578 : poly_state_t)
  : both (fset ([st_576_loc])) [interface] (poly_state_t) :=
  ((letbm st_576 : (field_element_t × field_element_t × poly_key_t
      ...
      letb st_576 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 n_blocks_580) st_576 (L := (fset ([st_576_loc]))) (
...
Definition st_584_loc : Location :=
...
Notation "'poly1305_update_last_inp'" :=(
  uint_size × sub_block_t × poly_state_t : choice_type) (at level 2).
...
Program Definition poly1305_update_last (pad_len_591 : uint_size) (
  ...
  : both (fset ([st_584_loc])) [interface] (poly_state_t) :=
  ((letbm st_584 : (field_element_t × field_element_t × poly_key_t
        ) loc( st_584_loc ) :=
        lift_to_both0 st_586 in
      letb '(st_584) :=
        if (seq_len (lift_to_both0 b_587)) !=.? (lift_to_both0 (usize 0)) :'bool
        then lift_scope (L1 := fset ([st_584_loc])) (L2 := fset (
...
Notation "'poly1305_update_out'" :=(
  poly_state_t : choice_type) (in custom pack_type at level 2).
Notation "'poly1305_update_out'" :=(poly_state_t : choice_type) (at level 2).
Definition POLY1305_UPDATE : nat :=
  597.
Program Definition poly1305_update (m_593 : byte_seq) (st_594 : poly_state_t)
  : both (fset ([st_576_loc ; st_584_loc])) [interface] (poly_state_t) :=
...
Notation "'poly1305_finish_inp'" :=(
  poly_state_t : choice_type) (in custom pack_type at level 2).
Notation "'poly1305_finish_inp'" :=(poly_state_t : choice_type) (at level 2).
Notation "'poly1305_finish_out'" :=(
  poly1305_tag_t : choice_type) (in custom pack_type at level 2).
Notation "'poly1305_finish_out'" :=(poly1305_tag_t : choice_type) (at level 2).
...
Definition st_605_loc : Location :=
...
Notation "'poly1305_inp'" :=(byte_seq × poly_key_t : choice_type) (at level 2).
Notation "'poly1305_out'" :=(
  poly1305_tag_t : choice_type) (in custom pack_type at level 2).
Notation "'poly1305_out'" :=(poly1305_tag_t : choice_type) (at level 2).
