...
Notation "'new_fletcher_inp'" :=('unit : choice_type) (at level 2).
Notation "'new_fletcher_out'" :=(
  fletcher_t : choice_type) (in custom pack_type at level 2).
Notation "'new_fletcher_out'" :=(fletcher_t : choice_type) (at level 2).
...
Notation "'max_chunk_size_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'max_chunk_size_inp'" :=('unit : choice_type) (at level 2).
Notation "'max_chunk_size_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'max_chunk_size_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'reduce_u32_inp'" :=(int32 : choice_type) (at level 2).
Notation "'reduce_u32_out'" :=(
  int32 : choice_type) (in custom pack_type at level 2).
Notation "'reduce_u32_out'" :=(int32 : choice_type) (at level 2).
...
Notation "'combine_inp'" :=(int32 × int32 : choice_type) (at level 2).
Notation "'combine_out'" :=(
  int32 : choice_type) (in custom pack_type at level 2).
Notation "'combine_out'" :=(int32 : choice_type) (at level 2).
...
Definition intermediate_a_1675_loc : Location :=
  (int32 ; 1677%nat).
Definition a_1673_loc : Location :=
  (int32 ; 1678%nat).
Definition b_1674_loc : Location :=
  (int32 ; 1679%nat).
Definition intermediate_b_1676_loc : Location :=
  (int32 ; 1680%nat).
Notation "'update_fletcher_inp'" :=(
  fletcher_t × seq int16 : choice_type) (in custom pack_type at level 2).
Notation "'update_fletcher_inp'" :=(
  fletcher_t × seq int16 : choice_type) (at level 2).
Notation "'update_fletcher_out'" :=(
  fletcher_t : choice_type) (in custom pack_type at level 2).
Notation "'update_fletcher_out'" :=(fletcher_t : choice_type) (at level 2).
...
Notation "'value_inp'" :=(
  fletcher_t : choice_type) (in custom pack_type at level 2).
Notation "'value_inp'" :=(fletcher_t : choice_type) (at level 2).
Notation "'value_out'" :=(int32 : choice_type) (in custom pack_type at level 2).
Notation "'value_out'" :=(int32 : choice_type) (at level 2).
  ...
  ((letb '(magic_1696, seq_number_1697, start_addr_1698, _) : (
      ...
      letb u16_seq_1693 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
              usize 3)) u16_seq_1693 (L := (fset ([u16_seq_1693_loc]))) (
...
Definition result_1712_loc : Location :=
  ('bool ; 1713%nat).
Notation "'is_valid_header_inp'" :=(
  header_t : choice_type) (in custom pack_type at level 2).
Notation "'is_valid_header_inp'" :=(header_t : choice_type) (at level 2).
Notation "'is_valid_header_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'is_valid_header_out'" :=('bool : choice_type) (at level 2).
...
Program Definition is_valid_header (h_1714 : header_t)
  ...
  ((letb '(magic_number_1715, seq_number_1716, start_addr_1717, checksum_1718
      ...
      letbm result_1712 : 'bool loc( result_1712_loc ) :=
        lift_to_both0 ((false : 'bool)) in
      letb '(result_1712) :=
        if (lift_to_both0 magic_number_1715) =.? (
          lift_to_both0 riotboot_magic_v) :'bool
...
Definition image_found_1725_loc : Location :=
  ('bool ; 1726%nat).
Definition image_1724_loc : Location :=
  (int32 ; 1727%nat).
Notation "'choose_image_inp'" :=(
  seq header_t : choice_type) (in custom pack_type at level 2).
Notation "'choose_image_inp'" :=(seq header_t : choice_type) (at level 2).
Notation "'choose_image_out'" :=(('bool × int32
  ) : choice_type) (in custom pack_type at level 2).
Notation "'choose_image_out'" :=(('bool × int32) : choice_type) (at level 2).
...
Program Definition choose_image (images_1728 : seq header_t)
  ...
  ((letbm image_1724 : int32 loc( image_1724_loc ) :=
      ...
      letbm image_found_1725 : 'bool loc( image_found_1725_loc ) :=
        lift_to_both0 ((false : 'bool)) in
        ...
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
            ...
            letb '(image_1724, image_found_1725) :=
              ...
              then lift_scope (L1 := fset (
                ...
                I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                letb change_image_1735 : 'bool :=
                  negb ((lift_to_both0 image_found_1725) && ((
                        lift_to_both0 seq_number_1732) <=.? (
                        lift_to_both0 image_1724))) in
                letb '(image_1724, image_found_1725) :=
                  if lift_to_both0 change_image_1735 :'bool
                  then lift_scope (L1 := fset (
                      [a_1673_loc ; b_1674_loc ; intermediate_a_1675_loc ; intermediate_b_1676_loc ; u16_seq_1693_loc ; result_1712_loc ; image_1724_loc ; image_found_1725_loc])) (
                    L2 := fset (
                      [a_1673_loc ; b_1674_loc ; intermediate_a_1675_loc ; intermediate_b_1676_loc ; u16_seq_1693_loc ; result_1712_loc ; image_1724_loc ; image_found_1725_loc])) (
