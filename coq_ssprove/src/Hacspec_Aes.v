...
Notation "'shift_rows_inp'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'shift_rows_inp'" :=(block_t : choice_type) (at level 2).
Notation "'shift_rows_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'shift_rows_out'" :=(block_t : choice_type) (at level 2).
...
Notation "'xtime_inp'" :=(uint8 : choice_type) (at level 2).
Notation "'xtime_out'" :=(uint8 : choice_type) (in custom pack_type at level 2).
Notation "'xtime_out'" :=(uint8 : choice_type) (at level 2).
...
Notation "'mix_columns_inp'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'mix_columns_inp'" :=(block_t : choice_type) (at level 2).
Notation "'mix_columns_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'mix_columns_out'" :=(block_t : choice_type) (at level 2).
...
Notation "'aes_enc_inp'" :=(
  block_t × round_key_t : choice_type) (in custom pack_type at level 2).
Notation "'aes_enc_inp'" :=(block_t × round_key_t : choice_type) (at level 2).
Notation "'aes_enc_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'aes_enc_out'" :=(block_t : choice_type) (at level 2).
...
Notation "'aes_enc_last_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'aes_enc_last_out'" :=(block_t : choice_type) (at level 2).
Definition AES_ENC_LAST : nat :=
  240.
Program Definition aes_enc_last (state_236 : block_t) (
    round_key_239 : round_key_t)
  : both (fset ([st_187_loc ; out_192_loc ; out_224_loc])) [interface] (
    block_t) :=
...
Definition out_241_loc : Location :=
  (block_t ; 242%nat).
Notation "'rounds_aes_inp'" :=(
  block_t × byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'rounds_aes_inp'" :=(block_t × byte_seq : choice_type) (at level 2).
Notation "'rounds_aes_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'rounds_aes_out'" :=(block_t : choice_type) (at level 2).
        ...
        foldi_both' (lift_to_both0 (usize 0)) (seq_num_chunks (
            ...
            letbm out_241 loc( out_241_loc ) :=
              aes_enc (lift_to_both0 out_241) (array_from_seq (blocksize_v) (
                  @lift_to_both0 (seq int8) key_block_246)) in
            lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
...
Notation "'block_cipher_aes_inp'" :=(
  block_t × byte_seq × uint_size : choice_type) (at level 2).
Notation "'block_cipher_aes_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'block_cipher_aes_out'" :=(block_t : choice_type) (at level 2).
...
Notation "'rotate_word_inp'" :=(word_t : choice_type) (at level 2).
Notation "'rotate_word_out'" :=(
  word_t : choice_type) (in custom pack_type at level 2).
Notation "'rotate_word_out'" :=(word_t : choice_type) (at level 2).
...
Notation "'slice_word_inp'" :=(
  word_t : choice_type) (in custom pack_type at level 2).
Notation "'slice_word_inp'" :=(word_t : choice_type) (at level 2).
Notation "'slice_word_out'" :=(
  word_t : choice_type) (in custom pack_type at level 2).
Notation "'slice_word_out'" :=(word_t : choice_type) (at level 2).
...
Definition k_266_loc : Location :=
  (word_t ; 268%nat).
Definition result_267_loc : Location :=
...
Notation "'key_expansion_word_inp'" :=(
  word_t × word_t × uint_size × uint_size × uint_size : choice_type) (at level 2).
Notation "'key_expansion_word_out'" :=(
  word_result_t : choice_type) (in custom pack_type at level 2).
Notation "'key_expansion_word_out'" :=(
  word_result_t : choice_type) (at level 2).
...
Program Definition key_expansion_word (w0_275 : word_t) (w1_270 : word_t) (
  ...
  : both (fset ([k_261_loc ; k_266_loc ; result_267_loc])) [interface] (
    word_result_t) :=
  ((letbm k_266 : word_t loc( k_266_loc ) := lift_to_both0 w1_270 in
      ...
      letb '(k_266, result_267) :=
        if (lift_to_both0 i_271) <.? ((lift_to_both0 (usize 4)) .* ((
              lift_to_both0 nr_272) .+ (lift_to_both0 (usize 1)))) :'bool
        then lift_scope (L1 := fset (
            [k_261_loc ; k_266_loc ; result_267_loc])) (L2 := fset (
          ...
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letb '(k_266
            ...
            then lift_scope (L1 := fset (
            ...
            else  lift_scope (L1 := fset ([k_266_loc ; result_267_loc])) (
              L2 := fset ([k_261_loc ; k_266_loc ; result_267_loc])) (
              I1 := [interface]) (
              I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letb '(
                ...
                if ((lift_to_both0 nk_273) >.? (lift_to_both0 (usize 6))) && (((
                    ...
                    lift_to_both0 (usize 4))) :'bool
                then lift_scope (L1 := fset ([k_266_loc ; result_267_loc])) (
                  L2 := fset ([k_266_loc ; result_267_loc])) (
                  I1 := [interface]) (
                  I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                  letbm k_266 loc( k_266_loc ) :=
         ...
         in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        @lift_to_both0 (result (int8) (word_t)) result_267)
      ) : both (fset ([k_261_loc ; k_266_loc ; result_267_loc])) [interface] (
      word_result_t)).
Fail Next Obligation.

Definition key_ex_277_loc : Location :=
  (seq uint8 ; 278%nat).
...
Notation "'key_expansion_aes_inp'" :=(
  byte_seq × uint_size × uint_size × uint_size × uint_size × uint_size : choice_type) (at level 2).
Notation "'key_expansion_aes_out'" :=(
  byte_seq_result_t : choice_type) (in custom pack_type at level 2).
Notation "'key_expansion_aes_out'" :=(
  byte_seq_result_t : choice_type) (at level 2).
  ...
  ((letbm key_ex_277 : seq uint8 loc( key_ex_277_loc ) :=
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both int8) key_ex_277 :=
        foldi_bind_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 iterations_283) key_ex_277 (L := (fset (
...
Notation "'aes_encrypt_block_inp'" :=(
  byte_seq × block_t × uint_size × uint_size × uint_size × uint_size × uint_size : choice_type) (at level 2).
Notation "'aes_encrypt_block_out'" :=(
  block_result_t : choice_type) (in custom pack_type at level 2).
Notation "'aes_encrypt_block_out'" :=(
  block_result_t : choice_type) (at level 2).
...
Notation "'aes128_encrypt_block_inp'" :=(
  key128_t × block_t : choice_type) (at level 2).
Notation "'aes128_encrypt_block_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'aes128_encrypt_block_out'" :=(block_t : choice_type) (at level 2).
...
Definition input_302_loc : Location :=
  (block_t ; 303%nat).
...
Notation "'aes_ctr_key_block_inp'" :=(
  byte_seq × aes_nonce_t × uint32 × uint_size × uint_size × uint_size × uint_size × uint_size : choice_type) (at level 2).
...
Definition blocks_out_320_loc : Location :=
  (seq uint8 ; 321%nat).
Definition ctr_319_loc : Location :=
  (uint32 ; 322%nat).
...
Notation "'aes_counter_mode_inp'" :=(
  byte_seq × aes_nonce_t × uint32 × byte_seq × uint_size × uint_size × uint_size × uint_size × uint_size : choice_type) (at level 2).
...
Program Definition aes_counter_mode (key_328 : byte_seq) (
  ...
  ((letbm ctr_319 : uint32 loc( ctr_319_loc ) := lift_to_both0 counter_323 in
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both int8) '(
        ...
        foldi_bind_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 n_blocks_325) ((ctr_319, blocks_out_320) : chProd uint32 (seq uint8)) (L := (
              fset (
            ...
            letbnd(_) key_block_335 : block_t :=
              aes_ctr_key_block (lift_to_both0 key_328) (
                lift_to_both0 nonce_329) (@lift_to_both0 uint32 ctr_319) (
            ...
            letbm blocks_out_320 loc( blocks_out_320_loc ) :=
              seq_set_chunk (@lift_to_both0 (seq int8) blocks_out_320) (
            ...
            letbm ctr_319 loc( ctr_319_loc ) :=
              (@lift_to_both0 uint32 ctr_319) .+ (secret (lift_to_both0 (
                    @repr U32 1))) in
        ...
        then lift_scope (L1 := fset (
          ...
          letbnd(_) key_block_339 : block_t :=
            aes_ctr_key_block (lift_to_both0 key_328) (
              ...
              lift_to_both0 key_length_333) (lift_to_both0 iterations_334) in
          letbm blocks_out_320 loc( blocks_out_320_loc ) :=
            seq_set_chunk (@lift_to_both0 (seq uint8) blocks_out_320) (
          ...
          ) int8 (@lift_to_both0 (seq int8) blocks_out_320))
         in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (@Ok byte_seq int8 (
...
Notation "'aes128_encrypt_inp'" :=(
  key128_t × aes_nonce_t × uint32 × byte_seq : choice_type) (at level 2).
Notation "'aes128_encrypt_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'aes128_encrypt_out'" :=(byte_seq : choice_type) (at level 2).
...
Notation "'aes128_decrypt_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'aes128_decrypt_out'" :=(byte_seq : choice_type) (at level 2).
