...
Notation "'jacobian_to_affine_inp'" :=(
  p256_jacobian_t : choice_type) (at level 2).
Notation "'jacobian_to_affine_out'" :=(
  affine_t : choice_type) (in custom pack_type at level 2).
Notation "'jacobian_to_affine_out'" :=(affine_t : choice_type) (at level 2).
...
Notation "'affine_to_jacobian_inp'" :=(
  affine_t : choice_type) (in custom pack_type at level 2).
Notation "'affine_to_jacobian_inp'" :=(affine_t : choice_type) (at level 2).
...
Notation "'point_double_inp'" :=(
  p256_jacobian_t : choice_type) (in custom pack_type at level 2).
Notation "'point_double_inp'" :=(p256_jacobian_t : choice_type) (at level 2).
Notation "'point_double_out'" :=(
  p256_jacobian_t : choice_type) (in custom pack_type at level 2).
Notation "'point_double_out'" :=(p256_jacobian_t : choice_type) (at level 2).
...
Notation "'is_point_at_infinity_out'" :=('bool : choice_type) (at level 2).
...
Notation "'s1_equal_s2_inp'" :=(
  p256_field_element_t × p256_field_element_t : choice_type) (at level 2).
Notation "'s1_equal_s2_out'" :=(
  jacobian_result_t : choice_type) (in custom pack_type at level 2).
Notation "'s1_equal_s2_out'" :=(jacobian_result_t : choice_type) (at level 2).
...
Definition result_760_loc : Location :=
      ...
      letb '(result_760) :=
        ...
        then lift_scope (L1 := fset ([result_760_loc])) (L2 := fset (
          ...
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letb '(
            ...
            else  lift_scope (L1 := fset ([result_760_loc])) (L2 := fset (
                [result_760_loc])) (I1 := [interface]) (
              I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letb '(
                  x1_764,
                  y1_765,
...
Notation "'ltr_mul_inp'" :=(
  p256_scalar_t × p256_jacobian_t : choice_type) (at level 2).
Notation "'ltr_mul_out'" :=(
  jacobian_result_t : choice_type) (in custom pack_type at level 2).
Notation "'ltr_mul_out'" :=(jacobian_result_t : choice_type) (at level 2).
Definition LTR_MUL : nat :=
  795.
Program Definition ltr_mul (k_793 : p256_scalar_t) (p_794 : p256_jacobian_t)
  : both (fset ([result_760_loc ; q_790_loc])) [interface] (
    jacobian_result_t) :=
  ((letbm q_790 : (
          p256_field_element_t ×
          p256_field_element_t ×
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) q_790 :=
        foldi_bind_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 bits_v) q_790 (L := (fset (
            ...
            letbnd(ChoiceEqualityMonad.result_bind_both error_t) '(q_790) :=
              if nat_mod_equal (nat_mod_get_bit (lift_to_both0 k_793) (((
                    ...
                    lift_to_both0 i_792))) (nat_mod_one ) :'bool
              then lift_scope (L1 := fset ([result_760_loc ; q_790_loc])) (
                L2 := fset ([result_760_loc ; q_790_loc])) (I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                letbndm(_) q_790 :=
...
Notation "'p256_point_mul_base_inp'" :=(
  p256_scalar_t : choice_type) (at level 2).
Notation "'p256_point_mul_base_out'" :=(
  affine_result_t : choice_type) (in custom pack_type at level 2).
Notation "'p256_point_mul_base_out'" :=(
  affine_result_t : choice_type) (at level 2).
...
Notation "'point_add_distinct_inp'" :=(
  affine_t × affine_t : choice_type) (at level 2).
...
Program Definition point_add_distinct (p_803 : affine_t) (q_804 : affine_t)
  : both (fset ([result_760_loc])) [interface] (affine_result_t) :=
...
Notation "'point_add_inp'" :=(
  affine_t × affine_t : choice_type) (in custom pack_type at level 2).
Notation "'point_add_inp'" :=(affine_t × affine_t : choice_type) (at level 2).
Notation "'point_add_out'" :=(
  affine_result_t : choice_type) (in custom pack_type at level 2).
Notation "'point_add_out'" :=(affine_result_t : choice_type) (at level 2).
...
Definition all_zero_811_loc : Location :=
  ('bool ; 812%nat).
Definition valid_810_loc : Location :=
  ('bool ; 813%nat).
...
Notation "'p256_validate_private_key_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'p256_validate_private_key_out'" :=('bool : choice_type) (at level 2).
Definition P256_VALIDATE_PRIVATE_KEY : nat :=
  818.
Program Definition p256_validate_private_key (k_814 : byte_seq)
  : both (fset ([valid_810_loc ; all_zero_811_loc])) [interface] ('bool) :=
  ((letbm valid_810 : 'bool loc( valid_810_loc ) :=
...
Notation "'p256_validate_public_key_inp'" :=(
  affine_t : choice_type) (in custom pack_type at level 2).
Notation "'p256_validate_public_key_inp'" :=(
  affine_t : choice_type) (at level 2).
Notation "'p256_validate_public_key_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'p256_validate_public_key_out'" :=('bool : choice_type) (at level 2).
...
Program Definition p256_validate_public_key (p_820 : affine_t)
  ...
  ((letb b_819 : p256_field_element_t :=
      ...
      letb point_at_infinity_821 : 'bool :=
...
Notation "'p256_calculate_w_inp'" :=(
  p256_field_element_t : choice_type) (at level 2).
