  ...
  ((letbm new_state_1250 : state_t loc( new_state_1250_loc ) :=
      ...
      letb new_state_1250 :=
        foldi_both' (lift_to_both0 (usize 0)) (array_len (
              lift_to_both0 new_state_1250)) new_state_1250 (L := (fset (
            ...
            letb word_1251 :=
              foldi_both' (lift_to_both0 (usize 0)) (array_len (
                    lift_to_both0 word_1251)) word_1251 (L := (fset (
...
Definition new_state_1258_loc : Location :=
...
Program Definition transmute_state_to_u8 (state_1260 : state_uint64_t)
  : both (fset ([new_state_1258_loc])) [interface] (state_uint8_t) :=
  ((letbm new_state_1258 : state_uint8_t loc( new_state_1258_loc ) :=
        array_new_ (default : uint8) (200) in
      letb new_state_1258 :=
        foldi_both' (lift_to_both0 (usize 0)) (array_len (
              lift_to_both0 state_1260)) new_state_1258 (L := (fset (
            ...
            letb new_state_1258 :=
              foldi_both' (lift_to_both0 (usize 0)) (seq_len (
                    lift_to_both0 bytes_1262)) new_state_1258 (L := (fset (
                      [new_state_1258_loc]))) (I := [interface]) (
...
Definition state_1265_loc : Location :=
  (state_uint8_t ; 1268%nat).
Definition pos_begin_1267_loc : Location :=
  (int8 ; 1269%nat).
Definition pos_1266_loc : Location :=
  (int8 ; 1270%nat).
Notation "'run_f_inp'" :=(
  strobe_t : choice_type) (in custom pack_type at level 2).
Notation "'run_f_inp'" :=(strobe_t : choice_type) (at level 2).
Notation "'run_f_out'" :=(
  strobe_t : choice_type) (in custom pack_type at level 2).
Notation "'run_f_out'" :=(strobe_t : choice_type) (at level 2).
...
Definition pos_begin_1277_loc : Location :=
  (int8 ; 1279%nat).
Definition cur_fl_1278_loc : Location :=
  (int8 ; 1280%nat).
Definition state_1275_loc : Location :=
  (state_uint8_t ; 1281%nat).
Definition pos_1276_loc : Location :=
  (int8 ; 1282%nat).
Notation "'absorb_inp'" :=(
  strobe_t × seq uint8 : choice_type) (in custom pack_type at level 2).
Notation "'absorb_inp'" :=(strobe_t × seq uint8 : choice_type) (at level 2).
Notation "'absorb_out'" :=(
  strobe_t : choice_type) (in custom pack_type at level 2).
Notation "'absorb_out'" :=(strobe_t : choice_type) (at level 2).
  ...
  ((letb '(state_1275, pos_1276, pos_begin_1277, cur_fl_1278) : (
      ...
      letb '(state_1275, pos_1276, pos_begin_1277, cur_fl_1278) :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
            ...
            letb '(state_1275, pos_1276, pos_begin_1277, cur_fl_1278) :=
              if (lift_to_both0 pos_1276) =.? (lift_to_both0 strobe_r_v) :'bool
...
Definition cur_fl_1294_loc : Location :=
  (int8 ; 1295%nat).
Definition state_1291_loc : Location :=
  (state_uint8_t ; 1296%nat).
Definition pos_1292_loc : Location :=
  (int8 ; 1297%nat).
Definition pos_begin_1293_loc : Location :=
  (int8 ; 1298%nat).
Notation "'squeeze_inp'" :=(
  strobe_t × seq uint8 : choice_type) (in custom pack_type at level 2).
Notation "'squeeze_inp'" :=(strobe_t × seq uint8 : choice_type) (at level 2).
Notation "'squeeze_out'" :=((strobe_t × seq uint8
  ) : choice_type) (in custom pack_type at level 2).
Notation "'squeeze_out'" :=((strobe_t × seq uint8) : choice_type) (at level 2).
  ...
  ((letb '(state_1291, pos_1292, pos_begin_1293, cur_fl_1294) : (
      ...
      letb '(data_1300, state_1291, pos_1292, pos_begin_1293, cur_fl_1294) :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
            ...
            letb '(state_1291, pos_1292, pos_begin_1293, cur_fl_1294) :=
              if (lift_to_both0 pos_1292) =.? (lift_to_both0 strobe_r_v) :'bool
              then lift_scope (L1 := fset (
                  [new_state_1250_loc ; word_1251_loc ; new_state_1258_loc ; state_1265_loc ; pos_1266_loc ; pos_begin_1267_loc ; state_1291_loc ; pos_1292_loc ; pos_begin_1293_loc ; cur_fl_1294_loc])) (
                L2 := fset (
                  [new_state_1250_loc ; word_1251_loc ; new_state_1258_loc ; state_1265_loc ; pos_1266_loc ; pos_begin_1267_loc ; state_1291_loc ; pos_1292_loc ; pos_begin_1293_loc ; cur_fl_1294_loc])) (
...
Definition cur_fl_1310_loc : Location :=
  (int8 ; 1313%nat).
Definition state_1307_loc : Location :=
  (state_uint8_t ; 1314%nat).
Definition data_1312_loc : Location :=
  (seq uint8 ; 1315%nat).
Definition ret_1311_loc : Location :=
  ((state_uint8_t × int8 × int8 × int8) ; 1316%nat).
Definition pos_1308_loc : Location :=
  (int8 ; 1317%nat).
Definition pos_begin_1309_loc : Location :=
  (int8 ; 1318%nat).
Notation "'begin_op_inp'" :=(
  strobe_t × int8 × 'bool : choice_type) (in custom pack_type at level 2).
Notation "'begin_op_inp'" :=(
  strobe_t × int8 × 'bool : choice_type) (at level 2).
Notation "'begin_op_out'" :=(
  strobe_t : choice_type) (in custom pack_type at level 2).
Notation "'begin_op_out'" :=(strobe_t : choice_type) (at level 2).
...
Program Definition begin_op (strobe_1319 : strobe_t) (flags_1322 : int8) (
  ...
  ((letb '(state_1307, pos_1308, pos_begin_1309, cur_fl_1310) : (
      ...
      letb '(state_1307, pos_1308, pos_begin_1309, cur_fl_1310, ret_1311) :=
        if negb (lift_to_both0 more_1320) :'bool
        then lift_scope (L1 := fset (
...
Definition st_1329_loc : Location :=
  (state_uint8_t ; 1330%nat).
Notation "'new_strobe_inp'" :=(
  seq uint8 : choice_type) (in custom pack_type at level 2).
Notation "'new_strobe_inp'" :=(seq uint8 : choice_type) (at level 2).
Notation "'new_strobe_out'" :=(
  strobe_t : choice_type) (in custom pack_type at level 2).
Notation "'new_strobe_out'" :=(strobe_t : choice_type) (at level 2).
...
Notation "'meta_ad_inp'" :=(
  strobe_t × seq uint8 × 'bool : choice_type) (in custom pack_type at level 2).
Notation "'meta_ad_inp'" :=(
  strobe_t × seq uint8 × 'bool : choice_type) (at level 2).
Notation "'meta_ad_out'" :=(
  strobe_t : choice_type) (in custom pack_type at level 2).
Notation "'meta_ad_out'" :=(strobe_t : choice_type) (at level 2).
...
Notation "'ad_out'" :=(strobe_t : choice_type) (at level 2).
Definition AD : nat :=
  1341.
...
Notation "'prf_out'" :=((strobe_t × seq uint8) : choice_type) (at level 2).
Definition PRF : nat :=
  1345.
