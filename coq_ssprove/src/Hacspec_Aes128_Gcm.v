...
Definition padded_msg_351_loc : Location :=
  (seq uint8 ; 352%nat).
...
Notation "'pad_aad_msg_out'" :=(byte_seq : choice_type) (at level 2).
Definition PAD_AAD_MSG : nat :=
  359.
Program Definition pad_aad_msg (aad_353 : byte_seq) (msg_355 : byte_seq)
  : both (fset ([padded_msg_351_loc])) [interface] (byte_seq) :=
...
Notation "'encrypt_aes_inp'" :=(
  byte_seq × aes_nonce_t × byte_seq × byte_seq : choice_type) (at level 2).
...
Program Definition encrypt_aes (key_361 : byte_seq) (iv_363 : aes_nonce_t) (
  ...
  : both (fset ([padded_msg_351_loc])) [interface] ((byte_seq × gf128_tag_t
    )) :=
  ((letb iv0_360 : aes_nonce_t := array_new_ (default : uint8) (_) in
      ...
      ) : both (fset ([padded_msg_351_loc])) [interface] ((
        byte_seq ×
        gf128_tag_t
      ))).
Fail Next Obligation.
...
Notation "'encrypt_aes128_inp'" :=(
  key128_t × aes_nonce_t × byte_seq × byte_seq : choice_type) (at level 2).
...
Notation "'decrypt_aes_inp'" :=(
  byte_seq × aes_nonce_t × byte_seq × byte_seq × gf128_tag_t : choice_type) (at level 2).
Notation "'decrypt_aes_out'" :=(
  aes_gcm_byte_seq_result_t : choice_type) (in custom pack_type at level 2).
Notation "'decrypt_aes_out'" :=(
  aes_gcm_byte_seq_result_t : choice_type) (at level 2).
...
Notation "'decrypt_aes128_inp'" :=(
  key128_t × aes_nonce_t × byte_seq × byte_seq × gf128_tag_t : choice_type) (at level 2).
