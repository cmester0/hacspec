...
Definition state_436_loc : Location :=
  (state_t ; 437%nat).
...
Notation "'chacha20_line_inp'" :=(
  state_idx_t × state_idx_t × state_idx_t × uint_size × state_t : choice_type) (at level 2).
Notation "'chacha20_line_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_line_out'" :=(state_t : choice_type) (at level 2).
...
Program Definition chacha20_line (a_439 : state_idx_t) (b_440 : state_idx_t) (
  ...
  : both (fset ([state_436_loc])) [interface] (state_t) :=
...
Notation "'chacha20_quarter_round_inp'" :=(
  state_idx_t × state_idx_t × state_idx_t × state_idx_t × state_t : choice_type) (at level 2).
Notation "'chacha20_quarter_round_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_quarter_round_out'" :=(state_t : choice_type) (at level 2).
...
Notation "'chacha20_double_round_inp'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_double_round_inp'" :=(state_t : choice_type) (at level 2).
Notation "'chacha20_double_round_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_double_round_out'" :=(state_t : choice_type) (at level 2).
...
Definition st_462_loc : Location :=
  (state_t ; 463%nat).
Notation "'chacha20_rounds_inp'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_rounds_inp'" :=(state_t : choice_type) (at level 2).
Notation "'chacha20_rounds_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_rounds_out'" :=(state_t : choice_type) (at level 2).
Definition CHACHA20_ROUNDS : nat :=
  466.
Program Definition chacha20_rounds (state_464 : state_t)
  : both (fset ([state_436_loc ; st_462_loc])) [interface] (state_t) :=
  ((letbm st_462 : state_t loc( st_462_loc ) := lift_to_both0 state_464 in
      letb st_462 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
              usize 10)) st_462 (L := (fset ([state_436_loc ; st_462_loc]))) (
...
Definition state_467_loc : Location :=
  (state_t ; 468%nat).
Notation "'chacha20_core_inp'" :=(
  uint32 × state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_core_inp'" :=(uint32 × state_t : choice_type) (at level 2).
Notation "'chacha20_core_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_core_out'" :=(state_t : choice_type) (at level 2).
Definition CHACHA20_CORE : nat :=
  472.
Program Definition chacha20_core (ctr_470 : uint32) (st0_469 : state_t)
  : both (fset ([state_436_loc ; st_462_loc ; state_467_loc])) [interface] (
    state_t) :=
...
Notation "'chacha20_key_block_inp'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_key_block_inp'" :=(state_t : choice_type) (at level 2).
Notation "'chacha20_key_block_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_key_block_out'" :=(block_t : choice_type) (at level 2).
...
Notation "'chacha20_key_block0_inp'" :=(
  cha_cha_key_t × cha_cha_iv_t : choice_type) (at level 2).
Notation "'chacha20_key_block0_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_key_block0_out'" :=(block_t : choice_type) (at level 2).
...
Notation "'chacha20_encrypt_block_inp'" :=(
  state_t × uint32 × block_t : choice_type) (at level 2).
Notation "'chacha20_encrypt_block_out'" :=(
  block_t : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_encrypt_block_out'" :=(block_t : choice_type) (at level 2).
...
Definition blocks_out_502_loc : Location :=
  (seq uint8 ; 503%nat).
...
Notation "'chacha20_update_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_update_out'" :=(byte_seq : choice_type) (at level 2).
  ...
  ((letbm blocks_out_502 : seq uint8 loc( blocks_out_502_loc ) :=
      ...
      letb blocks_out_502 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 n_blocks_505) blocks_out_502 (L := (fset (
...
Notation "'chacha20_inp'" :=(
  cha_cha_key_t × cha_cha_iv_t × int32 × byte_seq : choice_type) (at level 2).
Notation "'chacha20_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'chacha20_out'" :=(byte_seq : choice_type) (at level 2).
