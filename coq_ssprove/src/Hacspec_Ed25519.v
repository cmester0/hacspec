...
Notation "'scalar_from_hash_inp'" :=(
  sha512_digest_t : choice_type) (at level 2).
Notation "'scalar_from_hash_out'" :=(
  scalar_t : choice_type) (in custom pack_type at level 2).
Notation "'scalar_from_hash_out'" :=(scalar_t : choice_type) (at level 2).
...
Notation "'sign_inp'" :=(secret_key_t × byte_seq : choice_type) (at level 2).
Notation "'sign_out'" :=(
  signature_t : choice_type) (in custom pack_type at level 2).
Notation "'sign_out'" :=(signature_t : choice_type) (at level 2).
Definition SIGN : nat :=
  2534.
...
Notation "'zcash_verify_inp'" :=(
  public_key_t × signature_t × byte_seq : choice_type) (at level 2).
Notation "'zcash_verify_out'" :=(
  verify_result_t : choice_type) (in custom pack_type at level 2).
Notation "'zcash_verify_out'" :=(verify_result_t : choice_type) (at level 2).
...
Program Definition zcash_verify (pk_2536 : public_key_t) (
  ...
  ((letb b_2535 : (
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if negb (check_canonical_scalar (lift_to_both0 s_bytes_2540)) :'bool
      ...
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        ...
        then @Ok 'unit error_t (tt)
        else @Err 'unit error_t (InvalidSignature))
      ) : both (fset.fset0) [interface] (verify_result_t)).
Fail Next Obligation.
...
Notation "'ietf_cofactored_verify_out'" :=(
  verify_result_t : choice_type) (in custom pack_type at level 2).
Notation "'ietf_cofactored_verify_out'" :=(
  verify_result_t : choice_type) (at level 2).
      ...
      letb s_bytes_2554 : serialized_scalar_t :=
        array_from_slice (default : uint8) (32) (
          array_to_seq (lift_to_both0 signature_2552)) (lift_to_both0 (
            usize 32)) (lift_to_both0 (usize 32)) in
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if negb (check_canonical_scalar (lift_to_both0 s_bytes_2554)) :'bool
        then lift_scope (L1 := fset.fset0) (L2 := fset.fset0) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letbnd(
              _) _ : 'unit :=
      ...
      letb s_bytes_2568 : serialized_scalar_t :=
        array_from_slice (default : uint8) (32) (
          array_to_seq (lift_to_both0 signature_2566)) (lift_to_both0 (
            usize 32)) (lift_to_both0 (usize 32)) in
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if negb (check_canonical_scalar (lift_to_both0 s_bytes_2568)) :'bool
        then lift_scope (L1 := fset.fset0) (L2 := fset.fset0) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letbnd(
              _) _ : 'unit :=
...
Notation "'is_identity_inp'" :=(ed_point_t : choice_type) (at level 2).
Notation "'is_identity_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'is_identity_out'" :=('bool : choice_type) (at level 2).
...
Notation "'alg2_verify_out'" :=(
  verify_result_t : choice_type) (in custom pack_type at level 2).
Notation "'alg2_verify_out'" :=(verify_result_t : choice_type) (at level 2).
...
Program Definition alg2_verify (pk_2579 : public_key_t) (
  ...
  ((letb b_2578 : (
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if is_identity (point_mul_by_cofactor (lift_to_both0 a_2580)) :'bool
        then lift_scope (L1 := fset.fset0) (L2 := fset.fset0) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letbnd(
              _) _ : 'unit :=
      ...
      letb s_bytes_2583 : serialized_scalar_t :=
        array_from_slice (default : uint8) (32) (
          array_to_seq (lift_to_both0 signature_2581)) (lift_to_both0 (
            usize 32)) (lift_to_both0 (usize 32)) in
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if negb (check_canonical_scalar (lift_to_both0 s_bytes_2583)) :'bool
        then lift_scope (L1 := fset.fset0) (L2 := fset.fset0) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letbnd(
              _) _ : 'unit :=
...
Definition batch_entry_t : choice_type :=
  (public_key_t × byte_seq × signature_t).
Definition BatchEntry (x : (public_key_t × byte_seq × signature_t
    )) : batch_entry_t :=
   x.

Definition s_sum_2592_loc : Location :=
  (scalar_t ; 2595%nat).
Definition r_sum_2593_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Definition a_sum_2594_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Notation "'zcash_batch_verify_inp'" :=(
  seq batch_entry_t × byte_seq : choice_type) (at level 2).
...
Program Definition zcash_batch_verify (entries_2599 : seq batch_entry_t) (
  ...
  ((letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if (seq_len (lift_to_both0 entropy_2598)) <.? ((lift_to_both0 (
              usize 16)) .* (seq_len (lift_to_both0 entries_2599))) :'bool
        then lift_scope (L1 := fset.fset0) (L2 := fset (
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) '(
        ...
        foldi_bind_both' (lift_to_both0 (usize 0)) (seq_len (
            ...
            r_sum_2593,
            a_sum_2594
          ) (L := (fset ([s_sum_2592_loc ; r_sum_2593_loc ; a_sum_2594_loc]))) (
            ...
            letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
              if negb (check_canonical_scalar (
                  lift_to_both0 s_bytes_2606)) :'bool
              then lift_scope (L1 := fset (
                ...
                letbnd(_) _ : 'unit := @Err 'unit error_t (InvalidS) in
                lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
                  @Ok 'unit error_t (lift_to_both0 ((tt : 'unit))))
                )
              else lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
...
Definition r_sum_2617_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Definition a_sum_2618_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Definition s_sum_2616_loc : Location :=
  (scalar_t ; 2621%nat).
...
Program Definition ietf_cofactored_batch_verify (
  ...
  ((letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if (seq_len (lift_to_both0 entropy_2622)) <.? ((lift_to_both0 (
              usize 16)) .* (seq_len (lift_to_both0 entries_2623))) :'bool
        then lift_scope (L1 := fset.fset0) (L2 := fset (
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) '(
        ...
        foldi_bind_both' (lift_to_both0 (usize 0)) (seq_len (
            ...
            r_sum_2617,
            a_sum_2618
          ) (L := (fset ([s_sum_2616_loc ; r_sum_2617_loc ; a_sum_2618_loc]))) (
            ...
            letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
              if negb (check_canonical_scalar (
                  lift_to_both0 s_bytes_2630)) :'bool
              then lift_scope (L1 := fset (
                  [s_sum_2616_loc ; r_sum_2617_loc ; a_sum_2618_loc])) (
                L2 := fset (
                  [s_sum_2616_loc ; r_sum_2617_loc ; a_sum_2618_loc])) (
...
Definition a_sum_2642_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Definition r_sum_2641_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Definition s_sum_2640_loc : Location :=
  (scalar_t ; 2645%nat).
...
Program Definition ietf_cofactorless_batch_verify (
  ...
  ((letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if (seq_len (lift_to_both0 entropy_2646)) <.? ((lift_to_both0 (
              usize 16)) .* (seq_len (lift_to_both0 entries_2647))) :'bool
        then lift_scope (L1 := fset.fset0) (L2 := fset (
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) '(
        ...
        foldi_bind_both' (lift_to_both0 (usize 0)) (seq_len (
            ...
            r_sum_2641,
            a_sum_2642
          ) (L := (fset ([s_sum_2640_loc ; r_sum_2641_loc ; a_sum_2642_loc]))) (
            ...
            letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
              if negb (check_canonical_scalar (
                  lift_to_both0 s_bytes_2654)) :'bool
              then lift_scope (L1 := fset (
                  [s_sum_2640_loc ; r_sum_2641_loc ; a_sum_2642_loc])) (
                L2 := fset (
                  [s_sum_2640_loc ; r_sum_2641_loc ; a_sum_2642_loc])) (
...
Definition a_sum_2666_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Definition s_sum_2664_loc : Location :=
  (scalar_t ; 2668%nat).
Definition r_sum_2665_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Program Definition alg3_batch_verify (entries_2671 : seq batch_entry_t) (
  ...
  ((letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if (seq_len (lift_to_both0 entropy_2670)) <.? ((lift_to_both0 (
              usize 16)) .* (seq_len (lift_to_both0 entries_2671))) :'bool
        then lift_scope (L1 := fset.fset0) (L2 := fset (
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) '(
        ...
        foldi_bind_both' (lift_to_both0 (usize 0)) (seq_len (
            ...
            r_sum_2665,
            a_sum_2666
          ) (L := (fset ([s_sum_2664_loc ; r_sum_2665_loc ; a_sum_2666_loc]))) (
            ...
            letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
              ...
              then lift_scope (L1 := fset (
                ...
                I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                letbnd(_) _ : 'unit := @Err 'unit error_t (SmallOrderPoint) in
                lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
                  @Ok 'unit error_t (lift_to_both0 ((tt : 'unit))))
                )
              else lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
            ...
            letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
              if negb (check_canonical_scalar (
                  lift_to_both0 s_bytes_2678)) :'bool
              then lift_scope (L1 := fset (
                  [s_sum_2664_loc ; r_sum_2665_loc ; a_sum_2666_loc])) (
                L2 := fset (
                  [s_sum_2664_loc ; r_sum_2665_loc ; a_sum_2666_loc])) (
