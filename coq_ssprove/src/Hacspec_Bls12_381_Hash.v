...
Definition uniform_bytes_2203_loc : Location :=
  (seq uint8 ; 2204%nat).
Definition b_i_2202_loc : Location :=
  (seq uint8 ; 2205%nat).
Definition l_i_b_str_2201_loc : Location :=
  (seq uint8 ; 2206%nat).
Notation "'expand_message_xmd_inp'" :=(
  byte_seq × byte_seq × uint_size : choice_type) (in custom pack_type at level 2).
Notation "'expand_message_xmd_inp'" :=(
  byte_seq × byte_seq × uint_size : choice_type) (at level 2).
Notation "'expand_message_xmd_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'expand_message_xmd_out'" :=(byte_seq : choice_type) (at level 2).
...
Definition output_2218_loc : Location :=
  (seq fp_t ; 2219%nat).
...
Notation "'fp_hash_to_field_out'" :=(seq fp_t : choice_type) (at level 2).
  ...
  ((letb len_in_bytes_2221 : uint_size :=
      ...
      letb output_2218 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 count_2220) output_2218 (L := (fset (
...
Notation "'fp_sgn0_inp'" :=(fp_t : choice_type) (at level 2).
Notation "'fp_sgn0_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'fp_sgn0_out'" :=('bool : choice_type) (at level 2).
...
Notation "'fp_is_square_inp'" :=(
  fp_t : choice_type) (in custom pack_type at level 2).
Notation "'fp_is_square_inp'" :=(fp_t : choice_type) (at level 2).
Notation "'fp_is_square_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'fp_is_square_out'" :=('bool : choice_type) (at level 2).
...
Notation "'fp_sqrt_inp'" :=(
  fp_t : choice_type) (in custom pack_type at level 2).
Notation "'fp_sqrt_inp'" :=(fp_t : choice_type) (at level 2).
Notation "'fp_sqrt_out'" :=(
  fp_t : choice_type) (in custom pack_type at level 2).
Notation "'fp_sqrt_out'" :=(fp_t : choice_type) (at level 2).
...
Notation "'g1_curve_func_inp'" :=(
  fp_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_curve_func_inp'" :=(fp_t : choice_type) (at level 2).
Notation "'g1_curve_func_out'" :=(
  fp_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_curve_func_out'" :=(fp_t : choice_type) (at level 2).
...
Definition y_2242_loc : Location :=
  (fp_t ; 2243%nat).
Definition tv4_2241_loc : Location :=
  (fp_t ; 2244%nat).
Notation "'g1_map_to_curve_svdw_inp'" :=(
  fp_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_map_to_curve_svdw_inp'" :=(fp_t : choice_type) (at level 2).
Notation "'g1_map_to_curve_svdw_out'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_map_to_curve_svdw_out'" :=(g1_t : choice_type) (at level 2).
Definition G1_MAP_TO_CURVE_SVDW : nat :=
  2258.
Program Definition g1_map_to_curve_svdw (u_2247 : fp_t)
  : both (fset ([tv4_2241_loc ; y_2242_loc])) [interface] (g1_t) :=
  ((letb z_2245 : fp_t :=
      ...
      letb '(tv4_2241) :=
        if fp_sgn0 (lift_to_both0 tv4_2241) :'bool
        then lift_scope (L1 := fset ([tv4_2241_loc])) (L2 := fset (
      ...
      letb '(y_2242) :=
        if (fp_sgn0 (lift_to_both0 u_2247)) !=.? (fp_sgn0 (
            lift_to_both0 y_2242)) :'bool
        then lift_scope (L1 := fset ([tv4_2241_loc ; y_2242_loc])) (L2 := fset (
            [tv4_2241_loc ; y_2242_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
...
Notation "'g1_clear_cofactor_inp'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_clear_cofactor_inp'" :=(g1_t : choice_type) (at level 2).
Notation "'g1_clear_cofactor_out'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_clear_cofactor_out'" :=(g1_t : choice_type) (at level 2).
...
Notation "'g1_hash_to_curve_svdw_inp'" :=(
  byte_seq × byte_seq : choice_type) (at level 2).
Notation "'g1_hash_to_curve_svdw_out'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_hash_to_curve_svdw_out'" :=(g1_t : choice_type) (at level 2).
...
Notation "'g1_encode_to_curve_svdw_out'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_encode_to_curve_svdw_out'" :=(g1_t : choice_type) (at level 2).
...
Definition output_2276_loc : Location :=
...
Notation "'fp2_hash_to_field_out'" :=(seq fp2_t : choice_type) (at level 2).
...
Program Definition fp2_hash_to_field (msg_2280 : byte_seq) (
  ...
  ((letb len_in_bytes_2279 : uint_size :=
      ...
      letb output_2276 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 count_2278) output_2276 (L := (fset (
...
Notation "'fp2_sgn0_inp'" :=(fp2_t : choice_type) (at level 2).
Notation "'fp2_sgn0_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'fp2_sgn0_out'" :=('bool : choice_type) (at level 2).
Definition FP2_SGN0 : nat :=
  2297.
Program Definition fp2_sgn0 (x_2291 : fp2_t)
  : both (fset.fset0) [interface] ('bool) :=
  ((letb '(x0_2292, x1_2293) : (fp_t × fp_t) := lift_to_both0 x_2291 in
      letb sign_0_2294 : 'bool := fp_sgn0 (lift_to_both0 x0_2292) in
      letb zero_0_2295 : 'bool := (lift_to_both0 x0_2292) =.? (nat_mod_zero ) in
      letb sign_1_2296 : 'bool := fp_sgn0 (lift_to_both0 x1_2293) in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) ((
...
Notation "'fp2_is_square_inp'" :=(
  fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'fp2_is_square_inp'" :=(fp2_t : choice_type) (at level 2).
Notation "'fp2_is_square_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'fp2_is_square_out'" :=('bool : choice_type) (at level 2).
        ...
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
            ...
            letb '(c_2308) :=
              if nat_mod_bit (lift_to_both0 k_2311) ((lift_to_both0 (
                    usize 380)) .- (lift_to_both0 i_2310)) :'bool
              then lift_scope (L1 := fset ([c_2308_loc])) (L2 := fset (
...
Notation "'fp2_sqrt_inp'" :=(
  fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'fp2_sqrt_inp'" :=(fp2_t : choice_type) (at level 2).
Notation "'fp2_sqrt_out'" :=(
  fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'fp2_sqrt_out'" :=(fp2_t : choice_type) (at level 2).
...
Notation "'g2_curve_func_inp'" :=(
  fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_curve_func_inp'" :=(fp2_t : choice_type) (at level 2).
Notation "'g2_curve_func_out'" :=(
  fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_curve_func_out'" :=(fp2_t : choice_type) (at level 2).
...
Definition y_2326_loc : Location :=
  ((fp_t × fp_t) ; 2327%nat).
Definition tv4_2325_loc : Location :=
  ((fp_t × fp_t) ; 2328%nat).
Notation "'g2_map_to_curve_svdw_inp'" :=(
  fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_map_to_curve_svdw_inp'" :=(fp2_t : choice_type) (at level 2).
Notation "'g2_map_to_curve_svdw_out'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_map_to_curve_svdw_out'" :=(g2_t : choice_type) (at level 2).
Definition G2_MAP_TO_CURVE_SVDW : nat :=
  2343.
Program Definition g2_map_to_curve_svdw (u_2331 : fp2_t)
  : both (fset ([c_2308_loc ; tv4_2325_loc ; y_2326_loc])) [interface] (g2_t) :=
  ((letb z_2329 : (fp_t × fp_t) := fp2neg (fp2fromfp (nat_mod_one )) in
      ...
      letb '(tv4_2325) :=
        if fp2_sgn0 (lift_to_both0 tv4_2325) :'bool
        then lift_scope (L1 := fset ([c_2308_loc ; tv4_2325_loc])) (L2 := fset (
      ...
      letb '(y_2326) :=
        if (fp2_sgn0 (lift_to_both0 u_2331)) !=.? (fp2_sgn0 (
            lift_to_both0 y_2326)) :'bool
        then lift_scope (L1 := fset (
            [c_2308_loc ; tv4_2325_loc ; y_2326_loc])) (L2 := fset (
            [c_2308_loc ; tv4_2325_loc ; y_2326_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
      ...
      ) : both (fset ([c_2308_loc ; tv4_2325_loc ; y_2326_loc])) [interface] (
      g2_t)).
Fail Next Obligation.


Notation "'psi_inp'" :=(g2_t : choice_type) (in custom pack_type at level 2).
Notation "'psi_inp'" :=(g2_t : choice_type) (at level 2).
Notation "'psi_out'" :=(g2_t : choice_type) (in custom pack_type at level 2).
Notation "'psi_out'" :=(g2_t : choice_type) (at level 2).
Definition PSI : nat :=
  2352.
Program Definition psi (p_2346 : g2_t)
  : both (fset ([c_2308_loc])) [interface] (g2_t) :=
...
Notation "'g2_clear_cofactor_inp'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_clear_cofactor_inp'" :=(g2_t : choice_type) (at level 2).
Notation "'g2_clear_cofactor_out'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_clear_cofactor_out'" :=(g2_t : choice_type) (at level 2).
...
Notation "'g2_hash_to_curve_svdw_out'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_hash_to_curve_svdw_out'" :=(g2_t : choice_type) (at level 2).
...
Notation "'g2_encode_to_curve_svdw_out'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_encode_to_curve_svdw_out'" :=(g2_t : choice_type) (at level 2).
...
Program Definition g2_encode_to_curve_svdw (msg_2376 : byte_seq) (
  ...
  ((letb u_2378 : seq fp2_t :=
        fp2_hash_to_field (lift_to_both0 msg_2376) (lift_to_both0 dst_2377) (
          lift_to_both0 (usize 1)) in
      letb q_2379 : ((fp_t × fp_t) × (fp_t × fp_t) × 'bool) :=
        g2_map_to_curve_svdw (seq_index (u_2378) (lift_to_both0 (usize 0))) in
      letb p_2380 : ((fp_t × fp_t) × (fp_t × fp_t) × 'bool) :=
...
Definition x1_2382_loc : Location :=
  (fp_t ; 2384%nat).
Definition y_2383_loc : Location :=
  (fp_t ; 2385%nat).
Notation "'g1_simple_swu_iso_inp'" :=(
  fp_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_simple_swu_iso_inp'" :=(fp_t : choice_type) (at level 2).
Notation "'g1_simple_swu_iso_out'" :=((fp_t × fp_t
  ) : choice_type) (in custom pack_type at level 2).
Notation "'g1_simple_swu_iso_out'" :=((fp_t × fp_t
  ) : choice_type) (at level 2).
Definition G1_SIMPLE_SWU_ISO : nat :=
  2395.
Program Definition g1_simple_swu_iso (u_2389 : fp_t)
  : both (fset ([x1_2382_loc ; y_2383_loc])) [interface] ((fp_t × fp_t)) :=
  ((letb z_2386 : fp_t :=
      ...
      letb '(x1_2382) :=
        if (lift_to_both0 tv1_2390) =.? (nat_mod_zero ) :'bool
        then lift_scope (L1 := fset ([x1_2382_loc])) (L2 := fset (
      ...
      letb '(y_2383) :=
        if (fp_sgn0 (lift_to_both0 u_2389)) !=.? (fp_sgn0 (
            lift_to_both0 y_2383)) :'bool
        then lift_scope (L1 := fset ([x1_2382_loc ; y_2383_loc])) (L2 := fset (
            [x1_2382_loc ; y_2383_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
...
Definition yden_k_2399_loc : Location :=
  (seq fp_t ; 2409%nat).
Definition xx_2405_loc : Location :=
  (fp_t ; 2410%nat).
Definition xnum_k_2396_loc : Location :=
  (seq fp_t ; 2411%nat).
Definition inf_2408_loc : Location :=
  ('bool ; 2412%nat).
Definition xx_2401_loc : Location :=
  (fp_t ; 2413%nat).
Definition xx_2403_loc : Location :=
  (fp_t ; 2414%nat).
Definition xden_k_2397_loc : Location :=
  (seq fp_t ; 2415%nat).
Definition ynum_2404_loc : Location :=
  (fp_t ; 2416%nat).
Definition yden_2406_loc : Location :=
  (fp_t ; 2417%nat).
Definition ynum_k_2398_loc : Location :=
  (seq fp_t ; 2418%nat).
Definition xnum_2400_loc : Location :=
  (fp_t ; 2419%nat).
Definition xden_2402_loc : Location :=
  (fp_t ; 2420%nat).
Definition xx_2407_loc : Location :=
  (fp_t ; 2421%nat).
Notation "'g1_isogeny_map_inp'" :=(
  fp_t × fp_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_isogeny_map_inp'" :=(fp_t × fp_t : choice_type) (at level 2).
Notation "'g1_isogeny_map_out'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_isogeny_map_out'" :=(g1_t : choice_type) (at level 2).
...
Program Definition g1_isogeny_map (x_2423 : fp_t) (y_2428 : fp_t)
  ...
  ((letbm xnum_k_2396 : seq fp_t loc( xnum_k_2396_loc ) :=
      ...
      letbm inf_2408 : 'bool loc( inf_2408_loc ) :=
        lift_to_both0 ((false : 'bool)) in
      letb '(inf_2408) :=
        if ((lift_to_both0 xden_2402) =.? (nat_mod_zero )) || ((
            lift_to_both0 yden_2406) =.? (nat_mod_zero )) :'bool
        then lift_scope (L1 := fset (
            [xnum_k_2396_loc ; xden_k_2397_loc ; ynum_k_2398_loc ; yden_k_2399_loc ; xnum_2400_loc ; xx_2401_loc ; xden_2402_loc ; xx_2403_loc ; ynum_2404_loc ; xx_2405_loc ; yden_2406_loc ; xx_2407_loc ; inf_2408_loc])) (
          L2 := fset (
            [xnum_k_2396_loc ; xden_k_2397_loc ; ynum_k_2398_loc ; yden_k_2399_loc ; xnum_2400_loc ; xx_2401_loc ; xden_2402_loc ; xx_2403_loc ; ynum_2404_loc ; xx_2405_loc ; yden_2406_loc ; xx_2407_loc ; inf_2408_loc])) (
...
Notation "'g1_map_to_curve_sswu_inp'" :=(
  fp_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_map_to_curve_sswu_inp'" :=(fp_t : choice_type) (at level 2).
Notation "'g1_map_to_curve_sswu_out'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_map_to_curve_sswu_out'" :=(g1_t : choice_type) (at level 2).
...
Notation "'g1_hash_to_curve_sswu_out'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_hash_to_curve_sswu_out'" :=(g1_t : choice_type) (at level 2).
...
Notation "'g1_encode_to_curve_sswu_out'" :=(
  g1_t : choice_type) (in custom pack_type at level 2).
Notation "'g1_encode_to_curve_sswu_out'" :=(g1_t : choice_type) (at level 2).
...
Definition x1_2450_loc : Location :=
  ((fp_t × fp_t) ; 2452%nat).
Definition y_2451_loc : Location :=
  ((fp_t × fp_t) ; 2453%nat).
Notation "'g2_simple_swu_iso_inp'" :=(
  fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_simple_swu_iso_inp'" :=(fp2_t : choice_type) (at level 2).
...
Program Definition g2_simple_swu_iso (u_2457 : fp2_t)
  : both (fset ([c_2308_loc ; x1_2450_loc ; y_2451_loc])) [interface] ((
      fp2_t ×
      fp2_t
    )) :=
  ((letb z_2454 : (fp_t × fp_t) :=
      ...
      letb '(x1_2450) :=
        if (lift_to_both0 tv1_2458) =.? (fp2zero ) :'bool
        then lift_scope (L1 := fset ([x1_2450_loc])) (L2 := fset (
      ...
      letb '(y_2451) :=
        if (fp2_sgn0 (lift_to_both0 u_2457)) !=.? (fp2_sgn0 (
            lift_to_both0 y_2451)) :'bool
        then lift_scope (L1 := fset ([c_2308_loc ; x1_2450_loc ; y_2451_loc])) (
          L2 := fset ([c_2308_loc ; x1_2450_loc ; y_2451_loc])) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
...
Definition yden_k_2467_loc : Location :=
  (seq (fp_t × fp_t) ; 2477%nat).
Definition xx_2471_loc : Location :=
  ((fp_t × fp_t) ; 2478%nat).
Definition xden_k_2465_loc : Location :=
  (seq (fp_t × fp_t) ; 2479%nat).
Definition inf_2476_loc : Location :=
  ('bool ; 2480%nat).
Definition xnum_k_2464_loc : Location :=
  (seq (fp_t × fp_t) ; 2481%nat).
Definition xnum_2468_loc : Location :=
  ((fp_t × fp_t) ; 2482%nat).
Definition xden_2470_loc : Location :=
  ((fp_t × fp_t) ; 2483%nat).
Definition yden_2474_loc : Location :=
  ((fp_t × fp_t) ; 2484%nat).
Definition xx_2473_loc : Location :=
  ((fp_t × fp_t) ; 2485%nat).
Definition ynum_k_2466_loc : Location :=
  (seq (fp_t × fp_t) ; 2486%nat).
Definition xx_2475_loc : Location :=
  ((fp_t × fp_t) ; 2487%nat).
Definition xx_2469_loc : Location :=
  ((fp_t × fp_t) ; 2488%nat).
Definition ynum_2472_loc : Location :=
  ((fp_t × fp_t) ; 2489%nat).
Notation "'g2_isogeny_map_inp'" :=(
  fp2_t × fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_isogeny_map_inp'" :=(fp2_t × fp2_t : choice_type) (at level 2).
Notation "'g2_isogeny_map_out'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_isogeny_map_out'" :=(g2_t : choice_type) (at level 2).
...
Program Definition g2_isogeny_map (x_2491 : fp2_t) (y_2496 : fp2_t)
  ...
  ((letbm xnum_k_2464 : seq (fp_t × fp_t) loc( xnum_k_2464_loc ) :=
      ...
      letbm inf_2476 : 'bool loc( inf_2476_loc ) :=
        lift_to_both0 ((false : 'bool)) in
      letb '(inf_2476) :=
        if ((lift_to_both0 xden_2470) =.? (fp2zero )) || ((
            lift_to_both0 yden_2474) =.? (fp2zero )) :'bool
        then lift_scope (L1 := fset (
            [xnum_k_2464_loc ; xden_k_2465_loc ; ynum_k_2466_loc ; yden_k_2467_loc ; xnum_2468_loc ; xx_2469_loc ; xden_2470_loc ; xx_2471_loc ; ynum_2472_loc ; xx_2473_loc ; yden_2474_loc ; xx_2475_loc ; inf_2476_loc])) (
          L2 := fset (
            [xnum_k_2464_loc ; xden_k_2465_loc ; ynum_k_2466_loc ; yden_k_2467_loc ; xnum_2468_loc ; xx_2469_loc ; xden_2470_loc ; xx_2471_loc ; ynum_2472_loc ; xx_2473_loc ; yden_2474_loc ; xx_2475_loc ; inf_2476_loc])) (
...
Notation "'g2_map_to_curve_sswu_inp'" :=(
  fp2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_map_to_curve_sswu_inp'" :=(fp2_t : choice_type) (at level 2).
Notation "'g2_map_to_curve_sswu_out'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_map_to_curve_sswu_out'" :=(g2_t : choice_type) (at level 2).
...
Program Definition g2_map_to_curve_sswu (u_2499 : fp2_t)
  ...
  ((letb '(xp_2500, yp_2501) : (fp2_t × fp2_t) :=
      ...
      letb p_2502 : ((fp_t × fp_t) × (fp_t × fp_t) × 'bool) :=
...
Notation "'g2_hash_to_curve_sswu_out'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_hash_to_curve_sswu_out'" :=(g2_t : choice_type) (at level 2).
...
Notation "'g2_encode_to_curve_sswu_out'" :=(
  g2_t : choice_type) (in custom pack_type at level 2).
Notation "'g2_encode_to_curve_sswu_out'" :=(g2_t : choice_type) (at level 2).
...
Program Definition g2_encode_to_curve_sswu (msg_2512 : byte_seq) (
  ...
  ((letb u_2514 : seq fp2_t :=
        fp2_hash_to_field (lift_to_both0 msg_2512) (lift_to_both0 dst_2513) (
          lift_to_both0 (usize 1)) in
      letb q_2515 : ((fp_t × fp_t) × (fp_t × fp_t) × 'bool) :=
        g2_map_to_curve_sswu (seq_index (u_2514) (lift_to_both0 (usize 0))) in
      letb p_2516 : ((fp_t × fp_t) × (fp_t × fp_t) × 'bool) :=
