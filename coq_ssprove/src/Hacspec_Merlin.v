...
Notation "'merlin_protocol_label_inp'" :=('unit : choice_type) (at level 2).
Notation "'merlin_protocol_label_out'" :=(
  seq uint8 : choice_type) (in custom pack_type at level 2).
Notation "'merlin_protocol_label_out'" :=(seq uint8 : choice_type) (at level 2).
...
Notation "'encode_uint64_inp'" :=(uint64 : choice_type) (at level 2).
Notation "'encode_uint64_out'" :=(
  seq uint8 : choice_type) (in custom pack_type at level 2).
Notation "'encode_uint64_out'" :=(seq uint8 : choice_type) (at level 2).
...
Notation "'encode_usize_as_u32_inp'" :=(uint_size : choice_type) (at level 2).
Notation "'encode_usize_as_u32_out'" :=(
  seq uint8 : choice_type) (in custom pack_type at level 2).
Notation "'encode_usize_as_u32_out'" :=(seq uint8 : choice_type) (at level 2).
...
Notation "'new__inp'" :=(
  seq uint8 : choice_type) (in custom pack_type at level 2).
Notation "'new__inp'" :=(seq uint8 : choice_type) (at level 2).
Notation "'new__out'" :=(
  transcript_t : choice_type) (in custom pack_type at level 2).
Notation "'new__out'" :=(transcript_t : choice_type) (at level 2).
Definition NEW : nat :=
  1355.
...
Notation "'append_message_inp'" :=(
  transcript_t × seq uint8 × seq uint8 : choice_type) (at level 2).
Notation "'append_message_out'" :=(
  transcript_t : choice_type) (in custom pack_type at level 2).
Notation "'append_message_out'" :=(transcript_t : choice_type) (at level 2).
...
Notation "'append_uint64_inp'" :=(
  transcript_t × seq uint8 × uint64 : choice_type) (at level 2).
Notation "'append_uint64_out'" :=(
  transcript_t : choice_type) (in custom pack_type at level 2).
Notation "'append_uint64_out'" :=(transcript_t : choice_type) (at level 2).
