...
Definition crypto_error_t : choice_type :=
...
Notation "'empty_inp'" :=('unit : choice_type) (in custom pack_type at level 2).
Notation "'empty_inp'" :=('unit : choice_type) (at level 2).
Notation "'empty_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'empty_out'" :=(byte_seq : choice_type) (at level 2).
...
Notation "'zeros_inp'" :=(uint_size : choice_type) (at level 2).
Notation "'zeros_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'zeros_out'" :=(byte_seq : choice_type) (at level 2).
...
Definition named_group_t : choice_type :=
  'unit '+ 'unit.
...
Definition hash_algorithm_t : choice_type :=
  'unit '+ 'unit.
...
Definition aead_algorithm_t : choice_type :=
  'unit '+ 'unit '+ 'unit.
...
Definition signature_scheme_t : choice_type :=
  'unit '+ 'unit '+ 'unit.
...
Notation "'hash_len_inp'" :=(hash_algorithm_t : choice_type) (at level 2).
Notation "'hash_len_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'hash_len_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'hmac_key_len_inp'" :=(
  hash_algorithm_t : choice_type) (in custom pack_type at level 2).
Notation "'hmac_key_len_inp'" :=(hash_algorithm_t : choice_type) (at level 2).
Notation "'hmac_key_len_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'hmac_key_len_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'ae_key_len_inp'" :=(aead_algorithm_t : choice_type) (at level 2).
Notation "'ae_key_len_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'ae_key_len_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'ae_iv_len_inp'" :=(
  aead_algorithm_t : choice_type) (in custom pack_type at level 2).
Notation "'ae_iv_len_inp'" :=(aead_algorithm_t : choice_type) (at level 2).
Notation "'ae_iv_len_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'ae_iv_len_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'dh_priv_len_inp'" :=(named_group_t : choice_type) (at level 2).
Notation "'dh_priv_len_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'dh_priv_len_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'dh_pub_len_inp'" :=(
  named_group_t : choice_type) (in custom pack_type at level 2).
Notation "'dh_pub_len_inp'" :=(named_group_t : choice_type) (at level 2).
Notation "'dh_pub_len_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'dh_pub_len_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'zero_key_inp'" :=(
  hash_algorithm_t : choice_type) (in custom pack_type at level 2).
Notation "'zero_key_inp'" :=(hash_algorithm_t : choice_type) (at level 2).
Notation "'zero_key_out'" :=(
  key_t : choice_type) (in custom pack_type at level 2).
Notation "'zero_key_out'" :=(key_t : choice_type) (at level 2).
...
Notation "'p256_ecdh_inp'" :=(dh_sk_t × dh_pk_t : choice_type) (at level 2).
Notation "'p256_ecdh_out'" :=((result (crypto_error_t) (
      key_t)) : choice_type) (in custom pack_type at level 2).
Notation "'p256_ecdh_out'" :=((result (crypto_error_t) (
      key_t)) : choice_type) (at level 2).
...
Program Definition p256_ecdh (x_25 : dh_sk_t) (y_22 : dh_pk_t)
  ...
  ((letbnd(_) _ : 'unit := p256_check_point_len (lift_to_both0 y_22) in
...
Notation "'ecdh_inp'" :=(
  named_group_t × dh_sk_t × dh_pk_t : choice_type) (at level 2).
...
Notation "'kem_priv_len_inp'" :=(kem_scheme_t : choice_type) (at level 2).
Notation "'kem_priv_len_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'kem_priv_len_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'kem_pub_len_inp'" :=(
  kem_scheme_t : choice_type) (in custom pack_type at level 2).
Notation "'kem_pub_len_inp'" :=(kem_scheme_t : choice_type) (at level 2).
Notation "'kem_pub_len_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'kem_pub_len_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'kem_keygen_inner_inp'" :=(
  kem_scheme_t × entropy_t : choice_type) (at level 2).
...
Notation "'kem_encap_inp'" :=(
  kem_scheme_t × kem_pk_t × entropy_t : choice_type) (at level 2).
...
Notation "'kem_decap_inp'" :=(
  kem_scheme_t × byte_seq × kem_sk_t : choice_type) (at level 2).
...
Notation "'check_tag_len_inp'" :=(hmac_t × hmac_t : choice_type) (at level 2).
...
Program Definition check_tag_len (a_64 : hmac_t) (b_65 : hmac_t)
  ...
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        ...
        then @Ok 'unit crypto_error_t (tt)
        else @Err 'unit crypto_error_t (MacFailed))
      ) : both (fset.fset0) [interface] ((result (crypto_error_t) ('unit)))).
Fail Next Obligation.
...
Notation "'check_bytes_inp'" :=(uint8 × uint8 : choice_type) (at level 2).
...
Program Definition check_bytes (a_67 : uint8) (b_68 : uint8)
  ...
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        if is_pure (I := [interface]) (negb (uint8_equal (lift_to_both0 a_67) (
              lift_to_both0 b_68)))
        then @Err 'unit crypto_error_t (MacFailed)
        else @Ok 'unit crypto_error_t (tt))
      ) : both (fset.fset0) [interface] ((result (crypto_error_t) ('unit)))).
Fail Next Obligation.
...
Notation "'hmac_verify_inp'" :=(
  hash_algorithm_t × mac_key_t × byte_seq × hmac_t : choice_type) (at level 2).
  ...
  ((letbnd(_) my_hmac_73 : hmac_t :=
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both crypto_error_t) 'tt :=
        foldi_bind_both' (lift_to_both0 (usize 0)) (seq_len (
            ...
            lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
              @Ok 'unit crypto_error_t (lift_to_both0 ((tt : 'unit))))
            ) in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
...
Notation "'get_length_length_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'get_length_length_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'get_length_length_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'get_length_length_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'get_length_inp'" :=(
  byte_seq × uint_size : choice_type) (at level 2).
Notation "'get_length_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'get_length_out'" :=(uint_size : choice_type) (at level 2).
...
Notation "'get_short_length_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'get_short_length_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'get_short_length_out'" :=(
  uint_size : choice_type) (in custom pack_type at level 2).
Notation "'get_short_length_out'" :=(uint_size : choice_type) (at level 2).
...
Definition seq1_84_loc : Location :=
  (seq uint8 ; 88%nat).
Definition pk_85_loc : Location :=
  (seq uint8 ; 89%nat).
Definition len_86_loc : Location :=
  (uint_size ; 90%nat).
Definition ec_pk_oid_87_loc : Location :=
  ('bool ; 91%nat).
Notation "'verification_key_from_cert_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'verification_key_from_cert_inp'" :=(
  byte_seq : choice_type) (at level 2).
...
Notation "'verification_key_from_cert_out'" :=((result (crypto_error_t) (
      verification_key_t)) : choice_type) (at level 2).
  ...
  ((letb skip_93 : uint_size :=
      ...
      letb '(seq1_84, pk_85) :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 seq1_84)) prod_ce(seq1_84, pk_85) (L := (fset (
              ...
              then lift_scope (L1 := fset (
                ...
                letb '(len_86) :=
                  if (lift_to_both0 len_len_99) !=.? (lift_to_both0 (
                      usize 0)) :'bool
                  then lift_scope (L1 := fset (
                      [seq1_84_loc ; pk_85_loc ; len_86_loc])) (L2 := fset (
                      [seq1_84_loc ; pk_85_loc ; len_86_loc ; ec_pk_oid_87_loc])) (
                    I1 := [interface]) (
                    I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                          ...
                          then lift_scope (L1 := fset (
                            ...
                            letb '(pk_85) :=
                              ...
                              then lift_scope (L1 := fset (
                                ...
                                letb oid_106 : seq uint8 :=
                                  seq_slice (lift_to_both0 seq2_102) (
                                    lift_to_both0 (usize 1)) (lift_to_both0 (
                                      usize 9)) in
                                letbm ec_pk_oid_87 : 'bool loc( ec_pk_oid_87_loc ) :=
                                ...
                                letb '(pk_85) :=
                                  if lift_to_both0 ec_pk_oid_87 :'bool
                                  then lift_scope (L1 := fset (
                                      [seq1_84_loc ; pk_85_loc ; len_86_loc ; ec_pk_oid_87_loc])) (
                                    L2 := fset (
                                      [seq1_84_loc ; pk_85_loc ; len_86_loc ; ec_pk_oid_87_loc])) (
...
Notation "'p256_sign_inp'" :=(
  signature_key_t × byte_seq × entropy_t : choice_type) (at level 2).
...
Notation "'sign_inp'" :=(
  signature_scheme_t × signature_key_t × byte_seq × entropy_t : choice_type) (at level 2).
...
Notation "'p256_verify_inp'" :=(
  verification_key_t × byte_seq × byte_seq : choice_type) (at level 2).
...
Notation "'verify_inp'" :=(
  signature_scheme_t × verification_key_t × byte_seq × byte_seq : choice_type) (at level 2).
...
Program Definition verify (sa_138 : signature_scheme_t) (
  ...
  : both (fset.fset0) [interface] ((result (crypto_error_t) ('unit))) :=
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (TODO match) ) : both (
      fset.fset0) [interface] ((result (crypto_error_t) ('unit)))).
Fail Next Obligation.
...
Notation "'hkdf_extract_inp'" :=(
  hash_algorithm_t × key_t × key_t : choice_type) (at level 2).
...
Notation "'hkdf_expand_inp'" :=(
  hash_algorithm_t × key_t × byte_seq × uint_size : choice_type) (at level 2).
...
Notation "'aes128_encrypt_inp'" :=(
  aead_key_t × aead_iv_t × byte_seq × byte_seq : choice_type) (at level 2).
...
Notation "'aead_encrypt_inp'" :=(
  aead_algorithm_t × aead_key_t × aead_iv_t × byte_seq × byte_seq : choice_type) (at level 2).
