...
Notation "'ch_inp'" :=(uint32 × uint32 × uint32 : choice_type) (at level 2).
Notation "'ch_out'" :=(uint32 : choice_type) (in custom pack_type at level 2).
Notation "'ch_out'" :=(uint32 : choice_type) (at level 2).
Definition CH : nat :=
  835.
...
Notation "'maj_inp'" :=(
  uint32 × uint32 × uint32 : choice_type) (in custom pack_type at level 2).
Notation "'maj_inp'" :=(uint32 × uint32 × uint32 : choice_type) (at level 2).
Notation "'maj_out'" :=(uint32 : choice_type) (in custom pack_type at level 2).
Notation "'maj_out'" :=(uint32 : choice_type) (at level 2).
Definition MAJ : nat :=
  839.
...
Program Definition sigma (x_842 : uint32) (i_843 : uint_size) (
  ...
  ((letbm tmp_840 : uint32 loc( tmp_840_loc ) :=
      ...
      letb '(tmp_840) :=
        if (lift_to_both0 op_844) =.? (lift_to_both0 (usize 0)) :'bool
        then lift_scope (L1 := fset ([tmp_840_loc])) (L2 := fset (
  ...
  ((letb b_849 : seq uint32 := array_to_be_uint32s (lift_to_both0 block_848) in
      ...
      letb s_846 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 k_size_v) s_846 (
            L := (fset ([tmp_840_loc ; s_846_loc]))) (I := [interface]) (
            fun i_850 s_846 =>
            letb '(s_846) :=
              if (lift_to_both0 i_850) <.? (lift_to_both0 (usize 16)) :'bool
              then lift_scope (L1 := fset ([s_846_loc])) (L2 := fset (
              ...
              else  lift_scope (L1 := fset ([tmp_840_loc ; s_846_loc])) (
                L2 := fset ([tmp_840_loc ; s_846_loc])) (I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                letb t16_851 : uint32 :=
...
Definition h_874_loc : Location :=
  (hash_t ; 875%nat).
Notation "'compress_inp'" :=(
  block_t × hash_t : choice_type) (in custom pack_type at level 2).
Notation "'compress_inp'" :=(block_t × hash_t : choice_type) (at level 2).
Notation "'compress_out'" :=(
  hash_t : choice_type) (in custom pack_type at level 2).
Notation "'compress_out'" :=(hash_t : choice_type) (at level 2).
  ...
  ((letb s_877 : round_constants_table_t :=
      ...
      letb h_874 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (usize 8)) h_874 (
            L := (fset ([tmp_840_loc ; s_846_loc ; h_858_loc ; h_874_loc]))) (
...
Definition last_block_len_883_loc : Location :=
  (uint_size ; 885%nat).
Definition pad_block_884_loc : Location :=
  (block_t ; 886%nat).
Definition h_881_loc : Location :=
  (hash_t ; 887%nat).
Definition last_block_882_loc : Location :=
  (block_t ; 888%nat).
Notation "'hash_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'hash_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'hash_out'" :=(
  sha256_digest_t : choice_type) (in custom pack_type at level 2).
Notation "'hash_out'" :=(sha256_digest_t : choice_type) (at level 2).
Definition HASH : nat :=
  895.
  ...
  ((letbm h_881 : hash_t loc( h_881_loc ) := lift_to_both0 hash_init_v in
        ...
        foldi_both' (lift_to_both0 (usize 0)) (seq_num_chunks (
            ...
            letb '(h_881, last_block_882, last_block_len_883) :=
              if (lift_to_both0 block_len_891) <.? (
                lift_to_both0 block_size_v) :'bool
      ...
      letb '(h_881, last_block_882) :=
        if (lift_to_both0 last_block_len_883) <.? ((
            lift_to_both0 block_size_v) .- (lift_to_both0 len_size_v)) :'bool
        then lift_scope (L1 := fset (
            [tmp_840_loc ; s_846_loc ; h_858_loc ; h_874_loc ; h_881_loc ; last_block_882_loc ; last_block_len_883_loc])) (
          L2 := fset (
            [tmp_840_loc ; s_846_loc ; h_858_loc ; h_874_loc ; h_881_loc ; last_block_882_loc ; last_block_len_883_loc ; pad_block_884_loc])) (
...
Notation "'sha256_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'sha256_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'sha256_out'" :=(
  sha256_digest_t : choice_type) (in custom pack_type at level 2).
Notation "'sha256_out'" :=(sha256_digest_t : choice_type) (at level 2).
