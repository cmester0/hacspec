...
Notation "'new__inp'" :=(
  dim_type_t × dim_type_t × seq scalar_t : choice_type) (at level 2).
Notation "'new__out'" :=(
  mat_res_t : choice_type) (in custom pack_type at level 2).
Notation "'new__out'" :=(mat_res_t : choice_type) (at level 2).
Definition NEW : nat :=
  1120.
  ...
  ((letbm ret_1121 : seq int128 loc( ret_1121_loc ) :=
      ...
      letb ret_1121 :=
        foldi_both' (lift_to_both0 (usize 0)) ((lift_to_both0 n_1123) .* (
              lift_to_both0 m_1124)) ret_1121 (L := (fset ([ret_1121_loc]))) (
...
Notation "'zeros_inp'" :=(dim_type_t × dim_type_t : choice_type) (at level 2).
Notation "'zeros_out'" :=(
  matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'zeros_out'" :=(matrix_t : choice_type) (at level 2).
...
Notation "'ones_inp'" :=(
  dim_type_t × dim_type_t : choice_type) (in custom pack_type at level 2).
Notation "'ones_inp'" :=(dim_type_t × dim_type_t : choice_type) (at level 2).
Notation "'ones_out'" :=(
  matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'ones_out'" :=(matrix_t : choice_type) (at level 2).
Definition ONES : nat :=
  1133.
...
Definition ret_1134_loc : Location :=
  (seq int128 ; 1135%nat).
Notation "'identity_inp'" :=(
  dim_type_t × dim_type_t : choice_type) (in custom pack_type at level 2).
Notation "'identity_inp'" :=(
  dim_type_t × dim_type_t : choice_type) (at level 2).
Notation "'identity_out'" :=(
  matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'identity_out'" :=(matrix_t : choice_type) (at level 2).
Definition IDENTITY : nat :=
  1140.
Program Definition identity (n_1136 : dim_type_t) (m_1137 : dim_type_t)
  : both (fset ([ret_1134_loc])) [interface] (matrix_t) :=
  ((letbm ret_1134 : seq int128 loc( ret_1134_loc ) :=
      ...
      letb ret_1134 :=
        foldi_both' (lift_to_both0 (usize 0)) (min (lift_to_both0 n_1136) (
              lift_to_both0 m_1137)) ret_1134 (L := (fset ([ret_1134_loc]))) (
...
Notation "'index_inp'" :=(
  matrix_t × dim_type_t × dim_type_t : choice_type) (at level 2).
Notation "'index_out'" :=(
  scal_res_t : choice_type) (in custom pack_type at level 2).
Notation "'index_out'" :=(scal_res_t : choice_type) (at level 2).
...
Definition ret_1150_loc : Location :=
  (seq int128 ; 1151%nat).
Notation "'transpose_inp'" :=(
  matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'transpose_inp'" :=(matrix_t : choice_type) (at level 2).
Notation "'transpose_out'" :=(
  matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'transpose_out'" :=(matrix_t : choice_type) (at level 2).
Definition TRANSPOSE : nat :=
  1161.
Program Definition transpose (matrix_1152 : matrix_t)
  : both (fset ([ret_1150_loc])) [interface] (matrix_t) :=
  ((letb '(dim_1153, seq_1154) : (dims_t × seq scalar_t) :=
      ...
      letb ret_1150 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 rows_1155) ret_1150 (L := (fset ([ret_1150_loc]))) (
            I := [interface]) (fun i_1157 ret_1150 =>
            letb ret_1150 :=
              foldi_both' (lift_to_both0 (usize 0)) (
                  lift_to_both0 cols_1156) ret_1150 (L := (fset (
...
Definition ret_1162_loc : Location :=
  (seq int128 ; 1164%nat).
Definition res_1163_loc : Location :=
  ((result (int8) (matrix_t)) ; 1165%nat).
Notation "'slice_inp'" :=(
  matrix_t × dims_t × dims_t : choice_type) (in custom pack_type at level 2).
Notation "'slice_inp'" :=(
  matrix_t × dims_t × dims_t : choice_type) (at level 2).
Notation "'slice_out'" :=(
  mat_res_t : choice_type) (in custom pack_type at level 2).
Notation "'slice_out'" :=(mat_res_t : choice_type) (at level 2).
Definition SLICE : nat :=
  1182.
Program Definition slice (matrix_1166 : matrix_t) (start_1171 : dims_t) (
    len_1174 : dims_t)
  : both (fset ([ret_1162_loc ; res_1163_loc])) [interface] (mat_res_t) :=
  ((letb '(dim_1167, seq_1168) : (dims_t × seq scalar_t) :=
      ...
      letb '(ret_1162, res_1163) :=
        if ((lift_to_both0 start_index_1177) .+ ((
            ...
            lift_to_both0 rows_1169) .* (lift_to_both0 cols_1170)) :'bool
        then lift_scope (L1 := fset ([ret_1162_loc ; res_1163_loc])) (
          L2 := fset ([ret_1162_loc ; res_1163_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          letb ret_1162 :=
            foldi_both' (lift_to_both0 (usize 0)) (
                lift_to_both0 len_rows_1175) ret_1162 (L := (fset (
                    [ret_1162_loc ; res_1163_loc]))) (I := [interface]) (
                fun i_1178 ret_1162 =>
                letb ret_1162 :=
                  foldi_both' (lift_to_both0 (usize 0)) (
                      lift_to_both0 len_cols_1176) ret_1162 (L := (fset (
                          [ret_1162_loc ; res_1163_loc]))) (I := [interface]) (
                      fun j_1179 ret_1162 =>
...
Definition ret_1183_loc : Location :=
  (seq int128 ; 1184%nat).
Notation "'scale_inp'" :=(
  matrix_t × scalar_t : choice_type) (in custom pack_type at level 2).
Notation "'scale_inp'" :=(matrix_t × scalar_t : choice_type) (at level 2).
Notation "'scale_out'" :=(
  matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'scale_out'" :=(matrix_t : choice_type) (at level 2).
Definition SCALE : nat :=
  1190.
Program Definition scale (matrix_1185 : matrix_t) (scalar_1189 : scalar_t)
  : both (fset ([ret_1183_loc])) [interface] (matrix_t) :=
  ((letb '(dim_1186, seq_1187) : (dims_t × seq scalar_t) :=
      ...
      letb ret_1183 :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 seq_1187)) ret_1183 (L := (fset ([ret_1183_loc]))) (
            I := [interface]) (fun i_1188 ret_1183 =>
...
Definition res_1192_loc : Location :=
  ((result (int8) (matrix_t)) ; 1193%nat).
Definition ret_1191_loc : Location :=
  (seq int128 ; 1194%nat).
Notation "'add_inp'" :=(
  matrix_t × matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'add_inp'" :=(matrix_t × matrix_t : choice_type) (at level 2).
Notation "'add_out'" :=(
  mat_res_t : choice_type) (in custom pack_type at level 2).
Notation "'add_out'" :=(mat_res_t : choice_type) (at level 2).
Definition ADD : nat :=
  1202.
Program Definition add (matrix_1_1195 : matrix_t) (matrix_2_1198 : matrix_t)
  : both (fset ([ret_1191_loc ; res_1192_loc])) [interface] (mat_res_t) :=
  ((letb '(m1_dim_1196, m1_s_1197) : (dims_t × seq scalar_t) :=
      ...
      letb '(ret_1191, res_1192) :=
        if (lift_to_both0 m1_dim_1196) =.? (lift_to_both0 m2_dim_1199) :'bool
        then lift_scope (L1 := fset ([ret_1191_loc ; res_1192_loc])) (
          L2 := fset ([ret_1191_loc ; res_1192_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          letb ret_1191 :=
            foldi_both' (lift_to_both0 (usize 0)) (seq_len (
                  lift_to_both0 m1_s_1197)) ret_1191 (L := (fset (
...
Definition res_1204_loc : Location :=
  ((result (int8) (matrix_t)) ; 1205%nat).
Definition ret_1203_loc : Location :=
  (seq int128 ; 1206%nat).
Notation "'sub_inp'" :=(
  matrix_t × matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'sub_inp'" :=(matrix_t × matrix_t : choice_type) (at level 2).
Notation "'sub_out'" :=(
  mat_res_t : choice_type) (in custom pack_type at level 2).
Notation "'sub_out'" :=(mat_res_t : choice_type) (at level 2).
Definition SUB : nat :=
  1214.
Program Definition sub (matrix_1_1207 : matrix_t) (matrix_2_1210 : matrix_t)
  : both (fset ([ret_1203_loc ; res_1204_loc])) [interface] (mat_res_t) :=
  ((letb '(m1_dim_1208, m1_s_1209) : (dims_t × seq scalar_t) :=
      ...
      letb '(ret_1203, res_1204) :=
        if (lift_to_both0 m1_dim_1208) =.? (lift_to_both0 m2_dim_1211) :'bool
        then lift_scope (L1 := fset ([ret_1203_loc ; res_1204_loc])) (
          L2 := fset ([ret_1203_loc ; res_1204_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          letb ret_1203 :=
            foldi_both' (lift_to_both0 (usize 0)) (seq_len (
                  lift_to_both0 m1_s_1209)) ret_1203 (L := (fset (
...
Definition ret_1215_loc : Location :=
  (seq int128 ; 1217%nat).
Definition res_1216_loc : Location :=
  ((result (int8) (matrix_t)) ; 1218%nat).
Notation "'component_mul_inp'" :=(
  matrix_t × matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'component_mul_inp'" :=(
  matrix_t × matrix_t : choice_type) (at level 2).
Notation "'component_mul_out'" :=(
  mat_res_t : choice_type) (in custom pack_type at level 2).
Notation "'component_mul_out'" :=(mat_res_t : choice_type) (at level 2).
Definition COMPONENT_MUL : nat :=
  1226.
Program Definition component_mul (matrix_1_1219 : matrix_t) (
    matrix_2_1222 : matrix_t)
  : both (fset ([ret_1215_loc ; res_1216_loc])) [interface] (mat_res_t) :=
  ((letb '(m1_dim_1220, m1_s_1221) : (dims_t × seq scalar_t) :=
      ...
      letb '(ret_1215, res_1216) :=
        if (lift_to_both0 m1_dim_1220) =.? (lift_to_both0 m2_dim_1223) :'bool
        then lift_scope (L1 := fset ([ret_1215_loc ; res_1216_loc])) (
          L2 := fset ([ret_1215_loc ; res_1216_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          letb ret_1215 :=
            foldi_both' (lift_to_both0 (usize 0)) (seq_len (
                  lift_to_both0 m1_s_1221)) ret_1215 (L := (fset (
...
Definition res_1228_loc : Location :=
  ((result (int8) (matrix_t)) ; 1230%nat).
Definition acc_1229_loc : Location :=
  (int128 ; 1231%nat).
Definition ret_1227_loc : Location :=
  (seq int128 ; 1232%nat).
Notation "'mul_inp'" :=(
  matrix_t × matrix_t : choice_type) (in custom pack_type at level 2).
Notation "'mul_inp'" :=(matrix_t × matrix_t : choice_type) (at level 2).
Notation "'mul_out'" :=(
  mat_res_t : choice_type) (in custom pack_type at level 2).
Notation "'mul_out'" :=(mat_res_t : choice_type) (at level 2).
Definition MUL : nat :=
  1249.
Program Definition mul (matrix_1_1233 : matrix_t) (matrix_2_1236 : matrix_t)
  : both (fset ([ret_1227_loc ; res_1228_loc ; acc_1229_loc])) [interface] (
    mat_res_t) :=
  ((letb '(dim_1_1234, seq_1_1235) : (dims_t × seq scalar_t) :=
      ...
      letb '(ret_1227, res_1228) :=
        if (lift_to_both0 m_1240) =.? (lift_to_both0 m_1241) :'bool
        then lift_scope (L1 := fset (
            [ret_1227_loc ; res_1228_loc ; acc_1229_loc])) (L2 := fset (
            [ret_1227_loc ; res_1228_loc ; acc_1229_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
          letb ret_1227 :=
            foldi_both' (lift_to_both0 (usize 0)) (
                lift_to_both0 l_1239) ret_1227 (L := (fset (
                    [ret_1227_loc ; res_1228_loc ; acc_1229_loc]))) (
                I := [interface]) (fun i_1243 ret_1227 =>
                letb ret_1227 :=
                  foldi_both' (lift_to_both0 (usize 0)) (
                      lift_to_both0 n_1242) ret_1227 (L := (fset (
                          [ret_1227_loc ; res_1228_loc ; acc_1229_loc]))) (
                      ...
                      letb acc_1229 :=
                        foldi_both' (lift_to_both0 (usize 0)) (
                            lift_to_both0 m_1240) acc_1229 (L := (fset (
                                [ret_1227_loc ; res_1228_loc ; acc_1229_loc]))) (
