...
Notation "'rsaep_inp'" :=(pk_t × rsa_int_t : choice_type) (at level 2).
Notation "'rsaep_out'" :=(
  rsa_int_result_t : choice_type) (in custom pack_type at level 2).
Notation "'rsaep_out'" :=(rsa_int_result_t : choice_type) (at level 2).
...
Notation "'rsadp_inp'" :=(sk_t × rsa_int_t : choice_type) (at level 2).
Notation "'rsadp_out'" :=(
  rsa_int_result_t : choice_type) (in custom pack_type at level 2).
Notation "'rsadp_out'" :=(rsa_int_result_t : choice_type) (at level 2).
...
Notation "'rsasp1_inp'" :=(
  sk_t × rsa_int_t : choice_type) (in custom pack_type at level 2).
Notation "'rsasp1_inp'" :=(sk_t × rsa_int_t : choice_type) (at level 2).
Notation "'rsasp1_out'" :=(
  rsa_int_result_t : choice_type) (in custom pack_type at level 2).
Notation "'rsasp1_out'" :=(rsa_int_result_t : choice_type) (at level 2).
...
Notation "'rsavp1_inp'" :=(
  pk_t × rsa_int_t : choice_type) (in custom pack_type at level 2).
Notation "'rsavp1_inp'" :=(pk_t × rsa_int_t : choice_type) (at level 2).
Notation "'rsavp1_out'" :=(
  rsa_int_result_t : choice_type) (in custom pack_type at level 2).
Notation "'rsavp1_out'" :=(rsa_int_result_t : choice_type) (at level 2).
...
Notation "'i2osp_inp'" :=(rsa_int_t × int32 : choice_type) (at level 2).
Notation "'i2osp_out'" :=(
  byte_seq_result_t : choice_type) (in custom pack_type at level 2).
Notation "'i2osp_out'" :=(byte_seq_result_t : choice_type) (at level 2).
...
Notation "'os2ip_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'os2ip_out'" :=(
  rsa_int_t : choice_type) (in custom pack_type at level 2).
Notation "'os2ip_out'" :=(rsa_int_t : choice_type) (at level 2).
...
Definition t_3112_loc : Location :=
  (seq uint8 ; 3113%nat).
Definition result_3111_loc : Location :=
  ((result (error_t) (byte_seq)) ; 3114%nat).
Notation "'mgf1_inp'" :=(
  byte_seq × uint_size : choice_type) (in custom pack_type at level 2).
Notation "'mgf1_inp'" :=(byte_seq × uint_size : choice_type) (at level 2).
Notation "'mgf1_out'" :=(
  byte_seq_result_t : choice_type) (in custom pack_type at level 2).
Notation "'mgf1_out'" :=(byte_seq_result_t : choice_type) (at level 2).
Definition MGF1 : nat :=
  3119.
Program Definition mgf1 (mgf_seed_3118 : byte_seq) (mask_len_3115 : uint_size)
  : both (fset ([result_3111_loc ; t_3112_loc])) [interface] (
    byte_seq_result_t) :=
  ((letbm result_3111 : (result (error_t) (byte_seq)) loc( result_3111_loc ) :=
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) '(result_3111) :=
        if (lift_to_both0 mask_len_3115) <.? ((lift_to_both0 (usize 2)) .^ ((
              lift_to_both0 (usize 32)) .* (lift_to_both0 hlen_v))) :'bool
        then lift_scope (L1 := fset ([result_3111_loc ; t_3112_loc])) (
          L2 := fset ([result_3111_loc ; t_3112_loc])) (I1 := [interface]) (
          ...
          letbnd(ChoiceEqualityMonad.result_bind_both error_t) t_3112 :=
            foldi_bind_both' (lift_to_both0 (usize 0)) (((
                  ...
                  fset ([result_3111_loc ; t_3112_loc]))) (I := [interface]) (
                fun i_3116 t_3112 =>
