...
Definition result_1623_loc : Location :=
  (seq int128 ; 1624%nat).
Notation "'round_to_3_inp'" :=(
  seq int128 × int128 : choice_type) (in custom pack_type at level 2).
Notation "'round_to_3_inp'" :=(seq int128 × int128 : choice_type) (at level 2).
Notation "'round_to_3_out'" :=(
  seq int128 : choice_type) (in custom pack_type at level 2).
Notation "'round_to_3_out'" :=(seq int128 : choice_type) (at level 2).
Definition ROUND_TO_3 : nat :=
  1630.
Program Definition round_to_3 (poly_1625 : seq int128) (q_1626 : int128)
  : both (fset ([result_1623_loc])) [interface] (seq int128) :=
  ((letbm result_1623 : seq int128 loc( result_1623_loc ) :=
      ...
      letb result_1623 :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 poly_1625)) result_1623 (L := (fset (
                [result_1623_loc]))) (I := [interface]) (
            fun i_1628 result_1623 =>
            letb '(result_1623) :=
              if (seq_index (poly_1625) (lift_to_both0 i_1628)) >.? (
                lift_to_both0 q_12_1627) :'bool
              then lift_scope (L1 := fset ([result_1623_loc])) (L2 := fset (
      ...
      letb result_1623 :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 result_1623)) result_1623 (L := (fset (
                [result_1623_loc]))) (I := [interface]) (
...
Notation "'encrypt_inp'" :=(
  seq int128 × seq int128 × int128 × seq int128 : choice_type) (at level 2).
Notation "'encrypt_out'" :=(
  seq int128 : choice_type) (in custom pack_type at level 2).
Notation "'encrypt_out'" :=(seq int128 : choice_type) (at level 2).
...
Notation "'ntru_prime_653_encrypt_inp'" :=(
  seq int128 × seq int128 : choice_type) (at level 2).
Notation "'ntru_prime_653_encrypt_out'" :=(
  seq int128 : choice_type) (in custom pack_type at level 2).
Notation "'ntru_prime_653_encrypt_out'" :=(
  seq int128 : choice_type) (at level 2).
Definition NTRU_PRIME_653_ENCRYPT : nat :=
  1643.
Program Definition ntru_prime_653_encrypt (r_1641 : seq int128) (
    h_1642 : seq int128)
  : both (fset ([irr_1619_loc ; result_1623_loc])) [interface] (seq int128) :=
  ((letb p_1637 : uint_size := lift_to_both0 (usize 653) in
      ...
      ) : both (fset ([irr_1619_loc ; result_1623_loc])) [interface] (
      seq int128)).
Fail Next Obligation.

Definition f_3_c_1644_loc : Location :=
  (seq int128 ; 1647%nat).
Definition e_1645_loc : Location :=
  (seq int128 ; 1648%nat).
Definition r_1646_loc : Location :=
  (seq int128 ; 1649%nat).
Notation "'ntru_prime_653_decrypt_inp'" :=(
  seq int128 × seq int128 × seq int128 : choice_type) (in custom pack_type at level 2).
Notation "'ntru_prime_653_decrypt_inp'" :=(
  seq int128 × seq int128 × seq int128 : choice_type) (at level 2).
Notation "'ntru_prime_653_decrypt_out'" :=((seq int128 × 'bool
...
Program Definition ntru_prime_653_decrypt (c_1655 : seq int128) (
  ...
  ((letb p_1650 : uint_size := lift_to_both0 (usize 653) in
      ...
      letb f_3_c_and_decryption_ok_1657 : (seq int128 × 'bool) :=
      ...
      letb '(f_3_c_1658, ok_decrypt_1659) : (seq int128 × 'bool) :=
      ...
      letb f_3_c_1644 :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 f_3_c_1644)) f_3_c_1644 (L := (fset (
            ...
            letb '(f_3_c_1644) :=
              if (seq_index (f_3_c_1644) (lift_to_both0 i_1661)) >.? (
                lift_to_both0 q_12_1660) :'bool
              then lift_scope (L1 := fset ([irr_1619_loc ; f_3_c_1644_loc])) (
                L2 := fset ([irr_1619_loc ; f_3_c_1644_loc])) (
                I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
      ...
      letb e_1645 :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 e_1645)) e_1645 (L := (fset (
                [irr_1619_loc ; f_3_c_1644_loc ; e_1645_loc ; r_1646_loc]))) (
