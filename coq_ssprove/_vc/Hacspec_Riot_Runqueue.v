...
Definition runqueue_id_t : choice_type :=
  int8.
Definition RunqueueId (x : int8) : runqueue_id_t :=
   x.

Definition thread_id_t : choice_type :=
  int8.
...
Program Definition clist_new 
  ...
  ((letbm tail_1737 : tail_t loc( tail_1737_loc ) :=
      ...
      letb next_idxs_1738 :=
        foldi_both' (lift_to_both0 (usize 0)) (array_len (
              lift_to_both0 next_idxs_1738)) next_idxs_1738 (L := (fset (
                [tail_1737_loc ; next_idxs_1738_loc]))) (I := [interface]) (
      ...
      ) : both (fset ([tail_1737_loc ; next_idxs_1738_loc])) [interface] (
      clist_t)).
...
Notation "'clist_is_empty_inp'" :=(
  clist_t × runqueue_id_t : choice_type) (at level 2).
Notation "'clist_is_empty_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'clist_is_empty_out'" :=('bool : choice_type) (at level 2).
...
Definition tail_1750_loc : Location :=
  (tail_t ; 1752%nat).
Definition next_idxs_1751_loc : Location :=
  (next_ids_t ; 1753%nat).
Notation "'clist_push_inp'" :=(
  clist_t × thread_id_t × runqueue_id_t : choice_type) (in custom pack_type at level 2).
Notation "'clist_push_inp'" :=(
  clist_t × thread_id_t × runqueue_id_t : choice_type) (at level 2).
Notation "'clist_push_out'" :=(
  clist_t : choice_type) (in custom pack_type at level 2).
Notation "'clist_push_out'" :=(clist_t : choice_type) (at level 2).
Definition CLIST_PUSH : nat :=
  1759.
Program Definition clist_push (x_1758 : clist_t) (n_1756 : thread_id_t) (
    rq_1754 : runqueue_id_t)
  : both (fset ([tail_1750_loc ; next_idxs_1751_loc])) [interface] (clist_t) :=
  ((letb RunqueueId (rq_1755) : runqueue_id_t := lift_to_both0 rq_1754 in
      ...
      letb '(tail_1750, next_idxs_1751) :=
        if (array_index (next_idxs_1751) (@cast _ uint32 _ (
              lift_to_both0 n_1757))) =.? (lift_to_both0 sentinel_v) :'bool
        then lift_scope (L1 := fset ([tail_1750_loc ; next_idxs_1751_loc])) (
          L2 := fset ([tail_1750_loc ; next_idxs_1751_loc])) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letb '(
            ...
            if (array_index (tail_1750) (@cast _ uint32 _ (
                  lift_to_both0 rq_1755))) =.? (lift_to_both0 sentinel_v) :'bool
            then lift_scope (L1 := fset (
                [tail_1750_loc ; next_idxs_1751_loc])) (L2 := fset (
      ...
      ) : both (fset ([tail_1750_loc ; next_idxs_1751_loc])) [interface] (
      clist_t)).
Fail Next Obligation.

Definition tail_1760_loc : Location :=
  (tail_t ; 1763%nat).
Definition out_1762_loc : Location :=
  ((option (int8)) ; 1764%nat).
Definition next_idxs_1761_loc : Location :=
  (next_ids_t ; 1765%nat).
  ...
  ((letb RunqueueId (rq_1767) : runqueue_id_t := lift_to_both0 rq_1766 in
      ...
      letb '(tail_1760, next_idxs_1761, out_1762) :=
        if (array_index (tail_1760) (@cast _ uint32 _ (
              lift_to_both0 rq_1767))) =.? (lift_to_both0 sentinel_v) :'bool
        then lift_scope (L1 := fset (
            [tail_1760_loc ; next_idxs_1761_loc ; out_1762_loc])) (L2 := fset (
          ...
          letb '(tail_1760, next_idxs_1761) :=
            if (lift_to_both0 head_1769) =.? (array_index (tail_1760) (
                @cast _ uint32 _ (lift_to_both0 rq_1767))) :'bool
            then lift_scope (L1 := fset (
                [tail_1760_loc ; next_idxs_1761_loc ; out_1762_loc])) (
              L2 := fset (
                [tail_1760_loc ; next_idxs_1761_loc ; out_1762_loc])) (
...
Notation "'clist_peek_head_out'" :=((option (int8)) : choice_type) (at level 2).
...
Definition tail_1777_loc : Location :=
  (tail_t ; 1778%nat).
...
Notation "'clist_advance_out'" :=(
  clist_t : choice_type) (in custom pack_type at level 2).
Notation "'clist_advance_out'" :=(clist_t : choice_type) (at level 2).
Definition CLIST_ADVANCE : nat :=
  1783.
Program Definition clist_advance (x_1781 : clist_t) (rq_1779 : runqueue_id_t)
  : both (fset ([tail_1777_loc])) [interface] (clist_t) :=
  ((letb RunqueueId (rq_1780) : runqueue_id_t := lift_to_both0 rq_1779 in
      ...
      letb '(tail_1777) :=
        if (array_index (tail_1777) (@cast _ uint32 _ (
              lift_to_both0 rq_1780))) !=.? (lift_to_both0 sentinel_v) :'bool
        then lift_scope (L1 := fset ([tail_1777_loc])) (L2 := fset (
...
Definition run_queue_t : choice_type :=
  (int32 × clist_t).
...
Notation "'runqueue_new_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'runqueue_new_inp'" :=('unit : choice_type) (at level 2).
Notation "'runqueue_new_out'" :=(
  run_queue_t : choice_type) (in custom pack_type at level 2).
Notation "'runqueue_new_out'" :=(run_queue_t : choice_type) (at level 2).
...
Definition bitcache_1785_loc : Location :=
  (int32 ; 1787%nat).
Definition queues_1786_loc : Location :=
  (clist_t ; 1788%nat).
Notation "'runqueue_add_inp'" :=(
  run_queue_t × thread_id_t × runqueue_id_t : choice_type) (in custom pack_type at level 2).
Notation "'runqueue_add_inp'" :=(
  run_queue_t × thread_id_t × runqueue_id_t : choice_type) (at level 2).
Notation "'runqueue_add_out'" :=(
  run_queue_t : choice_type) (in custom pack_type at level 2).
Notation "'runqueue_add_out'" :=(run_queue_t : choice_type) (at level 2).
...
Definition bitcache_1794_loc : Location :=
  (int32 ; 1795%nat).
...
Notation "'runqueue_del_out'" :=(
  run_queue_t : choice_type) (in custom pack_type at level 2).
Notation "'runqueue_del_out'" :=(run_queue_t : choice_type) (at level 2).
...
Notation "'runqueue_ffs_inp'" :=(int32 : choice_type) (at level 2).
Notation "'runqueue_ffs_out'" :=(
  int32 : choice_type) (in custom pack_type at level 2).
Notation "'runqueue_ffs_out'" :=(int32 : choice_type) (at level 2).
...
Program Definition runqueue_get_next (y_1808 : run_queue_t)
  ...
  ((letb RunQueue ((bitcache_1809, queues_1810)) : run_queue_t :=
      ...
      letb '(out_1806) :=
        if (lift_to_both0 rq_ffs_1811) >.? (lift_to_both0 (@repr U32 0)) :'bool
        then lift_scope (L1 := fset ([out_1806_loc])) (L2 := fset (
...
Program Definition runqueue_advance (y_1816 : run_queue_t) (
  ...
  ((letb RunQueue ((bitcache_1817, queues_1814)) : run_queue_t :=
      ...
      ) : both (fset ([tail_1777_loc ; queues_1814_loc])) [interface] (
      run_queue_t)).
Fail Next Obligation.
