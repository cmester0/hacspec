...
Notation "'parity_inp'" :=(
  uint32 × uint32 × uint32 : choice_type) (in custom pack_type at level 2).
Notation "'parity_inp'" :=(
  uint32 × uint32 × uint32 : choice_type) (at level 2).
Notation "'parity_out'" :=(
  uint32 : choice_type) (in custom pack_type at level 2).
Notation "'parity_out'" :=(uint32 : choice_type) (at level 2).
...
Definition a_1585_loc : Location :=
  (uint32 ; 1591%nat).
Definition c_1587_loc : Location :=
  (uint32 ; 1592%nat).
Definition w_1584_loc : Location :=
  (schedule_t ; 1593%nat).
Definition b_1586_loc : Location :=
  (uint32 ; 1594%nat).
Definition d_1588_loc : Location :=
  (uint32 ; 1595%nat).
Definition e_1589_loc : Location :=
  (uint32 ; 1596%nat).
Definition t_1590_loc : Location :=
  (uint32 ; 1597%nat).
Notation "'compress_inp'" :=(
  block_bytes_t × hash_t : choice_type) (in custom pack_type at level 2).
Notation "'compress_inp'" :=(
  block_bytes_t × hash_t : choice_type) (at level 2).
  ...
  ((letb m_1599 : seq uint32 :=
      ...
      letb w_1584 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
              usize 80)) w_1584 (L := (fset (
                [w_1584_loc ; a_1585_loc ; b_1586_loc ; c_1587_loc ; d_1588_loc ; e_1589_loc ; t_1590_loc]))) (
            I := [interface]) (fun t_1600 w_1584 =>
            letb '(w_1584) :=
              if (lift_to_both0 t_1600) <.? (lift_to_both0 (usize 16)) :'bool
              then lift_scope (L1 := fset ([w_1584_loc])) (L2 := fset (
              ...
              else  lift_scope (L1 := fset ([w_1584_loc])) (L2 := fset (
                  [w_1584_loc])) (I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                letb w_1584 : schedule_t :=
        ...
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
            ...
            letb '(t_1590) :=
              if ((lift_to_both0 (usize 0)) <=.? (lift_to_both0 t_1602)) && ((
                  lift_to_both0 t_1602) <.? (lift_to_both0 (usize 20))) :'bool
            ...
            letb '(t_1590) :=
              if ((lift_to_both0 (usize 20)) <=.? (lift_to_both0 t_1602)) && ((
                  lift_to_both0 t_1602) <.? (lift_to_both0 (usize 40))) :'bool
              then lift_scope (L1 := fset (
                  [w_1584_loc ; a_1585_loc ; b_1586_loc ; c_1587_loc ; d_1588_loc ; e_1589_loc ; t_1590_loc])) (
                L2 := fset (
                  [w_1584_loc ; a_1585_loc ; b_1586_loc ; c_1587_loc ; d_1588_loc ; e_1589_loc ; t_1590_loc])) (
            ...
            letb '(t_1590) :=
              if ((lift_to_both0 (usize 40)) <=.? (lift_to_both0 t_1602)) && ((
                  lift_to_both0 t_1602) <.? (lift_to_both0 (usize 60))) :'bool
              then lift_scope (L1 := fset (
                  [w_1584_loc ; a_1585_loc ; b_1586_loc ; c_1587_loc ; d_1588_loc ; e_1589_loc ; t_1590_loc])) (
                L2 := fset (
                  [w_1584_loc ; a_1585_loc ; b_1586_loc ; c_1587_loc ; d_1588_loc ; e_1589_loc ; t_1590_loc])) (
            ...
            letb '(t_1590) :=
              if ((lift_to_both0 (usize 60)) <=.? (lift_to_both0 t_1602)) && ((
                  lift_to_both0 t_1602) <.? (lift_to_both0 (usize 80))) :'bool
              then lift_scope (L1 := fset (
                  [w_1584_loc ; a_1585_loc ; b_1586_loc ; c_1587_loc ; d_1588_loc ; e_1589_loc ; t_1590_loc])) (
                L2 := fset (
                  [w_1584_loc ; a_1585_loc ; b_1586_loc ; c_1587_loc ; d_1588_loc ; e_1589_loc ; t_1590_loc])) (
...
Definition pad_block_1606_loc : Location :=
  (block_bytes_t ; 1607%nat).
Definition h_1604_loc : Location :=
  (hash_t ; 1608%nat).
Definition block_bytes_1605_loc : Location :=
...
Notation "'hash_out'" :=(sha1_digest_t : choice_type) (at level 2).
Definition HASH : nat :=
  1616.
  ...
  ((letbm h_1604 : hash_t loc( h_1604_loc ) := lift_to_both0 hash_init_v in
      ...
      letb '(h_1604, block_bytes_1605) :=
        if (seq_len (lift_to_both0 raw_bytes_1614)) <.? ((
            ...
            lift_to_both0 bitlength_bytes_v)) :'bool
        then lift_scope (L1 := fset (
...
Notation "'sha1_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'sha1_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'sha1_out'" :=(
  sha1_digest_t : choice_type) (in custom pack_type at level 2).
Notation "'sha1_out'" :=(sha1_digest_t : choice_type) (at level 2).
Definition SHA1 : nat :=
  1618.
