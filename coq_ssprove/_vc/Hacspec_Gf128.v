...
Notation "'fadd_inp'" :=(element_t × element_t : choice_type) (at level 2).
Notation "'fadd_out'" :=(
  element_t : choice_type) (in custom pack_type at level 2).
Notation "'fadd_out'" :=(element_t : choice_type) (at level 2).
Definition FADD : nat :=
  398.
...
Definition res_399_loc : Location :=
  (element_t ; 401%nat).
Definition sh_400_loc : Location :=
  (uint128 ; 402%nat).
Notation "'fmul_inp'" :=(
  element_t × element_t : choice_type) (in custom pack_type at level 2).
Notation "'fmul_inp'" :=(element_t × element_t : choice_type) (at level 2).
Notation "'fmul_out'" :=(
  element_t : choice_type) (in custom pack_type at level 2).
Notation "'fmul_out'" :=(element_t : choice_type) (at level 2).
Definition FMUL : nat :=
  406.
Program Definition fmul (x_403 : element_t) (y_405 : element_t)
  : both (fset ([res_399_loc ; sh_400_loc])) [interface] (element_t) :=
  ((letbm res_399 : element_t loc( res_399_loc ) :=
      ...
      letb '(res_399, sh_400) :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
              usize 128)) prod_ce(res_399, sh_400) (L := (fset (
            ...
            letb '(res_399) :=
              if (uint128_declassify ((lift_to_both0 y_405) .& ((secret (
                  ...
                  secret (lift_to_both0 (@repr U128 0)))) :'bool
              then lift_scope (L1 := fset ([res_399_loc ; sh_400_loc])) (
                L2 := fset ([res_399_loc ; sh_400_loc])) (I1 := [interface]) (
            ...
            letb '(sh_400) :=
              ...
              else  lift_scope (L1 := fset ([res_399_loc ; sh_400_loc])) (
                L2 := fset ([res_399_loc ; sh_400_loc])) (I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                letbm sh_400 loc( sh_400_loc ) :=
                  (lift_to_both0 sh_400) shift_right (lift_to_both0 (
...
Notation "'encode_inp'" :=(gf128_block_t : choice_type) (at level 2).
Notation "'encode_out'" :=(
  element_t : choice_type) (in custom pack_type at level 2).
Notation "'encode_out'" :=(element_t : choice_type) (at level 2).
...
Notation "'decode_inp'" :=(
  element_t : choice_type) (in custom pack_type at level 2).
Notation "'decode_inp'" :=(element_t : choice_type) (at level 2).
Notation "'decode_out'" :=(
  gf128_block_t : choice_type) (in custom pack_type at level 2).
Notation "'decode_out'" :=(gf128_block_t : choice_type) (at level 2).
...
Notation "'update_inp'" :=(
  element_t × gf128_block_t × element_t : choice_type) (at level 2).
Notation "'update_out'" :=(
  element_t : choice_type) (in custom pack_type at level 2).
Notation "'update_out'" :=(element_t : choice_type) (at level 2).
...
Definition block_416_loc : Location :=
  (gf128_block_t ; 418%nat).
Definition last_block_417_loc : Location :=
  (gf128_block_t ; 419%nat).
Definition acc_415_loc : Location :=
  (uint128 ; 420%nat).
Notation "'poly_inp'" :=(
  byte_seq × element_t : choice_type) (in custom pack_type at level 2).
Notation "'poly_inp'" :=(byte_seq × element_t : choice_type) (at level 2).
Notation "'poly_out'" :=(
  element_t : choice_type) (in custom pack_type at level 2).
Notation "'poly_out'" :=(element_t : choice_type) (at level 2).
Definition POLY : nat :=
  429.
  ...
  ((letb l_422 : uint_size := seq_len (lift_to_both0 msg_421) in
      ...
      letb acc_415 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 n_blocks_423) acc_415 (L := (fset (
      ...
      letb '(acc_415) :=
        if (lift_to_both0 rem_424) !=.? (lift_to_both0 (usize 0)) :'bool
...
Notation "'gmac_inp'" :=(byte_seq × gf128_key_t : choice_type) (at level 2).
Notation "'gmac_out'" :=(
  gf128_tag_t : choice_type) (in custom pack_type at level 2).
Notation "'gmac_out'" :=(gf128_tag_t : choice_type) (at level 2).
Definition GMAC : nat :=
  435.
