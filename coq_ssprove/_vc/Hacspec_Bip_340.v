...
Definition error_t : choice_type :=
...
Definition point_t : choice_type :=
  affine_point_t '+ 'unit.
...
Notation "'finite_inp'" :=(point_t : choice_type) (at level 2).
Notation "'finite_out'" :=((option (
      affine_point_t)) : choice_type) (in custom pack_type at level 2).
Notation "'finite_out'" :=((option (
      affine_point_t)) : choice_type) (at level 2).
...
Notation "'x_inp'" :=(
  affine_point_t : choice_type) (in custom pack_type at level 2).
Notation "'x_inp'" :=(affine_point_t : choice_type) (at level 2).
Notation "'x_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'x_out'" :=(field_element_t : choice_type) (at level 2).
Definition X : nat :=
  3124.
...
Notation "'y_inp'" :=(
  affine_point_t : choice_type) (in custom pack_type at level 2).
Notation "'y_inp'" :=(affine_point_t : choice_type) (at level 2).
Notation "'y_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'y_out'" :=(field_element_t : choice_type) (at level 2).
Definition Y : nat :=
  3127.
...
Notation "'has_even_y_inp'" :=(
  affine_point_t : choice_type) (in custom pack_type at level 2).
Notation "'has_even_y_inp'" :=(affine_point_t : choice_type) (at level 2).
Notation "'has_even_y_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'has_even_y_out'" :=('bool : choice_type) (at level 2).
...
Notation "'sqrt_inp'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'sqrt_inp'" :=(field_element_t : choice_type) (at level 2).
Notation "'sqrt_out'" :=((option (
      field_element_t)) : choice_type) (in custom pack_type at level 2).
Notation "'sqrt_out'" :=((option (field_element_t)) : choice_type) (at level 2).
Definition SQRT : nat :=
  3133.
...
Definition y_3134_loc : Location :=
  (field_element_t ; 3135%nat).
Notation "'lift_x_inp'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'lift_x_inp'" :=(field_element_t : choice_type) (at level 2).
...
Program Definition lift_x (x_3140 : field_element_t)
  : both (fset ([y_3134_loc])) [interface] ((result (error_t) (
        affine_point_t))) :=
  ((letb one_3136 : field_element_t := nat_mod_one  in
      ...
      letb '(y_3134) :=
        if ((lift_to_both0 y_3134) rem (lift_to_both0 two_3137)) =.? (
          lift_to_both0 one_3136) :'bool
        then lift_scope (L1 := fset ([y_3134_loc])) (L2 := fset (
...
Notation "'compute_lam_inp'" :=(
  affine_point_t × affine_point_t : choice_type) (at level 2).
Notation "'compute_lam_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'compute_lam_out'" :=(field_element_t : choice_type) (at level 2).
...
Definition result_3147_loc : Location :=
  (point_t ; 3148%nat).
Notation "'point_add_inp'" :=(
  point_t × point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_add_inp'" :=(point_t × point_t : choice_type) (at level 2).
Notation "'point_add_out'" :=(
  point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_add_out'" :=(point_t : choice_type) (at level 2).
Definition POINT_ADD : nat :=
  3155.
Program Definition point_add (p1_3149 : point_t) (p2_3150 : point_t)
  : both (fset ([result_3147_loc])) [interface] (point_t) :=
  ((letbm result_3147 : point_t loc( result_3147_loc ) := AtInfinity in
      letb '(result_3147) :=
        if option_is_none (finite (lift_to_both0 p1_3149)) :'bool
        then lift_scope (L1 := fset ([result_3147_loc])) (L2 := fset (
        ...
        else  lift_scope (L1 := fset ([result_3147_loc])) (L2 := fset (
            [result_3147_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letb '(
              result_3147
            ) :=
            if option_is_none (finite (lift_to_both0 p2_3150)) :'bool
            then lift_scope (L1 := fset ([result_3147_loc])) (L2 := fset (
                [result_3147_loc])) (I1 := [interface]) (
              I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
...
Definition q_3157_loc : Location :=
  (point_t ; 3158%nat).
Definition p_3156_loc : Location :=
  (point_t ; 3159%nat).
Notation "'point_mul_inp'" :=(
  scalar_t × point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_mul_inp'" :=(scalar_t × point_t : choice_type) (at level 2).
Notation "'point_mul_out'" :=(
  point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_mul_out'" :=(point_t : choice_type) (at level 2).
Definition POINT_MUL : nat :=
  3163.
Program Definition point_mul (s_3162 : scalar_t) (p_3160 : point_t)
  : both (fset ([result_3147_loc ; p_3156_loc ; q_3157_loc])) [interface] (
    point_t) :=
...
Notation "'point_mul_base_inp'" :=(scalar_t : choice_type) (at level 2).
Notation "'point_mul_base_out'" :=(
  point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_mul_base_out'" :=(point_t : choice_type) (at level 2).
...
Notation "'tagged_hash_inp'" :=(
  public_byte_seq × byte_seq : choice_type) (at level 2).
Notation "'tagged_hash_out'" :=(
  bytes32_t : choice_type) (in custom pack_type at level 2).
Notation "'tagged_hash_out'" :=(bytes32_t : choice_type) (at level 2).
...
Notation "'hash_aux_inp'" :=(aux_rand_t : choice_type) (at level 2).
Notation "'hash_aux_out'" :=(
  bytes32_t : choice_type) (in custom pack_type at level 2).
Notation "'hash_aux_out'" :=(bytes32_t : choice_type) (at level 2).
...
Notation "'hash_nonce_inp'" :=(
  bytes32_t × bytes32_t × message_t : choice_type) (at level 2).
Notation "'hash_nonce_out'" :=(
  bytes32_t : choice_type) (in custom pack_type at level 2).
Notation "'hash_nonce_out'" :=(bytes32_t : choice_type) (at level 2).
...
Notation "'hash_challenge_inp'" :=(
  bytes32_t × bytes32_t × bytes32_t : choice_type) (at level 2).
Notation "'hash_challenge_out'" :=(
  bytes32_t : choice_type) (in custom pack_type at level 2).
Notation "'hash_challenge_out'" :=(bytes32_t : choice_type) (at level 2).
...
Notation "'bytes_from_point_inp'" :=(
  affine_point_t : choice_type) (in custom pack_type at level 2).
Notation "'bytes_from_point_inp'" :=(affine_point_t : choice_type) (at level 2).
Notation "'bytes_from_point_out'" :=(
  bytes32_t : choice_type) (in custom pack_type at level 2).
Notation "'bytes_from_point_out'" :=(bytes32_t : choice_type) (at level 2).
...
Notation "'bytes_from_scalar_inp'" :=(
  scalar_t : choice_type) (in custom pack_type at level 2).
Notation "'bytes_from_scalar_inp'" :=(scalar_t : choice_type) (at level 2).
Notation "'bytes_from_scalar_out'" :=(
  bytes32_t : choice_type) (in custom pack_type at level 2).
Notation "'bytes_from_scalar_out'" :=(bytes32_t : choice_type) (at level 2).
...
Notation "'scalar_from_bytes_inp'" :=(
  bytes32_t : choice_type) (in custom pack_type at level 2).
Notation "'scalar_from_bytes_inp'" :=(bytes32_t : choice_type) (at level 2).
Notation "'scalar_from_bytes_out'" :=(
  scalar_t : choice_type) (in custom pack_type at level 2).
Notation "'scalar_from_bytes_out'" :=(scalar_t : choice_type) (at level 2).
...
Notation "'scalar_from_bytes_strict_inp'" :=(
  bytes32_t : choice_type) (in custom pack_type at level 2).
Notation "'scalar_from_bytes_strict_inp'" :=(
  bytes32_t : choice_type) (at level 2).
Notation "'scalar_from_bytes_strict_out'" :=((option (
      scalar_t)) : choice_type) (in custom pack_type at level 2).
Notation "'scalar_from_bytes_strict_out'" :=((option (
      scalar_t)) : choice_type) (at level 2).
...
Notation "'fieldelem_from_bytes_inp'" :=(
  public_key_t : choice_type) (at level 2).
  ...
  ((letbm b_3204 : seq uint8 loc( b_3204_loc ) :=
      ...
      letb b_3204 :=
        foldi_both' (lift_to_both0 (usize 0)) (array_len (
              lift_to_both0 b0_3206)) b_3204 (L := (fset ([b_3204_loc]))) (
...
Notation "'pubkey_gen_inp'" :=(secret_key_t : choice_type) (at level 2).
Notation "'pubkey_gen_out'" :=(
  pubkey_gen_result_t : choice_type) (in custom pack_type at level 2).
Notation "'pubkey_gen_out'" :=(pubkey_gen_result_t : choice_type) (at level 2).
...
Notation "'sign_inp'" :=(
  message_t × secret_key_t × aux_rand_t : choice_type) (at level 2).
Notation "'sign_out'" :=(
  sign_result_t : choice_type) (in custom pack_type at level 2).
Notation "'sign_out'" :=(sign_result_t : choice_type) (at level 2).
Definition SIGN : nat :=
  3226.
Program Definition sign (msg_3220 : message_t) (seckey_3214 : secret_key_t) (
  ...
  ((letbnd(_) d0_3215 : scalar_t :=
      ...
      letbnd(ChoiceEqualityMonad.result_bind_both error_t) 'tt :=
        if (lift_to_both0 k0_3221) =.? (nat_mod_zero ) :'bool
        then lift_scope (L1 := fset (
          ...
          lift_scope (H_loc_incl := _) (H_opsig_incl := _) (@Ok 'unit error_t (
              lift_to_both0 ((tt : 'unit))))
          )
        else lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
          @Ok 'unit error_t (lift_to_both0 ((tt : 'unit))))
         in
...
Notation "'verify_inp'" :=(
  message_t × public_key_t × signature_t : choice_type) (at level 2).
Notation "'verify_out'" :=(
  verification_result_t : choice_type) (in custom pack_type at level 2).
Notation "'verify_out'" :=(verification_result_t : choice_type) (at level 2).
...
Program Definition verify (msg_3233 : message_t) (pubkey_3227 : public_key_t) (
  ...
  ((letbnd(_) p_x_3228 : field_element_t :=
      ...
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        ...
        then @Err 'unit error_t (InvalidSignature)
        else @Ok 'unit error_t (tt))
      ) : both (fset (
        [y_3134_loc ; result_3147_loc ; p_3156_loc ; q_3157_loc])) [interface] (
      verification_result_t)).
Fail Next Obligation.
