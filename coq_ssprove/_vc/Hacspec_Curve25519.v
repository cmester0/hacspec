...
Notation "'mask_scalar_inp'" :=(
  x25519_serialized_scalar_t : choice_type) (at level 2).
...
Program Definition mask_scalar (s_612 : x25519_serialized_scalar_t)
  : both (fset ([k_610_loc])) [interface] (x25519_serialized_scalar_t) :=
...
Notation "'decode_scalar_out'" :=(scalar_t : choice_type) (at level 2).
Definition DECODE_SCALAR : nat :=
  616.
Program Definition decode_scalar (s_614 : x25519_serialized_scalar_t)
  : both (fset ([k_610_loc])) [interface] (scalar_t) :=
...
Notation "'encode_point_inp'" :=(
  point_t : choice_type) (in custom pack_type at level 2).
Notation "'encode_point_inp'" :=(point_t : choice_type) (at level 2).
...
Notation "'swap_inp'" :=((point_t × point_t) : choice_type) (at level 2).
Notation "'swap_out'" :=((point_t × point_t
  ) : choice_type) (in custom pack_type at level 2).
Notation "'swap_out'" :=((point_t × point_t) : choice_type) (at level 2).
Definition SWAP : nat :=
  654.
  ...
  ((letb inf_657 : (x25519_field_element_t × x25519_field_element_t) :=
      ...
      letb acc_655 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
              usize 256)) acc_655 (L := (fset ([acc_655_loc]))) (
            I := [interface]) (fun i_659 acc_655 =>
            letb '(acc_655) :=
              if nat_mod_bit (lift_to_both0 k_660) ((lift_to_both0 (
                    usize 255)) .- (lift_to_both0 i_659)) :'bool
              then lift_scope (L1 := fset ([acc_655_loc])) (L2 := fset (
              ...
              else  lift_scope (L1 := fset ([acc_655_loc])) (L2 := fset (
                  [acc_655_loc])) (I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
                letbm acc_655 loc( acc_655_loc ) :=
                  point_add_and_double (lift_to_both0 init_658) (
...
Notation "'x25519_scalarmult_inp'" :=(
  x25519_serialized_scalar_t × x25519_serialized_point_t : choice_type) (at level 2).
...
Program Definition x25519_scalarmult (s_663 : x25519_serialized_scalar_t) (
  ...
  : both (fset ([k_610_loc ; u_617_loc ; acc_655_loc])) [interface] (
...
Definition base_669_loc : Location :=
