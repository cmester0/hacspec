...
Definition bi_3266_loc : Location :=
  (big_int_t ; 3267%nat).
Notation "'big_integer_test_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'big_integer_test_inp'" :=('unit : choice_type) (at level 2).
Notation "'big_integer_test_out'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'big_integer_test_out'" :=('unit : choice_type) (at level 2).
Definition BIG_INTEGER_TEST : nat :=
  3268.
Program Definition big_integer_test 
  : both (fset ([bi_3266_loc])) [interface] ('unit) :=
  ((letb _ : big_int_t := big_int_zero  in
      ...
      letb _ : 'bool := big_int_equal (big_int_one ) (big_int_two ) in
      letbm bi_3266 loc( bi_3266_loc ) :=
...
Definition mi_3269_loc : Location :=
  (int16 ; 3270%nat).
Notation "'machine_integer_test_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'machine_integer_test_inp'" :=('unit : choice_type) (at level 2).
Notation "'machine_integer_test_out'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'machine_integer_test_out'" :=('unit : choice_type) (at level 2).
Definition MACHINE_INTEGER_TEST : nat :=
  3271.
Program Definition machine_integer_test 
  : both (fset ([mi_3269_loc])) [interface] ('unit) :=
  ((letb _ : int32 := pub_uint32_zero  in
      ...
      letb _ : 'bool := pub_uint16_equal (pub_uint16_one ) (pub_uint16_two ) in
      letb _ : 'bool :=
...
Definition ns_3272_loc : Location :=
  (seq int8 ; 3276%nat).
Definition ns_3275_loc : Location :=
  (seq int8 ; 3277%nat).
Definition ns2_3274_loc : Location :=
  (seq int8 ; 3278%nat).
Definition ns1_3273_loc : Location :=
  (seq int8 ; 3279%nat).
Notation "'seq_test_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'seq_test_inp'" :=('unit : choice_type) (at level 2).
Notation "'seq_test_out'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'seq_test_out'" :=('unit : choice_type) (at level 2).
...
Notation "'array_test_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'array_test_inp'" :=('unit : choice_type) (at level 2).
Notation "'array_test_out'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'array_test_out'" :=('unit : choice_type) (at level 2).
Definition ARRAY_TEST : nat :=
  3281.
Program Definition array_test  : both (fset.fset0) [interface] ('unit) :=
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (lift_to_both0 (
          (tt : 'unit)))
      ) : both (fset.fset0) [interface] ('unit)).
Fail Next Obligation.
