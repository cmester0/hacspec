...
Notation "'init_inp'" :=(
  cha_cha_poly_key_t × cha_cha_poly_iv_t : choice_type) (at level 2).
Notation "'init_out'" :=(
  poly_state_t : choice_type) (in custom pack_type at level 2).
Notation "'init_out'" :=(poly_state_t : choice_type) (at level 2).
Definition INIT : nat :=
  523.
...
Definition poly_st_536_loc : Location :=
...
Notation "'chacha20_poly1305_encrypt_inp'" :=(
  cha_cha_poly_key_t × cha_cha_poly_iv_t × byte_seq × byte_seq : choice_type) (at level 2).
...
Program Definition chacha20_poly1305_encrypt (key_538 : cha_cha_poly_key_t) (
  ...
  : both (fset ([last_block_529_loc ; poly_st_536_loc])) [interface] ((
      byte_seq ×
      poly1305_tag_t
    )) :=
...
Definition poly_st_545_loc : Location :=
...
Notation "'chacha20_poly1305_decrypt_inp'" :=(
  cha_cha_poly_key_t × cha_cha_poly_iv_t × byte_seq × byte_seq × poly1305_tag_t : choice_type) (at level 2).
...
Program Definition chacha20_poly1305_decrypt (key_547 : cha_cha_poly_key_t) (
  ...
  : both (fset ([last_block_529_loc ; poly_st_545_loc])) [interface] (
    byte_seq_result_t) :=
