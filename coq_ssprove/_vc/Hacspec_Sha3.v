...
Definition b_1370_loc : Location :=
  (row_t ; 1371%nat).
Notation "'theta_inp'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'theta_inp'" :=(state_t : choice_type) (at level 2).
Notation "'theta_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'theta_out'" :=(state_t : choice_type) (at level 2).
Definition THETA : nat :=
  1378.
Program Definition theta (s_1373 : state_t)
  : both (fset ([b_1370_loc])) [interface] (state_t) :=
  ((letbm b_1370 : row_t loc( b_1370_loc ) :=
      ...
      letb b_1370 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (usize 5)) b_1370 (
            L := (fset ([b_1370_loc]))) (I := [interface]) (fun i_1372 b_1370 =>
            letb b_1370 : row_t :=
      ...
      letb s_1373 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (usize 5)) s_1373 (
            L := (fset ([b_1370_loc]))) (I := [interface]) (fun i_1374 s_1373 =>
            letb u_1375 : uint64 :=
            ...
            letb s_1373 :=
              foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
                    usize 5)) s_1373 (L := (fset ([b_1370_loc]))) (
...
Notation "'rho_inp'" :=(state_t : choice_type) (at level 2).
Notation "'rho_out'" :=(state_t : choice_type) (in custom pack_type at level 2).
Notation "'rho_out'" :=(state_t : choice_type) (at level 2).
Definition RHO : nat :=
  1382.
  ...
  ((letbm b_1388 : row_t loc( b_1388_loc ) :=
      ...
      letb '(s_1390, b_1388) :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (usize 5)) prod_ce(
            s_1390,
            b_1388
          ) (L := (fset ([b_1388_loc]))) (I := [interface]) (fun i_1391 '(
              s_1390,
              b_1388
            ) =>
            letb b_1388 :=
              foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
                    usize 5)) b_1388 (L := (fset ([b_1388_loc]))) (
            ...
            letb s_1390 :=
              foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
                    usize 5)) s_1390 (L := (fset ([b_1388_loc]))) (
...
Notation "'iota_inp'" :=(state_t × int64 : choice_type) (at level 2).
Notation "'iota_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'iota_out'" :=(state_t : choice_type) (at level 2).
Definition IOTA : nat :=
  1398.
...
Notation "'keccakf1600_inp'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'keccakf1600_inp'" :=(state_t : choice_type) (at level 2).
Notation "'keccakf1600_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'keccakf1600_out'" :=(state_t : choice_type) (at level 2).
Definition KECCAKF1600 : nat :=
  1401.
Program Definition keccakf1600 (s_1399 : state_t)
  : both (fset ([b_1370_loc ; v_1383_loc ; b_1388_loc])) [interface] (
    state_t) :=
  ((letb s_1399 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 rounds_v) s_1399 (
            L := (fset ([b_1370_loc ; v_1383_loc ; b_1388_loc]))) (
...
Notation "'absorb_block_inp'" :=(
  state_t × byte_seq : choice_type) (at level 2).
Notation "'absorb_block_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'absorb_block_out'" :=(state_t : choice_type) (at level 2).
...
Program Definition absorb_block (s_1403 : state_t) (block_1402 : byte_seq)
  ...
  ((letb s_1403 :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 block_1402)) s_1403 (L := (fset (
...
Definition out_1408_loc : Location :=
  (seq uint8 ; 1409%nat).
Notation "'squeeze_inp'" :=(
  state_t × uint_size × uint_size : choice_type) (in custom pack_type at level 2).
Notation "'squeeze_inp'" :=(
  state_t × uint_size × uint_size : choice_type) (at level 2).
Notation "'squeeze_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'squeeze_out'" :=(byte_seq : choice_type) (at level 2).
  ...
  ((letbm out_1408 : seq uint8 loc( out_1408_loc ) :=
      ...
      letb '(s_1411, out_1408) :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 nbytes_1410) prod_ce(s_1411, out_1408) (L := (fset (
            ...
            letb '(s_1411) :=
              if (((lift_to_both0 i_1412) .+ (lift_to_both0 (usize 1))) %% (
                  lift_to_both0 rate_1413)) =.? (lift_to_both0 (usize 0)) :'bool
...
Definition buf_1419_loc : Location :=
  (seq uint8 ; 1422%nat).
Definition last_block_len_1420_loc : Location :=
  (uint_size ; 1423%nat).
Definition s_1421_loc : Location :=
  (state_t ; 1424%nat).
Notation "'keccak_inp'" :=(
  uint_size × byte_seq × int8 × uint_size : choice_type) (in custom pack_type at level 2).
Notation "'keccak_inp'" :=(
  uint_size × byte_seq × int8 × uint_size : choice_type) (at level 2).
Notation "'keccak_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'keccak_out'" :=(byte_seq : choice_type) (at level 2).
...
Notation "'sha3224_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'sha3224_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'sha3224_out'" :=(
  digest224_t : choice_type) (in custom pack_type at level 2).
Notation "'sha3224_out'" :=(digest224_t : choice_type) (at level 2).
...
Notation "'sha3256_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'sha3256_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'sha3256_out'" :=(
  digest256_t : choice_type) (in custom pack_type at level 2).
Notation "'sha3256_out'" :=(digest256_t : choice_type) (at level 2).
...
Notation "'sha3384_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'sha3384_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'sha3384_out'" :=(
  digest384_t : choice_type) (in custom pack_type at level 2).
Notation "'sha3384_out'" :=(digest384_t : choice_type) (at level 2).
...
Notation "'sha3512_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'sha3512_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'sha3512_out'" :=(
  digest512_t : choice_type) (in custom pack_type at level 2).
Notation "'sha3512_out'" :=(digest512_t : choice_type) (at level 2).
...
Notation "'shake128_inp'" :=(byte_seq × uint_size : choice_type) (at level 2).
Notation "'shake128_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'shake128_out'" :=(byte_seq : choice_type) (at level 2).
...
Notation "'shake256_inp'" :=(
  byte_seq × uint_size : choice_type) (in custom pack_type at level 2).
Notation "'shake256_inp'" :=(byte_seq × uint_size : choice_type) (at level 2).
Notation "'shake256_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'shake256_out'" :=(byte_seq : choice_type) (at level 2).
