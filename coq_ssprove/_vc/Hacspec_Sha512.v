...
Notation "'ch_inp'" :=(uint64 × uint64 × uint64 : choice_type) (at level 2).
Notation "'ch_out'" :=(uint64 : choice_type) (in custom pack_type at level 2).
Notation "'ch_out'" :=(uint64 : choice_type) (at level 2).
Definition CH : nat :=
  2834.
...
Notation "'maj_inp'" :=(
  uint64 × uint64 × uint64 : choice_type) (in custom pack_type at level 2).
Notation "'maj_inp'" :=(uint64 × uint64 × uint64 : choice_type) (at level 2).
Notation "'maj_out'" :=(uint64 : choice_type) (in custom pack_type at level 2).
Notation "'maj_out'" :=(uint64 : choice_type) (at level 2).
Definition MAJ : nat :=
  2838.
...
Program Definition sigma (x_2841 : uint64) (i_2842 : uint_size) (
  ...
  ((letbm tmp_2839 : uint64 loc( tmp_2839_loc ) :=
      ...
      letb '(tmp_2839) :=
        if (lift_to_both0 op_2843) =.? (lift_to_both0 (usize 0)) :'bool
        then lift_scope (L1 := fset ([tmp_2839_loc])) (L2 := fset (
...
Definition s_2845_loc : Location :=
...
Program Definition schedule (block_2847 : block_t)
  : both (fset ([tmp_2839_loc ; s_2845_loc])) [interface] (
  ...
  ((letb b_2848 : seq uint64 :=
      ...
      letb s_2845 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 k_size_v) s_2845 (
            L := (fset ([tmp_2839_loc ; s_2845_loc]))) (I := [interface]) (
            fun i_2849 s_2845 =>
            letb '(s_2845) :=
              if (lift_to_both0 i_2849) <.? (lift_to_both0 (usize 16)) :'bool
              then lift_scope (L1 := fset ([s_2845_loc])) (L2 := fset (
              ...
              else  lift_scope (L1 := fset ([tmp_2839_loc ; s_2845_loc])) (
                L2 := fset ([tmp_2839_loc ; s_2845_loc])) (I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
...
Definition h_2857_loc : Location :=
  (hash_t ; 2858%nat).
...
Program Definition shuffle (ws_2869 : round_constants_table_t) (
    hashi_2859 : hash_t)
  : both (fset ([tmp_2839_loc ; h_2857_loc])) [interface] (hash_t) :=
  ((letbm h_2857 : hash_t loc( h_2857_loc ) := lift_to_both0 hashi_2859 in
      letb h_2857 :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 k_size_v) h_2857 (
            L := (fset ([tmp_2839_loc ; h_2857_loc]))) (I := [interface]) (
            fun i_2860 h_2857 =>
            letb a0_2861 : uint64 :=
...
Definition h_2873_loc : Location :=
  (hash_t ; 2874%nat).
...
Definition pad_block_2883_loc : Location :=
  (block_t ; 2884%nat).
Definition h_2880_loc : Location :=
  (hash_t ; 2885%nat).
Definition last_block_2881_loc : Location :=
  (block_t ; 2886%nat).
Definition last_block_len_2882_loc : Location :=
  (uint_size ; 2887%nat).
Notation "'hash_inp'" :=(
...
Notation "'hash_out'" :=(sha512_digest_t : choice_type) (at level 2).
Definition HASH : nat :=
  2894.
...
Notation "'sha512_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'sha512_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'sha512_out'" :=(
  sha512_digest_t : choice_type) (in custom pack_type at level 2).
Notation "'sha512_out'" :=(sha512_digest_t : choice_type) (at level 2).
