...
Notation "'vrf_mgf1_inp'" :=(rsa_int_t × byte_seq : choice_type) (at level 2).
Notation "'vrf_mgf1_out'" :=(
  byte_seq_result_t : choice_type) (in custom pack_type at level 2).
Notation "'vrf_mgf1_out'" :=(byte_seq_result_t : choice_type) (at level 2).
...
Notation "'prove_inp'" :=(sk_t × byte_seq : choice_type) (at level 2).
Notation "'prove_out'" :=(
  byte_seq_result_t : choice_type) (in custom pack_type at level 2).
Notation "'prove_out'" :=(byte_seq_result_t : choice_type) (at level 2).
...
Notation "'proof_to_hash_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'proof_to_hash_out'" :=(
  byte_seq_result_t : choice_type) (in custom pack_type at level 2).
Notation "'proof_to_hash_out'" :=(byte_seq_result_t : choice_type) (at level 2).
...
Notation "'verify_inp'" :=(
  pk_t × byte_seq × byte_seq : choice_type) (at level 2).
Notation "'verify_out'" :=(
  byte_seq_result_t : choice_type) (in custom pack_type at level 2).
Notation "'verify_out'" :=(byte_seq_result_t : choice_type) (at level 2).
