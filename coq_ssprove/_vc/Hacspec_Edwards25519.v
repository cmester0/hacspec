...
Notation "'is_negative_inp'" :=(
  ed25519_field_element_t : choice_type) (at level 2).
Notation "'is_negative_out'" :=(
  uint8 : choice_type) (in custom pack_type at level 2).
Notation "'is_negative_out'" :=(uint8 : choice_type) (at level 2).
...
Definition result_2700_loc : Location :=
  ((option (ed25519_field_element_t)) ; 2701%nat).
Notation "'sqrt_inp'" :=(
  ed25519_field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'sqrt_inp'" :=(ed25519_field_element_t : choice_type) (at level 2).
...
Program Definition sqrt (a_2704 : ed25519_field_element_t)
  : both (fset ([result_2700_loc])) [interface] ((option (
        ed25519_field_element_t))) :=
  ((letb p3_8_2702 : ed25519_field_element_t :=
      ...
      letb '(result_2700) :=
        if ((lift_to_both0 x_c_2705) *% (lift_to_both0 x_c_2705)) =.? (
          lift_to_both0 a_2704) :'bool
        then lift_scope (L1 := fset ([result_2700_loc])) (L2 := fset (
      ...
      letb '(result_2700) :=
        if ((lift_to_both0 x_c_2705) *% (lift_to_both0 x_c_2705)) =.? ((
            nat_mod_zero ) -% (lift_to_both0 a_2704)) :'bool
        then lift_scope (L1 := fset ([result_2700_loc])) (L2 := fset (
            [result_2700_loc])) (I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
...
Notation "'check_canonical_point_inp'" :=(
  compressed_ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'check_canonical_point_inp'" :=(
  compressed_ed_point_t : choice_type) (at level 2).
Notation "'check_canonical_point_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'check_canonical_point_out'" :=('bool : choice_type) (at level 2).
...
Definition x_2712_loc : Location :=
  (ed25519_field_element_t ; 2713%nat).
Definition y_s_2711_loc : Location :=
...
Notation "'decompress_out'" :=((option (
      ed_point_t)) : choice_type) (in custom pack_type at level 2).
Notation "'decompress_out'" :=((option (
      ed_point_t)) : choice_type) (at level 2).
Definition DECOMPRESS : nat :=
  2725.
Program Definition decompress (q_2716 : compressed_ed_point_t)
  : both (fset ([result_2700_loc ; y_s_2711_loc ; x_2712_loc])) [interface] ((
      option (ed_point_t))) :=
  ((letb d_2715 : ed25519_field_element_t :=
      ...
      letbnd(ChoiceEqualityMonad.option_bind_both) 'tt :=
        if negb (check_canonical_point (lift_to_both0 y_s_2711)) :'bool
        then lift_scope (L1 := fset ([y_s_2711_loc])) (L2 := fset (
            [result_2700_loc ; y_s_2711_loc ; x_2712_loc])) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letbnd(
              _) _ : ed_point_t :=
            @None ed_point_t in
          lift_scope (H_loc_incl := _) (H_opsig_incl := _) (@Some 'unit (
              lift_to_both0 ((tt : 'unit))))
          )
        else lift_scope (H_loc_incl := _) (H_opsig_incl := _) (@Some 'unit (
            lift_to_both0 ((tt : 'unit))))
         in
      ...
      letbnd(ChoiceEqualityMonad.option_bind_both) 'tt :=
        if ((lift_to_both0 x_2712) =.? (nat_mod_zero )) && ((uint8_declassify (
              lift_to_both0 x_s_2717)) =.? (lift_to_both0 (@repr U8 1))) :'bool
        then lift_scope (L1 := fset (
            [result_2700_loc ; y_s_2711_loc ; x_2712_loc])) (L2 := fset (
            [result_2700_loc ; y_s_2711_loc ; x_2712_loc])) (
          I1 := [interface]) (
          I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (letbnd(
              _) _ : ed_point_t :=
...
Definition y_s_2726_loc : Location :=
  (compressed_ed_point_t ; 2728%nat).
Definition x_2727_loc : Location :=
...
Program Definition decompress_non_canonical (p_2731 : compressed_ed_point_t)
  : both (fset ([result_2700_loc ; y_s_2726_loc ; x_2727_loc])) [interface] ((
      option (ed_point_t))) :=
  ((letb d_2730 : ed25519_field_element_t :=
      ...
      letb '(x_2727) :=
        if (uint8_declassify (lift_to_both0 x_r_2739)) !=.? (uint8_declassify (
            lift_to_both0 x_s_2732)) :'bool
        then lift_scope (L1 := fset (
            [result_2700_loc ; y_s_2726_loc ; x_2727_loc])) (L2 := fset (
...
Definition s_2741_loc : Location :=
  (byte_seq ; 2742%nat).
Notation "'encode_inp'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'encode_inp'" :=(ed_point_t : choice_type) (at level 2).
Notation "'encode_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'encode_out'" :=(byte_seq : choice_type) (at level 2).
Definition ENCODE : nat :=
  2750.
Program Definition encode (p_2743 : ed_point_t)
  : both (fset ([s_2741_loc])) [interface] (byte_seq) :=
...
Notation "'decode_inp'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'decode_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'decode_out'" :=((option (
      ed_point_t)) : choice_type) (in custom pack_type at level 2).
Notation "'decode_out'" :=((option (ed_point_t)) : choice_type) (at level 2).
...
Notation "'point_add_inp'" :=(
  ed_point_t × ed_point_t : choice_type) (at level 2).
Notation "'point_add_out'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_add_out'" :=(ed_point_t : choice_type) (at level 2).
...
Notation "'point_identity_inp'" :=('unit : choice_type) (at level 2).
Notation "'point_identity_out'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_identity_out'" :=(ed_point_t : choice_type) (at level 2).
...
Definition p_2780_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Definition q_2781_loc : Location :=
  ((
      ed25519_field_element_t ×
      ed25519_field_element_t ×
      ed25519_field_element_t ×
...
Notation "'point_mul_inp'" :=(
  scalar_t × ed_point_t : choice_type) (at level 2).
Notation "'point_mul_out'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_mul_out'" :=(ed_point_t : choice_type) (at level 2).
Definition POINT_MUL : nat :=
  2787.
Program Definition point_mul (s_2786 : scalar_t) (p_2784 : ed_point_t)
  : both (fset ([p_2780_loc ; q_2781_loc])) [interface] (ed_point_t) :=
  ((letbm p_2780 : (
          ed25519_field_element_t ×
          ed25519_field_element_t ×
          ed25519_field_element_t ×
      ...
      letb '(p_2780, q_2781) :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
              usize 256)) prod_ce(p_2780, q_2781) (L := (fset (
            ...
            letb '(q_2781) :=
              if nat_mod_bit (lift_to_both0 s_2786) (
                lift_to_both0 i_2785) :'bool
              then lift_scope (L1 := fset ([p_2780_loc ; q_2781_loc])) (
                L2 := fset ([p_2780_loc ; q_2781_loc])) (I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
...
Notation "'point_neg_inp'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_neg_inp'" :=(ed_point_t : choice_type) (at level 2).
Notation "'point_neg_out'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_neg_out'" :=(ed_point_t : choice_type) (at level 2).
...
Notation "'point_eq_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'point_eq_out'" :=('bool : choice_type) (at level 2).
...
Notation "'point_normalize_inp'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_normalize_inp'" :=(ed_point_t : choice_type) (at level 2).
Notation "'point_normalize_out'" :=(
  ed_point_t : choice_type) (in custom pack_type at level 2).
Notation "'point_normalize_out'" :=(ed_point_t : choice_type) (at level 2).
...
Program Definition secret_expand (sk_2819 : secret_key_t)
  : both (fset ([s_2817_loc])) [interface] ((
      serialized_scalar_t ×
      serialized_scalar_t
    )) :=
...
Notation "'secret_to_public_inp'" :=(
  secret_key_t : choice_type) (in custom pack_type at level 2).
Notation "'secret_to_public_inp'" :=(secret_key_t : choice_type) (at level 2).
Notation "'secret_to_public_out'" :=(
  public_key_t : choice_type) (in custom pack_type at level 2).
Notation "'secret_to_public_out'" :=(public_key_t : choice_type) (at level 2).
...
Notation "'check_canonical_scalar_inp'" :=(
  serialized_scalar_t : choice_type) (at level 2).
Notation "'check_canonical_scalar_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'check_canonical_scalar_out'" :=('bool : choice_type) (at level 2).
