...
Notation "'p_inp'" :=('unit : choice_type) (in custom pack_type at level 2).
Notation "'p_inp'" :=('unit : choice_type) (at level 2).
Notation "'p_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'p_out'" :=(field_element_t : choice_type) (at level 2).
Definition P : nat :=
  939.
...
Notation "'d_inp'" :=('unit : choice_type) (in custom pack_type at level 2).
Notation "'d_inp'" :=('unit : choice_type) (at level 2).
Notation "'d_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'d_out'" :=(field_element_t : choice_type) (at level 2).
Definition D : nat :=
  940.
...
Notation "'sqrt_m1_inp'" :=('unit : choice_type) (at level 2).
Notation "'sqrt_m1_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'sqrt_m1_out'" :=(field_element_t : choice_type) (at level 2).
...
Notation "'invsqrt_a_minus_d_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'invsqrt_a_minus_d_inp'" :=('unit : choice_type) (at level 2).
Notation "'invsqrt_a_minus_d_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'invsqrt_a_minus_d_out'" :=(
  field_element_t : choice_type) (at level 2).
...
Notation "'sqrt_ad_minus_one_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'sqrt_ad_minus_one_inp'" :=('unit : choice_type) (at level 2).
...
Notation "'one_minus_d_sq_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'one_minus_d_sq_inp'" :=('unit : choice_type) (at level 2).
Notation "'one_minus_d_sq_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'one_minus_d_sq_out'" :=(field_element_t : choice_type) (at level 2).
...
Notation "'d_minus_one_sq_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'d_minus_one_sq_inp'" :=('unit : choice_type) (at level 2).
Notation "'d_minus_one_sq_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'d_minus_one_sq_out'" :=(field_element_t : choice_type) (at level 2).
...
Notation "'base_point_encoded_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'base_point_encoded_inp'" :=('unit : choice_type) (at level 2).
Notation "'base_point_encoded_out'" :=(
  ristretto_point_encoded_t : choice_type) (in custom pack_type at level 2).
Notation "'base_point_encoded_out'" :=(
  ristretto_point_encoded_t : choice_type) (at level 2).
...
Notation "'base_point_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'base_point_inp'" :=('unit : choice_type) (at level 2).
Notation "'base_point_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'base_point_out'" :=(ristretto_point_t : choice_type) (at level 2).
...
Notation "'identity_point_inp'" :=(
  'unit : choice_type) (in custom pack_type at level 2).
Notation "'identity_point_inp'" :=('unit : choice_type) (at level 2).
Notation "'identity_point_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'identity_point_out'" :=(
  ristretto_point_t : choice_type) (at level 2).
...
Notation "'fe_inp'" :=(uint_size : choice_type) (at level 2).
Notation "'fe_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'fe_out'" :=(field_element_t : choice_type) (at level 2).
Definition FE : nat :=
  950.
...
Definition res_951_loc : Location :=
  ('bool ; 952%nat).
Notation "'geq_p_inp'" :=(
  seq uint8 : choice_type) (in custom pack_type at level 2).
Notation "'geq_p_inp'" :=(seq uint8 : choice_type) (at level 2).
Notation "'geq_p_out'" :=('bool : choice_type) (in custom pack_type at level 2).
Notation "'geq_p_out'" :=('bool : choice_type) (at level 2).
Definition GEQ_P : nat :=
  958.
Program Definition geq_p (x_955 : seq uint8)
  : both (fset ([res_951_loc])) [interface] ('bool) :=
  ((letb p_seq_953 : seq uint8 :=
      ...
      letbm res_951 : 'bool loc( res_951_loc ) :=
        lift_to_both0 ((true : 'bool)) in
      letb res_951 :=
        foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              lift_to_both0 p_seq_953)) res_951 (L := (fset ([res_951_loc]))) (
            I := [interface]) (fun index_954 res_951 =>
            ...
            letb '(res_951) :=
              if (lift_to_both0 x_index_956) !=.? (
                lift_to_both0 p_index_957) :'bool
              then lift_scope (L1 := fset ([res_951_loc])) (L2 := fset (
...
Notation "'is_negative_inp'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'is_negative_inp'" :=(field_element_t : choice_type) (at level 2).
Notation "'is_negative_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'is_negative_out'" :=('bool : choice_type) (at level 2).
...
Notation "'eq_inp'" :=(
  field_element_t × field_element_t : choice_type) (at level 2).
Notation "'eq_out'" :=('bool : choice_type) (in custom pack_type at level 2).
Notation "'eq_out'" :=('bool : choice_type) (at level 2).
Definition EQ : nat :=
  963.
...
Notation "'select_inp'" :=(
  field_element_t × 'bool × field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'select_inp'" :=(
  field_element_t × 'bool × field_element_t : choice_type) (at level 2).
Notation "'select_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'select_out'" :=(field_element_t : choice_type) (at level 2).
Definition SELECT : nat :=
  967.
Program Definition select (u_965 : field_element_t) (cond_964 : 'bool) (
    v_966 : field_element_t)
  : both (fset.fset0) [interface] (field_element_t) :=
  ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
...
Notation "'neg_fe_inp'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'neg_fe_inp'" :=(field_element_t : choice_type) (at level 2).
Notation "'neg_fe_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'neg_fe_out'" :=(field_element_t : choice_type) (at level 2).
...
Notation "'abs_inp'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'abs_inp'" :=(field_element_t : choice_type) (at level 2).
Notation "'abs_out'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'abs_out'" :=(field_element_t : choice_type) (at level 2).
Definition ABS : nat :=
  971.
...
Definition r_972_loc : Location :=
  (field_element_t ; 973%nat).
Notation "'sqrt_ratio_m1_inp'" :=(
  field_element_t × field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'sqrt_ratio_m1_inp'" :=(
  field_element_t × field_element_t : choice_type) (at level 2).
Notation "'sqrt_ratio_m1_out'" :=(('bool × field_element_t
...
Program Definition sqrt_ratio_m1 (u_977 : field_element_t) (
  ...
  : both (fset ([r_972_loc])) [interface] (('bool × field_element_t)) :=
...
Definition s_985_loc : Location :=
  (field_element_t ; 986%nat).
Notation "'map_inp'" :=(
  field_element_t : choice_type) (in custom pack_type at level 2).
Notation "'map_inp'" :=(field_element_t : choice_type) (at level 2).
Notation "'map_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'map_out'" :=(ristretto_point_t : choice_type) (at level 2).
Definition MAP : nat :=
  1001.
Program Definition map (t_989 : field_element_t)
  : both (fset ([r_972_loc ; s_985_loc])) [interface] (ristretto_point_t) :=
  ((letb one_987 : field_element_t := fe (lift_to_both0 (usize 1)) in
      ...
      letb '(was_square_993, s_985) : ('bool × field_element_t) :=
      ...
      ) : both (fset ([r_972_loc ; s_985_loc])) [interface] (
      ristretto_point_t)).
Fail Next Obligation.

Definition r1_bytes_1003_loc : Location :=
  (seq int8 ; 1004%nat).
Definition r0_bytes_1002_loc : Location :=
  (seq int8 ; 1005%nat).
Notation "'one_way_map_inp'" :=(
  byte_string_t : choice_type) (in custom pack_type at level 2).
Notation "'one_way_map_inp'" :=(byte_string_t : choice_type) (at level 2).
Notation "'one_way_map_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'one_way_map_out'" :=(ristretto_point_t : choice_type) (at level 2).
...
Definition y_1014_loc : Location :=
  (field_element_t ; 1015%nat).
Notation "'encode_inp'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'encode_inp'" :=(ristretto_point_t : choice_type) (at level 2).
Notation "'encode_out'" :=(
  ristretto_point_encoded_t : choice_type) (in custom pack_type at level 2).
Notation "'encode_out'" :=(
  ristretto_point_encoded_t : choice_type) (at level 2).
...
Program Definition encode (u_1016 : ristretto_point_t)
  : both (fset ([r_972_loc ; y_1014_loc])) [interface] (
  ...
  ((letb '(x0_1017, y0_1018, z0_1019, t0_1020) : (
      ...
      letb '(_, invsqrt_1023) : ('bool × field_element_t) :=
...
Definition ret_1036_loc : Location :=
...
Notation "'decode_out'" :=(decode_result_t : choice_type) (at level 2).
Definition DECODE : nat :=
  1053.
Program Definition decode (u_1038 : ristretto_point_encoded_t)
  : both (fset ([res_951_loc ; r_972_loc ; ret_1036_loc])) [interface] (
    decode_result_t) :=
  ((letbm ret_1036 : (result (int8) (ristretto_point_t)) loc( ret_1036_loc ) :=
      ...
      letb '(ret_1036) :=
        if (negb (geq_p (array_to_le_bytes (lift_to_both0 u_1038)))) && (negb (
            is_negative (lift_to_both0 s_1039))) :'bool
        then lift_scope (L1 := fset (
            [res_951_loc ; r_972_loc ; ret_1036_loc])) (L2 := fset (
          ...
          letb '(was_square_1046, invsqrt_1047) : ('bool × field_element_t) :=
...
Notation "'equals_inp'" :=(
  ristretto_point_t × ristretto_point_t : choice_type) (at level 2).
Notation "'equals_out'" :=(
  'bool : choice_type) (in custom pack_type at level 2).
Notation "'equals_out'" :=('bool : choice_type) (at level 2).
...
Notation "'add_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'add_out'" :=(ristretto_point_t : choice_type) (at level 2).
Definition ADD : nat :=
  1083.
...
Notation "'neg_inp'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'neg_inp'" :=(ristretto_point_t : choice_type) (at level 2).
Notation "'neg_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'neg_out'" :=(ristretto_point_t : choice_type) (at level 2).
Definition NEG : nat :=
  1089.
...
Notation "'sub_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'sub_out'" :=(ristretto_point_t : choice_type) (at level 2).
Definition SUB : nat :=
  1092.
...
Notation "'double_inp'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'double_inp'" :=(ristretto_point_t : choice_type) (at level 2).
Notation "'double_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'double_out'" :=(ristretto_point_t : choice_type) (at level 2).
...
Definition temp_1110_loc : Location :=
  ((field_element_t × field_element_t × field_element_t × field_element_t
    ) ; 1111%nat).
Definition res_1109_loc : Location :=
  ((field_element_t × field_element_t × field_element_t × field_element_t
    ) ; 1112%nat).
Notation "'mul_inp'" :=(
  scalar_t × ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'mul_inp'" :=(
  scalar_t × ristretto_point_t : choice_type) (at level 2).
Notation "'mul_out'" :=(
  ristretto_point_t : choice_type) (in custom pack_type at level 2).
Notation "'mul_out'" :=(ristretto_point_t : choice_type) (at level 2).
Definition MUL : nat :=
  1116.
Program Definition mul (k_1115 : scalar_t) (p_1113 : ristretto_point_t)
  : both (fset ([res_1109_loc ; temp_1110_loc])) [interface] (
    ristretto_point_t) :=
  ((letbm res_1109 : (
          field_element_t ×
          field_element_t ×
      ...
      letb '(res_1109, temp_1110) :=
        foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
              usize 256)) prod_ce(res_1109, temp_1110) (L := (fset (
            ...
            letb '(res_1109) :=
              if (nat_mod_get_bit (lift_to_both0 k_1115) (
                  ...
                  lift_to_both0 (@repr U128 1))) :'bool
              then lift_scope (L1 := fset ([res_1109_loc ; temp_1110_loc])) (
                L2 := fset ([res_1109_loc ; temp_1110_loc])) (
                I1 := [interface]) (
                I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
