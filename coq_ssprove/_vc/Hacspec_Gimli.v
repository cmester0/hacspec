...
Notation "'swap_inp'" :=(
  state_t × state_idx_t × state_idx_t : choice_type) (at level 2).
Notation "'swap_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'swap_out'" :=(state_t : choice_type) (at level 2).
Definition SWAP : nat :=
  1455.
...
Notation "'gimli_round_inp'" :=(state_t × int32 : choice_type) (at level 2).
Notation "'gimli_round_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'gimli_round_out'" :=(state_t : choice_type) (at level 2).
...
Notation "'gimli_inp'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'gimli_inp'" :=(state_t : choice_type) (at level 2).
Notation "'gimli_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'gimli_out'" :=(state_t : choice_type) (at level 2).
...
Notation "'absorb_block_inp'" :=(block_t × state_t : choice_type) (at level 2).
  ...
  ((letb rate_1480 : uint_size := array_length  in
      ...
      letb s_1483 :=
        foldi_both' (lift_to_both0 (usize 0)) (
            lift_to_both0 chunks_1482) s_1483 (L := (fset (
...
Notation "'gimli_hash_inp'" :=(byte_seq : choice_type) (at level 2).
Notation "'gimli_hash_out'" :=(
  digest_t : choice_type) (in custom pack_type at level 2).
Notation "'gimli_hash_out'" :=(digest_t : choice_type) (at level 2).
Definition GIMLI_HASH : nat :=
  1496.
Program Definition gimli_hash (input_bytes_1491 : byte_seq)
  : both (fset ([block_1471_loc ; input_block_padded_1478_loc])) [interface] (
    digest_t) :=
...
Notation "'process_ad_inp'" :=(
  byte_seq × state_t : choice_type) (in custom pack_type at level 2).
Notation "'process_ad_inp'" :=(byte_seq × state_t : choice_type) (at level 2).
Notation "'process_ad_out'" :=(
  state_t : choice_type) (in custom pack_type at level 2).
Notation "'process_ad_out'" :=(state_t : choice_type) (at level 2).
...
Definition msg_block_padded_1501_loc : Location :=
  (block_t ; 1502%nat).
Definition ciphertext_1500_loc : Location :=
  (seq uint8 ; 1503%nat).
Notation "'process_msg_inp'" :=(
  byte_seq × state_t : choice_type) (in custom pack_type at level 2).
Notation "'process_msg_inp'" :=(byte_seq × state_t : choice_type) (at level 2).
...
Definition message_1517_loc : Location :=
  (seq uint8 ; 1519%nat).
Definition msg_block_1518_loc : Location :=
  (block_t ; 1520%nat).
Notation "'process_ct_inp'" :=(
  byte_seq × state_t : choice_type) (in custom pack_type at level 2).
Notation "'process_ct_inp'" :=(byte_seq × state_t : choice_type) (at level 2).
...
Definition uints_1541_loc : Location :=
  (seq uint32 ; 1542%nat).
Notation "'key_to_u32s_inp'" :=(
  key_t : choice_type) (in custom pack_type at level 2).
Notation "'key_to_u32s_inp'" :=(key_t : choice_type) (at level 2).
Notation "'key_to_u32s_out'" :=(
  seq uint32 : choice_type) (in custom pack_type at level 2).
Notation "'key_to_u32s_out'" :=(seq uint32 : choice_type) (at level 2).
Definition KEY_TO_U32S : nat :=
  1544.
Program Definition key_to_u32s (key_1543 : key_t)
  : both (fset ([uints_1541_loc])) [interface] (seq uint32) :=
...
Notation "'gimli_aead_encrypt_inp'" :=(
  byte_seq × byte_seq × nonce_t × key_t : choice_type) (at level 2).
...
Definition out_1557_loc : Location :=
  (seq uint8 ; 1558%nat).
Notation "'gimli_aead_decrypt_inp'" :=(
  byte_seq × byte_seq × tag_t × nonce_t × key_t : choice_type) (in custom pack_type at level 2).
Notation "'gimli_aead_decrypt_inp'" :=(
  byte_seq × byte_seq × tag_t × nonce_t × key_t : choice_type) (at level 2).
Notation "'gimli_aead_decrypt_out'" :=(
  byte_seq : choice_type) (in custom pack_type at level 2).
Notation "'gimli_aead_decrypt_out'" :=(byte_seq : choice_type) (at level 2).
