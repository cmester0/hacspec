...
type res_typ = Result<usize, bool>;

pub fn mut_var_fun_1() -> res_typ {
    let mut v = 2;
    v = 12;
    res_typ::Ok(v)
}

pub fn mut_var_fun_2() -> usize {
    let mut v = 9;
    v = 3;
    v
}

pub(crate) fn mut_var_calls() -> res_typ {
    mut_var_fun_1()?;
    // let key_ex = mut_var_fun_1()?;
    res_typ::Ok(mut_var_fun_2())
}
