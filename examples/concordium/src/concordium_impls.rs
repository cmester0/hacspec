...
//     // #[ensures(a.produces(creusot_contracts::Seq::EMPTY, a))]
...
//     fn produces_trans(a: Self, ab: creusot_contracts::Seq<Self::Item>, b: Self, bc: creusot_contracts::Seq<Self::Item>, c: Self) {
