...
// #[proof]
// #[quickchick]
// fn test_contract_state_write(data : Seq<u8>) {
//     let mut state = has_contract_state_impl_for_contract_state_open(data);
//     let test0 = write_impl_for_contract_state(&1u64.to_le_bytes()) == Ok(8);
