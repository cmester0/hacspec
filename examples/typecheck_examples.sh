...
typecheck hacspec-hkdf              no-ec      fst    json      coq  Hacspec.Hkdf.fst
typecheck hacspec-hmac              no-ec      fst    json      coq  Hacspec.Hmac.fst
typecheck hacspec-sha256            no-ec      fst    json      coq     Hacspec.Sha256.fst
typecheck hacspec-ntru-prime           ec      fst    json      coq  Hacspec.NtruPrime.fst
...
typecheck hacspec-sha3              no-ec      fst    json      coq  Hacspec.Sha3.fst
