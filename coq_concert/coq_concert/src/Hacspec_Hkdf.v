...
Definition extract (salt_0 : byte_seq) (ikm_1 : byte_seq) : prk_t :=
  ...
  array_from_seq (_) (array_to_seq (hmac (salt_or_zero_2) (ikm_1))).
...
Definition expand
  ...
  bind (check_output_limit (l_14)) (fun n_15 => let t_i_16 : prk_t :=
      ...
      foldi (usize 0) (n_15) (fun i_18 '(t_i_16, t_17) =>
        let hmac_txt_in_19 : seq uint8 :=
          (if ((i_18) =.? (usize 0)):bool then (build_hmac_txt (seq_new_ (
                ...
                seq_from_seq (array_to_seq (t_i_16))) (info_13) (secret ((
                    pub_u8 (i_18)) .+ (@repr WORDSIZE8 1)) : int8))) in 
        let t_i_16 :=
          hmac (prk_12) (hmac_txt_in_19) in 
        let t_17 :=
          seq_update (t_17) ((i_18) * (array_len (t_i_16))) (
            array_to_seq (t_i_16)) in 
        (t_i_16, t_17))
      (t_i_16, t_17) in 
