...
fn translate_literal<'a>(lit: Literal) -> RcDoc<'a, ()> {
    match lit {
        ...
        Literal::Int128(x) => RcDoc::as_string(format!("(repr {} : int128)", x)),
        Literal::UInt128(x) => RcDoc::as_string(format!("(repr {} : int128)", x)),
        Literal::Int64(x) => RcDoc::as_string(format!("(repr {} : int64)", x)),
        Literal::UInt64(x) => RcDoc::as_string(format!("(repr {} : int64)", x)),
        Literal::Int32(x) => RcDoc::as_string(format!("(repr {} : int32)", x)),
        Literal::UInt32(x) => RcDoc::as_string(format!("(repr {} : int32)", x)),
        Literal::Int16(x) => RcDoc::as_string(format!("(repr {} : int16)", x)),
        Literal::UInt16(x) => RcDoc::as_string(format!("(repr {} : int16)", x)),
        Literal::Int8(x) => RcDoc::as_string(format!("(repr {} : int8)", x)),
        Literal::UInt8(x) => RcDoc::as_string(format!("(repr {} : int8)", x)),
