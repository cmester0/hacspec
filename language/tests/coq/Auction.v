...
Definition auction_bid
  ...
  let sender_address_25 : user_address :=
...
Definition auction_finalize
  ...
  let 'State ((
    ...
    (state_36) in 
  let result_43 : (result (state × finalize_action) finalize_error) :=
    @Ok (state × finalize_action) finalize_error (((state_36), Accept)) in 
  ...
  let '(slot_time_44, owner_45, balance_46) :=
    ctx_35 in 
  ...
  thenbnd (let return_action_47 : finalize_action :=
      SimpleTransfer (seq_concat (seq_concat (seq_new_ (@repr WORDSIZE8 0) (
              usize 0)) (owner_45)) (u64_to_be_bytes (highest_bid_38))) in 
    let remaining_bid_48 : bid_remain :=
      BidNone in 
    bind (foldibnd (usize 0) to ((seq_len ((m0_41))) / (usize 32)) for (
        auction_state_37,
        return_action_47,
        remaining_bid_48
      )>> (fun x_49 '(auction_state_37, return_action_47, remaining_bid_48) =>
      let addr_50 : user_address :=
        array_from_seq (32) (seq_slice ((m0_41)) ((x_49) * (usize 32)) (
            usize 32)) in 
      let amnt_51 : int64 :=
        u64_from_be_bytes (array_from_seq (8) (seq_slice ((m1_42)) ((x_49) * (
                usize 8)) (usize 8))) in 
      ifbnd (amnt_51) <.? (highest_bid_38) : bool
      then (let return_action_47 :=
          match return_action_47 with
          | Accept => Accept
          | SimpleTransfer m_52 => SimpleTransfer (seq_concat (seq_concat (
                m_52) (addr_50)) (u64_to_be_bytes (amnt_51)))
          end in 
      ...
      elsebnd(ifbnd negb ((remaining_bid_48) =.? (BidNone)) : bool
        ...
        let auction_state_37 :=
          Sold (addr_50) in 
        let remaining_bid_48 :=
          BidSome (amnt_51) in 
      ...
      Ok ((auction_state_37, return_action_47, remaining_bid_48))))) (fun '(
        ...
        match remaining_bid_48 with
        | BidSome amount_53 => (if (negb ((amount_53) =.? (
                highest_bid_38))):bool then (@Err (state × finalize_action
      ...
      bind ((result_43)) (fun _ => Ok ((auction_state_37, result_43)))))
...
Theorem ensures_auction_test_init : forall result_56 (
  item_54 : public_byte_seq) (time_55 : int64),
 @auction_test_init item_54 time_55 = result_56 ->
 result_56 = true.
 Proof. Admitted.
QuickChick (
  forAll g_public_byte_seq (fun item_54 : public_byte_seq =>forAll g_int64 (fun time_55 : int64 =>auction_test_init item_54 time_55))).
...
Definition new_account
  ...
  let addr_75 : user_address :=
    useraddress_from_u8 (i_74) in 
  let ctx_76 : (int64 × user_address_set) :=
    (time_73, UserAddressSome (addr_75)) in 
  (addr_75, ctx_76).
...
Definition test_auction_bid_and_finalize
  ...
  let winning_amount_80 : int64 :=
    @repr WORDSIZE64 300 in 
  let big_amount_81 : int64 :=
    @repr WORDSIZE64 500 in 
  let bid_map_82 : seq_map :=
    SeqMap ((
        seq_new_ (@repr WORDSIZE8 0) (usize 0),
        seq_new_ (@repr WORDSIZE8 0) (usize 0)
      )) in 
  let state_83 : state :=
    fresh_state ((item_77)) (time_78) in 
  let '(alice_84, alice_ctx_85) :=
    new_account (time_78) (@repr WORDSIZE8 0) in 
  let '(state_86, bid_map_87, res_0_88, result_0_89) :=
    verify_bid ((item_77)) (state_83) (alice_84) (alice_ctx_85) (amount_79) (
      bid_map_82) (amount_79) (time_78) in 
  let '(state_90, bid_map_91, res_1_92, result_1_93) :=
    verify_bid ((item_77)) (state_86) (alice_84) (alice_ctx_85) (amount_79) (
      bid_map_87) ((amount_79) .+ (amount_79)) (time_78) in 
  let '(bob_94, bob_ctx_95) :=
    new_account (time_78) (@repr WORDSIZE8 1) in 
  let '(state_96, bid_map_97, res_2_98, result_2_99) :=
    verify_bid ((item_77)) (state_90) (bob_94) (bob_ctx_95) (
      winning_amount_80) (bid_map_91) (winning_amount_80) (time_78) in 
  let owner_100 : user_address :=
    useraddress_from_u8 (@repr WORDSIZE8 0) in 
  let balance_101 : int64 :=
    @repr WORDSIZE64 100 in 
  let ctx4_102 : (int64 × user_address × int64) :=
    (time_78, owner_100, balance_101) in 
  let finres_103 : (result (state × finalize_action) finalize_error) :=
    auction_finalize (ctx4_102) ((state_96)) in 
  let '(state_104, result_3_105) :=
    match finres_103 with
  ...
  let ctx5_110 : (int64 × user_address × int64) :=
    ((time_78) .+ (@repr WORDSIZE64 1), carol_108, winning_amount_80) in 
  let finres2_111 : (result (state × finalize_action) finalize_error) :=
    auction_finalize (ctx5_110) ((state_104)) in 
  let '(state_112, result_4_113) :=
    match finres2_111 with
    | Err _ => ((state_104), false)
    | Ok (state_114, action_115) => (
      state_114,
      (action_115) =.? (SimpleTransfer (seq_concat (seq_concat (seq_concat (
                seq_concat (seq_new_ (@repr WORDSIZE8 0) (usize 0)) (
                  carol_108)) (u64_to_be_bytes (winning_amount_80))) (
              alice_84)) (u64_to_be_bytes ((amount_79) .+ (amount_79)))))
    )
    end in 
  let result_5_116 : bool :=
    ((state_112)) =.? (State ((
          Sold (bob_94),
          winning_amount_80,
          (item_77),
  ...
  let '(state_118, result_6_119) :=
    match finres3_117 with
  ...
  let result_7_124 : bool :=
    match t_123 with
    | Err e_125 => (e_125) =.? (AuctionIsFinalized)
    | Ok _ => false
    end in 
  (((((((result_0_89) && (result_1_93)) && (result_2_99)) && (
            result_3_105)) && (result_4_113)) && (result_5_116)) && (
      result_6_119)) && (result_7_124).

Theorem ensures_test_auction_bid_and_finalize : forall result_56 (
  item_77 : public_byte_seq) (time_78 : int64),
 @test_auction_bid_and_finalize item_77 time_78 = result_56 ->
 result_56 = true.
 Proof. Admitted.
QuickChick (
  forAll g_public_byte_seq (fun item_77 : public_byte_seq =>forAll g_int64 (fun time_78 : int64 =>test_auction_bid_and_finalize item_77 time_78))).
